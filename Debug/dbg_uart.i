# 1 "../Sources/mid/dbg_uart/dbg_uart.c"
...
# 11 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/include/dbg_uart.h" 2
...
# 9 "../Sources/mid/dbg_uart/dbg_uart.c" 2
...
# 42 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/lpuart_hal.h" 2
...
# 43 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/lpuart_hal.h" 2
...
# 24 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/lpuart_driver.h" 2
...
status_t CLOCK_SYS_GetFreq(clock_names_t clockName,
                           uint32_t *frequency);
# 25 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/lpuart_driver.h" 2
...
# 26 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/lpuart_driver.h" 2
...
# 10 "../Sources/mid/dbg_uart/dbg_uart.c" 2
...
# 12 "../Sources/mid/dbg_uart/dbg_uart.c" 2
...
# 13 "../Sources/mid/dbg_uart/dbg_uart.c" 2
...
# 14 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/include/ring_buffer.h" 2
...
# 14 "../Sources/mid/dbg_uart/dbg_uart.c" 2
...
static uint8_t dbg_rx_buf[(128U)];
...
static unsigned char DBGUART_TxBuf[(512U)];
...
{
# 77 "../Sources/mid/dbg_uart/dbg_uart.c"
...
void dbg_uart_tx_callback(uint32_t instance, void *callbackParam)
{
    ((void)instance );
    ((void)callbackParam );
# 100 "../Sources/mid/dbg_uart/dbg_uart.c"
    ...
    if (((DBGUART_TxAppPtr - DBGUART_TxPtr + (512U)) % (512U)) > (256U))
    {
        txlength = (256U);
        txbuffer = (uint8_t *)(DBGUART_TxBuf + DBGUART_TxPtr);
        DBGUART_TxPtr = (DBGUART_TxPtr + (256U)) % (512U);
    }
    else
    {
        txlength = (DBGUART_TxAppPtr - DBGUART_TxPtr + (512U)) % (512U);
        txbuffer = (uint8_t *)(DBGUART_TxBuf + DBGUART_TxPtr);
        DBGUART_TxPtr = 0;
        DBGUART_TxAppPtr = 0;
    }

    LPUART_DRV_SendData((0U), txbuffer, txlength);
...
void dbg_uart_rx_callback(uint32_t instance, void *callbackParam)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Hardware buffer overflow !" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    }


    if (1 == LPUART_DRV_GetChar(instance, &rx))
    {
        if (!rb_put(&dbg_rx_ring, &rx, 1))
        {
            do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Software buffer overflow !" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        }

        kernelSetTaskEvent(task_id, (1<<17));
    }
}
...
{
    task_id = task;
    LPUART_DRV_ReceiveData((0U), dbg_rx_buf, sizeof(dbg_rx_buf));
}
...
void dbg_uart_init(void)
{
    ...
    LPUART_DRV_Init((0U), &dbgUart_State, &initConfig);
    LPUART_DRV_InstallTxCallback((0U), dbg_uart_tx_callback, ((void *)0));
    LPUART_DRV_InstallRxCallback((0U), dbg_uart_rx_callback, ((void *)0));
}

uint32_t dbg_uart_send(const uint8_t *buffer, uint32_t size)
{
# 217 "../Sources/mid/dbg_uart/dbg_uart.c"
    unsigned int i;
    unsigned char *txbuffer;
    ...
    if (size > 0)
    {
        if (DBGUART_TxAppPtr <= DBGUART_TxPtr)
        {
            if (((DBGUART_TxAppPtr + size) >= DBGUART_TxPtr))
            {
                ...
                while (LPUART_DRV_GetTransmitStatus((0U), &bytesRemaining) != STATUS_SUCCESS)
                {
                    if (driverGetUptime() - uart_send_data_time >= (50))
                    {
                        break;
                    }
                }
        ...
        {
            if (((DBGUART_TxAppPtr + size - (512U)) >= DBGUART_TxPtr))
            {
                uint32_t bytesRemaining;
        ...
        for (i = 0; i < size; i++)
        {
            if ((DBGUART_TxAppPtr + 1) % (512U) == DBGUART_TxPtr)
            {
            ...
            DBGUART_TxAppPtr = (DBGUART_TxAppPtr + 1) % (512U);
        }
...
void dbg_uart_fflush(void)
{
# 362 "../Sources/mid/dbg_uart/dbg_uart.c"
}
