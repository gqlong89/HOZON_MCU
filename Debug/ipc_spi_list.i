# 1 "../Sources/mid/ipc_spi/ipc_spi_list.c"
...
void __assert_func (const char *, int, const char *, const char *) __attribute__ ((__noreturn__))
                                 ;
# 9 "../Sources/mid/ipc_spi/ipc_spi_list.c" 2
...
# 10 "../Sources/mid/ipc_spi/ipc_spi_list.c" 2
...
# 13 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/mid/ipc_spi/ipc_spi_list.h" 2
...
# 11 "../Sources/mid/ipc_spi/ipc_spi_list.c" 2
...
# 12 "../Sources/mid/ipc_spi/ipc_spi_list.c" 2
...
# 13 "../Sources/mid/ipc_spi/ipc_spi_list.c" 2


IPC_FRAME_T spi_frame[(50U)] __attribute__((section(".data.spibuf")));
list_t ipc_flst;
list_t ipc_slst;
list_t ipc_rlst;
...
# 135 "../Sources/mid/ipc_spi/ipc_spi_list.c"
void ipc_list_show(void)
{
    do { if( !g_xModemCommEnable ) { printf( " free list =[%d]\r\n", list_count(&ipc_flst) ); if( shellRedirectBufSize > 1 ) { redirectLen = snprintf( (char *)shellRedirectBuf, shellRedirectBufSize , " free list =[%d]\r\n", list_count(&ipc_flst) ); if ( (redirectLen > 0) && ( redirectLen < shellRedirectBufSize ) ) { shellRedirectBufSize -= redirectLen; shellRedirectBuf += redirectLen; } else { shellRedirectBufSize = 0; } } } } while (0);
    do { if( !g_xModemCommEnable ) { printf( " send list =[%d]\r\n", list_count(&ipc_slst) ); if( shellRedirectBufSize > 1 ) { redirectLen = snprintf( (char *)shellRedirectBuf, shellRedirectBufSize , " send list =[%d]\r\n", list_count(&ipc_slst) ); if ( (redirectLen > 0) && ( redirectLen < shellRedirectBufSize ) ) { shellRedirectBufSize -= redirectLen; shellRedirectBuf += redirectLen; } else { shellRedirectBufSize = 0; } } } } while (0);
    do { if( !g_xModemCommEnable ) { printf( " recv list =[%d]\r\n", list_count(&ipc_rlst) ); if( shellRedirectBufSize > 1 ) { redirectLen = snprintf( (char *)shellRedirectBuf, shellRedirectBufSize , " recv list =[%d]\r\n", list_count(&ipc_rlst) ); if ( (redirectLen > 0) && ( redirectLen < shellRedirectBufSize ) ) { shellRedirectBufSize -= redirectLen; shellRedirectBuf += redirectLen; } else { shellRedirectBufSize = 0; } } } } while (0);
}
