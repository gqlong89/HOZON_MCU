...
# 2 "../Sources/app/battery/varta.c" 2
...
# 3 "../Sources/app/battery/varta.c" 2
...
# 4 "../Sources/app/battery/varta.c" 2
...
# 5 "../Sources/app/battery/varta.c" 2
...
# 6 "../Sources/app/battery/varta.c" 2
...
# 24 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/rtos/osif/osif.h" 2
...
# 71 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/rtos/osif/osif.h" 2
...
# 7 "../Sources/app/battery/varta.c" 2
...
# 8 "../Sources/app/battery/varta.c" 2
...
# 10 "../Sources/app/battery/varta.c" 2
...
# 12 "../Sources/app/battery/varta.c" 2
...
# 13 "../Sources/app/battery/varta.c" 2

static unsigned int vartahealthtestflag = 1;

#define VARTA_HW_SOPPORT_TRICKLE 1
...
static void VartaBatteryStopCharge(void)
{
    ...
    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "%s:stop charge.......", __func__ ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
}
...
static void VartaBatteryFastCharge(void)
{
    ...
    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "%s:standard charge.......", __func__ ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
}
...
# 138 "../Sources/app/battery/varta.c"
}
...
static int VartaBatteryTempratue(void)
{
    ...
    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( ":temprature = %d,resistance=%d", temprature, (int)resistance ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
...
void VartaBatteryHealthStrategy(void)
{
    ...
    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( ":voltage = %s", adcValueStr ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    ...
    if (Ritestflag == 0)
    {
        if (flag == 0)
        {
            ...
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( ":start time = %d", (uint32_t)driverGetUptime() ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        }
        else if (driverGetUptime() > (time + 100))
        {
            ...
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( ":ocv = %s", adcValueStr ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            float_to_string(ccv, adcValueStr);
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( ":ccv = %s", adcValueStr ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            float_to_string(Ri, adcValueStr);
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( ":Ri = %s", adcValueStr ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);

            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( ":end time = %d", (uint32_t)driverGetUptime() ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);

            if (Ri < 1.2)
            {
                batteryhealthstatus = 0;
                do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( ":battery SOH = green" ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            }
            else if ((1.2 <= Ri) && (Ri <= 1.5))
            {
                batteryhealthstatus = 1;
                do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( ":battery SOH = yellow" ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            }
            else if ((Ri >= 1.5))
            {
                batteryhealthstatus = 2;
                do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( ":battery SOH = red" ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            }
...
void VartaBatteryChargeStrategy(void)
{
    ...
    if ((result > 408) || (temprature < (-20)) || (temprature > TempratueMax))
    {
        if (batterychargestatus.stopchargeflag == 0)
        {
            ...
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( ":temprature = %d\r\n", temprature ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        }
    }
    else if ((result >= 390) && (temprature >= (-20)) && (temprature <= TempratueMax))
    {
        ...
        if (batterychargestatus.tricklechargeflag == 0)
        {
            ...
            {
                do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "%s:trickle charge.......", __func__ ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            }
    ...
    else if ((result > 0) && (temprature >= (-20)) && (temprature <= TempratueMax))
    {
        if ((batterychargestatus.standardchargeflag == 0) && (standardchargetimeoutflag == 0))
        {
            ...
            batterychargestatus.tricklechargeflag = 0;
            standardchargetime = driverGetUptime() + 5040000;
        }
...
void VartaChargePinStatus(void)
{
    printf("pm_cpu_charge_ctrl = %d, pm_cpu_charge_trickle_ctrl = %d, pm_cpu_charge_trickle_varta_ctrl = %d\r\n",
           GPIO_ReadPinInput(((GPIO_Type *)(0x400FF0C0u)), 12U),
           GPIO_ReadPinInput(((GPIO_Type *)(0x400FF0C0u)), 16U),
           GPIO_ReadPinInput(((GPIO_Type *)(0x400FF0C0u)), 5U));
}
