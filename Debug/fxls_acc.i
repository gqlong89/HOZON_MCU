...
void acc_sleep(void);
# 9 "../Sources/mid/acc/fxls_acc.c" 2
...
# 10 "../Sources/mid/acc/fxls_acc.c" 2
...
# 11 "../Sources/mid/acc/fxls_acc.c" 2
...
# 12 "../Sources/mid/acc/fxls_acc.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/mid/acc/fxls_acc.h" 1
...
# 14 "../Sources/mid/acc/fxls_acc.c" 2
...
_Bool is_fxls_acc(void)
{
    ...
    ret = fxls_read((0x0D), &temp_val, 1);

    if (!ret)
    {
        if (temp_val != (0x6A))
        {
            do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "is not fxls acc:(0x%x)", temp_val ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            ret = 1;
        }
    }
    else
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "fxls read faild,ret:%d", ret ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    }
...
_Bool fxls_acc_init(void)
{
    ...
    databyte = 0;
    ret = fxls_write((0x2A), databyte, 1);
# 71 "../Sources/mid/acc/fxls_acc.c"
    databyte = 0x01;
    ret |= fxls_write((0x0E), databyte, 1);
# 81 "../Sources/mid/acc/fxls_acc.c"
    databyte = 0x0d;
    ret |= fxls_write((0x2A), databyte, 1);
    ...
    {
        ret |= fxls_write((0x2A), 0x00, 1);
        ret |= fxls_write((0x2C), 0x04, 1);
        ret |= fxls_write((0x2D), 0x02, 1);
        ret |= fxls_write((0x2E), 0xff, 1);
        ret |= fxls_write((0x5F), 0x48, 1);
        databyte = ((cfg_get_acc_vecm_ths() >> 8) & 0x1f);
        databyte |= 0x80;
        ret |= fxls_write((0x60), databyte, 1);
        databyte = (cfg_get_acc_vecm_ths() & 0xff);
        ret |= fxls_write((0x61), databyte, 1);
        ret |= fxls_write((0x62), 0x01, 1);
        ret |= fxls_write(0x2a, 0x29, 1);
    }
    else
    {
        ret |= fxls_write((0x2A), 0x00, 1);
        ret |= fxls_write((0x2C), 0x00, 1);
        ret |= fxls_write((0x2D), 0x00, 1);
        ret |= fxls_write((0x2A), 0x29, 1);
    }

    if (ret)
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "fxls write faild,ret:%d", ret ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 0;
    }
    else
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "fxls acc init ok" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 1;
    }
}
...
int fxls_get_interrupt_src(void)
{
    ...
    if (int_src > 0)
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "int_src: 0x%x", int_src ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);

        if (int_src & 0x02)
        {
            flag |= (1 << 1);
            do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Accelerometer vector-magnitude interrupt" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        }

        if (int_src & 0x20)
        {
            flag |= (1 << 2);
            do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Transient interrupt" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            ret = fxls_read((0x1E), &transient_src, 1);

            if (ret)
            {
                do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "reg read error:%d, int_src:0x%x", ret, int_src ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            }
            else
            {
                do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "TRANSIENT_SRC: 0x%x", transient_src ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            }
        }
    }
...
static void fxls_xyz_convent(signed short *accvel, double *angle)
{
    ...
    angle_x = asin(accvel[0] * 0.488 / 1000) * 180 / 3.1415926;
    ...
    angle_y = asin(accvel[1] * 0.488 / 1000) * 180 / 3.1415926;
    ...
    angle_z = asin(accvel[2] * 0.488 / 1000) * 180 / 3.1415926;
    angle_z = 90 - angle_z;
    ...
    if (angle_z > 55)
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( " Roll over" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( " angle_z: (%d)", angle_z ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    }
}
...
int fxls_get_xyz(double *angle)
{
    ...
    if ((!ret) && (XYZ[0] & (1 << 3)))
    {
        ...
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_DEBUG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "status[0x%x],acc_xyz=[%5d,%5d,%5d]", XYZ[0], accVal[0], accVal[1], accVal[2] ); printf("\r\n"); if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
                                                       ;
        return 0;
    }
    else
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Fatal error!,ret:%d,status[0x%x]", ret, XYZ[0] ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return -1;
    }
}
...
void fxls_sleep(void)
{
    ...
    fxls_read((0x2A), &databyte, 1);
    databyte &= 0xFE;
    fxls_write((0x2A), databyte, 1);

    fxls_read((0x2B), &databyte, 1);
    databyte |= 0x04;
    fxls_write((0x2B), databyte, 1);
    ...
    fxls_write((0x2D), 0x82, 1);

    fxls_write((0x2E), 0xff, 1);

    fxls_write((0x2C), 0x04, 1);

    fxls_read((0x0E), &databyte, 1);
    databyte &= 0xFC;
    fxls_write((0x0E), databyte, 1);
}
