...
# 1 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\sys\\features.h" 1 3
# 22 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\sys\\features.h" 3
...
# 1 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\machine\\_default_types.h" 1 3
...
# 15 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\machine\\_default_types.h" 3
...
# 214 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\machine\\_default_types.h" 3
#undef __EXP
# 8 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\machine\\_types.h" 2 3
...
# 2 "../Sources/mid/rtc/rtc.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/include/i2c.h" 1

#define _I2C_H_ 

# 1 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\sys\\_stdint.h" 1 3
# 10 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\sys\\_stdint.h" 3
...
# 5 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/include/i2c.h" 2
...
# 3 "../Sources/mid/rtc/rtc.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/include/rtc.h" 1
...
# 52 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Generated_Code/clockMan1.h" 2
...
# 53 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Generated_Code/clockMan1.h" 2
...
# 66 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Generated_Code/lpi2c1.h" 2
...
# 67 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Generated_Code/lpi2c1.h" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Generated_Code/osif1.h" 1
# 48 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Generated_Code/osif1.h"
#define osif1_H 
# 68 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Generated_Code/lpi2c1.h" 2
...
# 7 "../Sources/mid/rtc/rtc.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/include/softrtc.h" 1
...
static RTCTime RTC_GetNextTime(unsigned int min)
{
    ...
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "alarm time: %02d/%02d/%02d %02d:%02d:%02d", rtcTime.RTC_Year + 2000, rtcTime.RTC_Mon, rtcTime.RTC_Mday, rtcTime.RTC_Hour, rtcTime.RTC_Min, rtcTime.RTC_Sec ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
...
void driverRTCGetTime(RTCTime *localtime)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "softrtc not init: %d/%d/%d %d:%d:%d\r\n", localtime->RTC_Year + 2000, localtime->RTC_Mon, localtime->RTC_Mday, localtime->RTC_Hour, localtime->RTC_Min, localtime->RTC_Sec ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
...
void driverRTCSetTime(RTCTime time)
{
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Set Hard RTC: %d/%d/%d %d:%d:%d\r\n", time.RTC_Year, time.RTC_Mon, time.RTC_Mday, time.RTC_Hour, time.RTC_Min, time.RTC_Sec ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
    ...
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Set Soft RTC: %d/%d/%d %d:%d:%d\r\n", time.RTC_Year + 2000, time.RTC_Mon, time.RTC_Mday, time.RTC_Hour, time.RTC_Min, time.RTC_Sec ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
