	...
	.eabi_attribute 18, 4
	.thumb
	.file	"shell_transfer.c"
	.text
.Ltext0:
	.cfi_sections	.debug_frame
	.global	g_xModemCommEnable
	.section	.bss.g_xModemCommEnable,"aw",%nobits
	.type	g_xModemCommEnable, %object
	.size	g_xModemCommEnable, 1
g_xModemCommEnable:
	.space	1
	.section	.text.shell_read,"ax",%progbits
	.align	2
	.global	shell_read
	.thumb
	.thumb_func
	.type	shell_read, %function
shell_read:
.LFB0:
	.file 1 "../Sources/app/shell/shell_transfer.c"
	.loc 1 16 0
	.cfi_startproc
...
.L18:
	...
	.cfi_endproc
.LFE0:
	.size	shell_read, .-shell_read
	.section	.text.shell_write,"ax",%progbits
	.align	2
	.global	shell_write
	.thumb
	.thumb_func
	.type	shell_write, %function
shell_write:
.LFB1:
	.loc 1 101 0
	.cfi_startproc
	...
	.cfi_endproc
.LFE1:
	.size	shell_write, .-shell_write
	.section	.bss.r_pos.3981,"aw",%nobits
	.align	2
	.type	r_pos.3981, %object
	.size	r_pos.3981, 4
r_pos.3981:
	.space	4
	.section	.bss.w_pos.3982,"aw",%nobits
	.align	2
	.type	w_pos.3982, %object
	.size	w_pos.3982, 4
w_pos.3982:
	.space	4
	.section	.bss.recv_buf.3980,"aw",%nobits
	.align	2
	.type	recv_buf.3980, %object
	.size	recv_buf.3980, 256
recv_buf.3980:
	.space	256
	.text
.Letext0:
...
.Ldebug_macro0:
	...
	.uleb128 0x2
	.4byte	.LASF359
	.file 4 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/include/dbg_uart.h"
	.byte	0x3
	.uleb128 0x8
	.uleb128 0x4
	.byte	0x5
...
.LASF507:
	...
	.ascii	" 0, 0}}\000"
.LASF686:
	.ascii	"../Sources/app/shell/shell_transfer.c\000"
.LASF101:
