# 1 "../SDK/platform/drivers/src/lpspi/lpspi_slave_driver.c"
...
# 1 "../SDK/platform/drivers/src/lpspi/lpspi_slave_driver.c"
# 82 "../SDK/platform/drivers/src/lpspi/lpspi_slave_driver.c"
...
# 83 "../SDK/platform/drivers/src/lpspi/lpspi_slave_driver.c" 2
...
lpspi_callback_t LPSPIT_DRV_SlaveInstallCallback(uint32_t instance,
                                                  ...
                                                  void * callbackParam);
# 84 "../SDK/platform/drivers/src/lpspi/lpspi_slave_driver.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/clock_manager.h" 1
# 85 "../SDK/platform/drivers/src/lpspi/lpspi_slave_driver.c" 2
...
# 86 "../SDK/platform/drivers/src/lpspi/lpspi_slave_driver.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/lpspi_shared_function.h" 1
# 87 "../SDK/platform/drivers/src/lpspi/lpspi_slave_driver.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/S32K144/include/S32K144_features.h" 1
# 88 "../SDK/platform/drivers/src/lpspi/lpspi_slave_driver.c" 2
...
# 264 "../SDK/platform/drivers/src/lpspi/lpspi_slave_driver.c"
    ...
    else
    {
        ...
        if(receiveBuffer != ((void *)0))
        {
            ...
            EDMA_HAL_TCDSetDisableDmaRequestAfterTCDDoneCmd(baseDma, state->rxDMAChannel, 1);
            state->rxCount = transferByteCount;
        ...
        if(sendBuffer != ((void *)0))
        {
            ...
            EDMA_HAL_TCDSetDisableDmaRequestAfterTCDDoneCmd(baseDma, state->txDMAChannel, 1);
            state->txCount = transferByteCount;
...
void LPSPI_DRV_SlaveIRQHandler(uint32_t instance)
{
    ...
    if ((_Bool)LPSPI_HAL_GetStatusFlag(base, LPSPI_TRANSMIT_ERROR))
    {
        ...
        {
            lpspiState->callback(instance, lpspiState->callbackParam);
        }
        return;
    }
    ...
    if ((rxCount == (uint8_t)0) && (txCount == (uint8_t)0))
    {
        ...
        lpspiState->status = LPSPI_TRANSFER_CMP;
        if (lpspiState->callback != ((void *)0))
        {
            lpspiState->callback(instance, lpspiState->callbackParam);
        }
...
status_t LPSPI_DRV_SlaveGetTransferStatus(uint32_t instance,uint32_t * bytesRemained)
{
    ...
    if (lpspiState->status == LPSPI_TRANSFER_OK || lpspiState->status == LPSPI_TRANSFER_CMP )
    {
...
static void LPSPI_DRV_SlaveCompleteDMATransfer(void* parameter, edma_chn_status_t status)
{
    ...
    {
        lpspiState->status = LPSPI_DMA_ERROR;
    }
    else
    {
        lpspiState->status = LPSPI_TRANSFER_CMP;
    }
    (void)LPSPI_HAL_ClearStatusFlag(base, LPSPI_FRAME_COMPLETE);
...
# 535 "../SDK/platform/drivers/src/lpspi/lpspi_slave_driver.c"
lpspi_callback_t LPSPIT_DRV_SlaveInstallCallback(uint32_t instance,
                                                  lpspi_callback_t function,
                                                  void * callbackParam)
{
    ...
    lpspi_callback_t currentCallback = lpspiState->callback;
    lpspiState->callback = function;
    lpspiState->callbackParam = callbackParam;
