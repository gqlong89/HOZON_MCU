# 1 "../Sources/app/can_mgr/can_broadCast.c"
...
# 1 "../Sources/app/can_mgr/can_broadCast.c"
# 15 "../Sources/app/can_mgr/can_broadCast.c"
...
# 16 "../Sources/app/can_mgr/can_broadCast.c" 2
...
# 17 "../Sources/app/can_mgr/can_broadCast.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/scom/scom_tl.h" 1
# 9 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/scom/scom_tl.h"
...
#define MCU_CHK_VER_STATE 0
#define MCU_NEED_UPG_STATE 1
#define MCU_NO_NEED_UPG_STATE 2
...
_Bool scom_is_need_upgrade(void);
# 18 "../Sources/app/can_mgr/can_broadCast.c" 2
...
# 19 "../Sources/app/can_mgr/can_broadCast.c" 2
...
# 20 "../Sources/app/can_mgr/can_broadCast.c" 2
...
# 21 "../Sources/app/can_mgr/can_broadCast.c" 2
...
# 22 "../Sources/app/can_mgr/can_broadCast.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/include/scom_msg_def.h" 1
...
typedef enum
{
    ...
    SCOM_TL_CMD_RESERVED1,
    SCOM_TL_CMD_RESERVED2,
...
typedef enum
{
    SCOM_TL_CMD_CTRL = (SCOM_TL_CHN_CUSTOM << 4),
    SCOM_MPU_MCU_VIRTUAL_ON,
    SCOM_MPU_MCU_0x440,
    SCOM_MPU_MCU_0x445,
    SOCM_MCU_MPU_0x526,
    SCOM_MCU_MPU_0x3d2,
...
# 23 "../Sources/app/can_mgr/can_broadCast.c" 2
...
# 24 "../Sources/app/can_mgr/can_broadCast.c" 2
...
# 26 "../Sources/app/can_mgr/can_broadCast.c" 2
...
# 30 "../Sources/app/can_mgr/can_broadCast.c" 2
...
# 31 "../Sources/app/can_mgr/can_broadCast.c" 2
...
# 32 "../Sources/app/can_mgr/can_broadCast.c" 2
...
# 34 "../Sources/app/can_mgr/can_broadCast.c" 2
...
# 35 "../Sources/app/can_mgr/can_broadCast.c" 2
...
# 36 "../Sources/app/can_mgr/can_broadCast.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/can_mgr/can_sendFifo.h" 1
...
# 37 "../Sources/app/can_mgr/can_broadCast.c" 2


BC_CYCLE_ST BC_CycleList[(5)];
BC_ENENT_ST BC_EventList[(5)];
BC_CE_ST BC_CEList[(5)];
BC_ACTIVE_ST BC_ActiveList[(1)];


static int8_t timer_BC_Cycle[(5)] = {(-1)};
static int8_t timer_BC_Event[(5)] = {(-1)};
static int8_t timer_BC_CE[(5)] = {(-1)};
static int8_t timer_BC_Active[(1)] = {(-1)};

static int8_t timer_BC_CE_Event[(5)] = {(-1)};


unsigned char BC_CYCLE_SEND_FLAG;
unsigned char BC_EVENT_SEND_FLAG;
unsigned char BC_CE_SEND_FLAG;
unsigned char BC_ACITVE_SEND_FLAG;

unsigned char BC_CE_EVENT_SEND_FLAG;


extern unsigned char canBasic_taskid;
# 70 "../Sources/app/can_mgr/can_broadCast.c"
...
void timer_BC_CycleISR0(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast Cycle timer0 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    BC_CYCLE_SEND_FLAG |= (1<<0);
    kernelSetTaskEvent(canBasic_taskid, (1<<22));

    if (BC_CycleList[0].num_C != (0x7ffffffe))
    {
...
void timer_BC_CycleISR1(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast Cycle timer1 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    BC_CYCLE_SEND_FLAG |= (1<<1);
    kernelSetTaskEvent(canBasic_taskid, (1<<22));

    if (BC_CycleList[1].num_C != (0x7ffffffe))
    {
...
void timer_BC_CycleISR2(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast Cycle timer2 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    BC_CYCLE_SEND_FLAG |= (1<<2);
    kernelSetTaskEvent(canBasic_taskid, (1<<22));

    if (BC_CycleList[2].num_C != (0x7ffffffe))
    {
...
void timer_BC_CycleISR3(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast Cycle timer3 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    BC_CYCLE_SEND_FLAG |= (1<<3);
    kernelSetTaskEvent(canBasic_taskid, (1<<22));

    if (BC_CycleList[3].num_C != (0x7ffffffe))
    {
...
void timer_BC_CycleISR4(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast Cycle timer4 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    BC_CYCLE_SEND_FLAG |= (1<<4);
    kernelSetTaskEvent(canBasic_taskid, (1<<22));

    if (BC_CycleList[4].num_C != (0x7ffffffe))
    {
...
void timer_BC_EventISR0(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast Event timer0 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    BC_EVENT_SEND_FLAG |= (1<<0);
    kernelSetTaskEvent(canBasic_taskid, (1<<22));
...
void timer_BC_EventISR1(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast Event timer1 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    BC_EVENT_SEND_FLAG |= (1<<1);
    kernelSetTaskEvent(canBasic_taskid, (1<<22));
...
void timer_BC_EventISR2(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast Event timer2 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    BC_EVENT_SEND_FLAG |= (1<<2);
    kernelSetTaskEvent(canBasic_taskid, (1<<22));
...
void timer_BC_EventISR3(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast Event timer3 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    BC_EVENT_SEND_FLAG |= (1<<3);
    kernelSetTaskEvent(canBasic_taskid, (1<<22));
...
void timer_BC_EventISR4(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast Event timer4 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    BC_EVENT_SEND_FLAG |= (1<<4);
    kernelSetTaskEvent(canBasic_taskid, (1<<22));
...
void timer_BC_CEISR0(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast CE timer0 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    if (BC_CEList[0].eventIsGoing == 0)
    {
        BC_CE_SEND_FLAG |= (1<<0);
        kernelSetTaskEvent(canBasic_taskid, (1<<22));
    }
...
void timer_BC_CEISR1(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast CE timer1 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    if (BC_CEList[1].eventIsGoing == 0)
    {
        BC_CE_SEND_FLAG |= (1<<1);
...
void timer_BC_CEISR2(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast CE timer2 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    if (BC_CEList[2].eventIsGoing == 0)
    {
        BC_CE_SEND_FLAG |= (1<<2);
        kernelSetTaskEvent(canBasic_taskid, (1<<22));
    }
...
void timer_BC_CEISR3(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast CE timer3 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    if (BC_CEList[3].eventIsGoing == 0)
    {
        BC_CE_SEND_FLAG |= (1<<3);
        kernelSetTaskEvent(canBasic_taskid, (1<<22));
    }
...
void timer_BC_CEISR4(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast CE timer4 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    if (BC_CEList[4].eventIsGoing == 0)
    {
        BC_CE_SEND_FLAG |= (1<<4);
        kernelSetTaskEvent(canBasic_taskid, (1<<22));
    }
...
void timer_BC_CE_EVENTISR0(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast CE_Event timer0 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    BC_CE_EVENT_SEND_FLAG |= (1<<0);
    kernelSetTaskEvent(canBasic_taskid, (1<<22));
...
void timer_BC_CE_EVENTISR1(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast CE_Event timer1 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    BC_CE_EVENT_SEND_FLAG |= (1<<1);
    kernelSetTaskEvent(canBasic_taskid, (1<<22));
...
void timer_BC_CE_EVENTISR2(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast CE_Event timer2 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    BC_CE_EVENT_SEND_FLAG |= (1<<2);
...
void timer_BC_CE_EVENTISR3(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast CE_Event timer3 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    BC_CE_EVENT_SEND_FLAG |= (1<<3);
    kernelSetTaskEvent(canBasic_taskid, (1<<22));
...
void timer_BC_CE_EVENTISR4(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BroadCast CE_Event timer4 check Wrong!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    BC_CE_EVENT_SEND_FLAG |= (1<<4);
    kernelSetTaskEvent(canBasic_taskid, (1<<22));
...
timeout_handler timer_BC_CycleISR[(5)] =
{
    timer_BC_CycleISR0,
    timer_BC_CycleISR1,
    timer_BC_CycleISR2,
...
timeout_handler timer_BC_EventISR[(5)] =
{
    timer_BC_EventISR0,
    timer_BC_EventISR1,
    timer_BC_EventISR2,
...
timeout_handler timer_BC_CEISR[(5)] =
{
    timer_BC_CEISR0,
    timer_BC_CEISR1,
    timer_BC_CEISR2,
...
timeout_handler timer_BC_CE_EVENTISR[(5)] =
{
...
# 550 "../Sources/app/can_mgr/can_broadCast.c"
unsigned char creat_BC_Item(BC_SET_ST BC_VALUE)
{
    ...
    if (BC_VALUE.type == (0))
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BoartCast type need to be set!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        ret = 1;
        return ret;
    }
    ...
    switch (BC_VALUE.type)
    {
        case (2):
            {
                ...
                {
                    ret = 2;
                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Cycle broadCast number is Over mast number" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                    return ret;
                }
        ...
        case (1):
            {
                ...
                {
                    ret = 3;
                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Event broadCast number is Over mast number" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                    return ret;
                }

                BC_EventList[i].id = BC_VALUE.id;
                BC_EventList[i].port = BC_VALUE.port;
                BC_EventList[i].used = (1);
        ...
        case (3):
            {
                ...
                {
                    ret = 4;
                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "CE broadCast number is Over mast number" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                    return ret;
                }
        ...
        case (4):
            {
                ...
                {
                    ret = 5;
                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Active broadCast number is Over mast number" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                    return ret;
                }

                BC_ActiveList[i].id = BC_VALUE.id;
                BC_ActiveList[i].port = BC_VALUE.port;
                BC_ActiveList[i].used = (1);
                ret = 0;
                break;
            }
        ...
        default:
            {
                do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "BC type worng!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                ret = 0xfe;
                break;
            }
    }
...
unsigned char BC_Init(void)
{
    ...
    memset(timer_BC_Cycle, (-1), (5));
    memset(timer_BC_Event, (-1), (5));
    memset(timer_BC_CE, (-1), (5));
    memset(timer_BC_Active, (-1), (1));

    memset(timer_BC_CE_Event, (-1), (5));
    ...
    for (i = 0; i < (5); i++)
    {
        if (BC_CycleList[i].used == (1))
        {
            if (timer_BC_Cycle[i] == (-1))
            {
                timer_BC_Cycle[i] = ltimer_create(timer_BC_CycleISR[i]);

            }
            else
            {
                do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Timer for broadCast Cycle %d is used,Wrong!", i ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            }
        }
        else
        {
    ...
    for (i = 0; i < (5); i++)
    {
        if (BC_EventList[i].used == (1))
        {
            if (timer_BC_Event[i] == (-1))
            {
                timer_BC_Event[i] = ltimer_create(timer_BC_EventISR[i]);
            }
            else
            {
                do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Timer for broadCast Event %d is used,Wrong!", i ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            }
        }
        else
        {
    ...
    for (i = 0; i < (5); i++)
    {
        if (BC_CEList[i].used == (1))
        {
            if (timer_BC_CE[i] == (-1))
            {
                timer_BC_CE[i] = ltimer_create(timer_BC_CEISR[i]);
            }
            else
            {
                do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Timer for broadCast CE %d is used,Wrong!", i ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            }

            if (timer_BC_CE_Event[i] == (-1))
            {
                timer_BC_CE_Event[i] = ltimer_create(timer_BC_CE_EVENTISR[i]);
            }
            else
            {
                do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Timer for broadCast CE_EVENT %d is used,Wrong!", i ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            }
        }
        else
        {
...
# 872 "../Sources/app/can_mgr/can_broadCast.c"
...
# 927 "../Sources/app/can_mgr/can_broadCast.c"
void start_BC_timerByChl(unsigned char canport)
{
    ...
    if (canport > 1)
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "CAN port %d is wrong", canport ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }
...
# 981 "../Sources/app/can_mgr/can_broadCast.c"
...
# 1034 "../Sources/app/can_mgr/can_broadCast.c"
void stop_BC_timerByChl(unsigned char canport)
{
 ...
 do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "stop can %d bc", canport ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
...
# 1192 "../Sources/app/can_mgr/can_broadCast.c"
_Bool data_packageFunction(unsigned char *p_des, unsigned char *p_src, unsigned char *p_mask,
                          unsigned char data_type)
{
    ...
    switch (data_type)
    {
        ...
        case HZ_TIME:
            {
                driverRTCGetTime(&current_time1);
...
void first_BC(unsigned char canport)
{
   ...
   memset(tmpMsg.Data,0,8);
            ...
            {
                do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Data package worng!!!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                memcpy(tmpMsg.Data, 0, 8);
            }

            APP_CANSend(BC_CycleList[i].port, &tmpMsg);

            if (BC_CycleList[i].num_C != (0x7ffffffe))
            {
...
# 1351 "../Sources/app/can_mgr/can_broadCast.c"
void APP_SendHandle(void)
{
    ...
    for (i = 0; i < (5); i++)
    {
        ...
        if (BC_CE_EVENT_SEND_FLAG & (1 << i))
        {
            INT_SYS_DisableIRQGlobal();

            BC_CE_EVENT_SEND_FLAG &= (~(1 << i));
    ...
    kernelSetTaskEvent(canBasic_taskid, (1<<23));
}
# 1492 "../Sources/app/can_mgr/can_broadCast.c"
unsigned char BC_Event_handle(unsigned int id ,
                              unsigned char port,
                              unsigned char len,
                              unsigned char *pdata,
                              unsigned char num_Event,
                              unsigned int cycle_Event)
{
    ...
    for (i = 0; i < (5); i++)
    {
        if ((id == BC_EventList[i].id) && (port == BC_EventList[i].port))
        {
            if ((len >= 2) && (num_Event > 0) && (cycle_Event != 0))
            {
            ...
            {
                do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "the detail in message is wroang!!!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                return (2);
            }
    ...
    if (i >= (5))
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "ID 0x %x on CAN %d is not register", id, port ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return (1);
    }

    return 0 ;
}
# 1580 "../Sources/app/can_mgr/can_broadCast.c"
                           ...
                           unsigned int cycle_Event)
{
    ...
    for (i = 0; i < (5); i++)
    {
        if ((id == BC_CEList[i].id) && (port == BC_CEList[i].port))
        {
            if ((len >= 2) && (num_Event > 0) && (cycle_Event != 0))
            {
                ...
                if (BC_CEList[i].eventIsGoing == 1)
                {
                    ...
                    stop_Event_timerByID(port, id);
                    BC_CE_EVENT_SEND_FLAG = 0;

                    INT_SYS_EnableIRQGlobal();
                }
                else
                {
                    BC_CEList[i].eventIsGoing = 1;
                }
