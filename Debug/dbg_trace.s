...
.Ltext0:
	...
	.section	.bss.dbg_trace_info,"aw",%nobits
	.align	2
	.type	dbg_trace_info, %object
	.size	dbg_trace_info, 4
dbg_trace_info:
	.space	4
	.section	.text.dbgTraceInit,"ax",%progbits
	.align	2
	.global	dbgTraceInit
	.thumb
	.thumb_func
	.type	dbgTraceInit, %function
dbgTraceInit:
.LFB0:
	.file 1 "../Sources/mid/dbg_trace/dbg_trace.c"
	.loc 1 10 0
	.cfi_startproc
...
.L3:
	...
	.cfi_endproc
.LFE0:
	.size	dbgTraceInit, .-dbgTraceInit
	.section	.text.dbgTraceTaskId,"ax",%progbits
	.align	2
	.global	dbgTraceTaskId
	.thumb
	.thumb_func
	.type	dbgTraceTaskId, %function
dbgTraceTaskId:
.LFB1:
	.loc 1 22 0
	.cfi_startproc
...
.L7:
	...
	.cfi_endproc
.LFE1:
	.size	dbgTraceTaskId, .-dbgTraceTaskId
	.section	.rodata
	.align	2
.LC0:
	.ascii	"\015\012-----------------dbg trace info begin------"
	.ascii	"--------------\015\012\000"
	.align	2
.LC1:
	.ascii	"trace info is null \015\012\000"
	.align	2
.LC2:
	.ascii	"last task id:%u\015\012\000"
	.align	2
.LC3:
	.ascii	"event mask:0x%08x\015\012\000"
	.align	2
.LC4:
	.ascii	"last task type:0x%02x\015\012\000"
	.align	2
.LC5:
	.ascii	"\015\012-----------------dbg trace info end--------"
	.ascii	"--------------\015\012\000"
	.section	.text.dbgTraceDump,"ax",%progbits
	.align	2
	.global	dbgTraceDump
	.thumb
	.thumb_func
	.type	dbgTraceDump, %function
dbgTraceDump:
.LFB2:
	.loc 1 35 0
	.cfi_startproc
...
.L13:
	...
	.cfi_endproc
.LFE2:
	.size	dbgTraceDump, .-dbgTraceDump
	.text
.Letext0:
	.file 2 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/include/dbg_trace.h"
...
.Ldebug_macro0:
	...
	.4byte	.LASF479
	.byte	0x4
	.file 9 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/mid/kernel/kernel.h"
	.byte	0x3
	.uleb128 0x2
	.uleb128 0x9
	.byte	0x7
	...
	.byte	0x4
	.byte	0x4
	.file 22 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/include/flash.h"
	.byte	0x3
	.uleb128 0x5
	.uleb128 0x16
	.byte	0x7
...
.LASF814:
	.ascii	"DBG_TRACE_EXIT\000"
.LASF305:
	.ascii	"__USER_LABEL_PREFIX__ \000"
.LASF819:
	.ascii	"DBG_TRACE_TYPE\000"
.LASF781:
...
.LASF825:
	.ascii	"../Sources/mid/dbg_trace/dbg_trace.c\000"
.LASF777:
