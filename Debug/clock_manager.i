# 1 "../SDK/platform/drivers/src/clock/clock_manager.c"
...
# 1 "../SDK/platform/drivers/src/clock/clock_manager.c"
# 33 "../SDK/platform/drivers/src/clock/clock_manager.c"
...
# 34 "../SDK/platform/drivers/src/clock/clock_manager.c" 2
...
status_t CLOCK_SYS_GetFreq(clock_names_t clockName,
                           uint32_t *frequency);
# 35 "../SDK/platform/drivers/src/clock/clock_manager.c" 2
...
# 36 "../SDK/platform/drivers/src/clock/clock_manager.c" 2
# 1 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\lib\\gcc\\arm-none-eabi\\4.9.3\\include\\stddef.h" 1 3 4
# 37 "../SDK/platform/drivers/src/clock/clock_manager.c" 2
# 45 "../SDK/platform/drivers/src/clock/clock_manager.c"
static clock_manager_state_t g_clockState;
# 57 "../SDK/platform/drivers/src/clock/clock_manager.c"
status_t CLOCK_SYS_Init(clock_manager_user_config_t const **clockConfigsPtr,
                              uint8_t configsNumber,
                              clock_manager_callback_user_config_t **callbacksPtr,
                              uint8_t callbacksNumber)
...
# 90 "../SDK/platform/drivers/src/clock/clock_manager.c"
status_t CLOCK_SYS_UpdateConfiguration(uint8_t targetConfigIndex,
                                                   clock_manager_policy_t policy)
{
    uint8_t callbackIdx;
...
# 208 "../SDK/platform/drivers/src/clock/clock_manager.c"
uint8_t CLOCK_SYS_GetCurrentConfiguration(void)
{
    return g_clockState.curConfigIndex;
}
# 220 "../SDK/platform/drivers/src/clock/clock_manager.c"
clock_manager_callback_user_config_t* CLOCK_SYS_GetErrorCallback(void)
{
