# 1 "../SDK/platform/hal/src/wdog/wdog_hal.c"
...
# 1 "../SDK/platform/hal/src/wdog/wdog_hal.c"
# 29 "../SDK/platform/hal/src/wdog/wdog_hal.c"
...
# 37 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/wdog_hal.h" 2
...
# 30 "../SDK/platform/hal/src/wdog/wdog_hal.c" 2
# 42 "../SDK/platform/hal/src/wdog/wdog_hal.c"
void WDOG_HAL_Init(WDOG_Type *base)
{
    { if (((base)->CS & 0x2000u) != 0U) { { (base)->CNT = (0xD928C520U); (void)(base)->CNT; }; } else { { (base)->CNT = (0xC520U); (void)(base)->CNT; (base)->CNT = (0xD928U); (void)(base)->CNT; }; } };
    ...
    base->CS = 0x20u | 0x80u | (0x2000U) |
                  (((uint32_t)(((uint32_t)(WDOG_LPO_CLOCK))<<8u))&0x300u);
    base->TOVAL = (0x400U);
    base->WIN = (0x0U);
...
# 64 "../SDK/platform/hal/src/wdog/wdog_hal.c"
void WDOG_HAL_Config(WDOG_Type *base, const wdog_user_config_t *config)
{
    uint32_t cs = base->CS;


    cs &= ~(0x8000u | 0x1000u | 0x300u |
            0x40u | 0x20u | 0x4u |
            0x2u | 0x1u);

    cs |= (((uint32_t)(((uint32_t)(config->winEnable? 1UL : 0UL))<<15u))&0x8000u);
    cs |= (((uint32_t)(((uint32_t)(config->prescalerEnable? 1UL : 0UL))<<12u))&0x1000u);
    cs |= (((uint32_t)(((uint32_t)(config->clkSource))<<8u))&0x300u);
    cs |= (((uint32_t)(((uint32_t)(config->intEnable? 1UL : 0UL))<<6u))&0x40u);
    cs |= (((uint32_t)(((uint32_t)(config->updateEnable? 1UL : 0UL))<<5u))&0x20u);
    cs |= (((uint32_t)(((uint32_t)(config->opMode.debug? 1UL : 0UL))<<2u))&0x4u);
    cs |= (((uint32_t)(((uint32_t)(config->opMode.wait? 1UL : 0UL))<<1u))&0x2u);
    cs |= (((uint32_t)(((uint32_t)(config->opMode.stop? 1UL : 0UL))<<0u))&0x1u);
...
# 103 "../SDK/platform/hal/src/wdog/wdog_hal.c"
wdog_user_config_t WDOG_HAL_GetConfig(const WDOG_Type *base)
{
