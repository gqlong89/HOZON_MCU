# 1 "../Sources/app/scom/scom_task.c"
...
# 9 "../Sources/app/scom/scom_task.c" 2
...
# 12 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/scom/scom_tl.h" 2
...
# 11 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/scom/scom_can_msg.h" 2
...
# 10 "../Sources/app/scom/scom_task.c" 2
...
# 11 "../Sources/app/scom/scom_task.c" 2
...
# 13 "../Sources/app/scom/scom_task.c" 2
...
void uds_data_indication(void *uds_para, uint32_t u32AI, uint16_t u32PDU_DLC, uint8_t *pu8_PDUData,
                         uint8_t eNResult);
# 14 "../Sources/app/scom/scom_task.c" 2
...
# 15 "../Sources/app/scom/scom_task.c" 2
...
# 16 "../Sources/app/scom/scom_task.c" 2
...
# 17 "../Sources/app/scom/scom_task.c" 2
...
# 18 "../Sources/app/scom/scom_task.c" 2
...
# 19 "../Sources/app/scom/scom_task.c" 2
...
# 6 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/mid/msg/msg_parse.h" 2
...
# 20 "../Sources/app/scom/scom_task.c" 2
...
# 21 "../Sources/app/scom/scom_task.c" 2
...
# 22 "../Sources/app/scom/scom_task.c" 2
...
# 23 "../Sources/app/scom/scom_task.c" 2
...
# 26 "../Sources/app/scom/scom_task.c" 2
...
# 5 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/custom/custom.h" 2
...
# 27 "../Sources/app/scom/scom_task.c" 2
...
#define SPI_SUPPORT_EVENT ( TASK_SYS_EVENT_READ | TASK_SYS_EVENT_SEND | TASK_SYS_DATA_READ | SPI_TLS_TIMER | SPI_TLS_EX_TIMER | SPI_TLS_NM_STATE | SPI_TLS_BUSOFF_STATE| SPI_TLS_NM_LIMPHOME_STATE )
# 45 "../Sources/app/scom/scom_task.c"
#define SPI_TLS_TIMER_VALUE (200)
#define SPI_TLS_EX_TIMER_VALUE (2000)
#define SPI_SEND_NEXT_TIMER_VALUE (10)


unsigned char scom_taskid = 0xFF;
...
static unsigned char scom_upg_sate = 0;
...
static scom_custom_msg_cb scom_custom_fun = ((void *)0);
...
{
    scom_tl_send_msg(SCOM_TL_CMD_UPG_MCU_REQ, ((void *)0), 0);
}
...
void scom_proc_hb(unsigned char *msg, unsigned int len)
{
    ...
    if (!strlen(ver))
    {
        scom_set_mcu_upg_state(2);
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "invalid version" ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    if (0 != strncmp((const char *) ver, kernelGetVerNo(), strlen(kernelGetVerNo())))
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "new=[%s],old=[%s]", ver, kernelGetVerNo() ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "there is a new version" ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        scom_set_mcu_upg_state(1);
        unsigned int tmp = (0xaaaaaaaa);
        Flash_EEPROM_WriteBuffer((unsigned char *)&tmp, (((0x14000000U) + (3 * 1024))), 4);
        driverReset();
    }
    else
    {
...
void scom_msg_proc_ex(unsigned char *msg, unsigned int len)
{
    ...
    switch (tl_hdr->msg_type)
    {
        case SCOM_TL_CMD_SLEEP_REQ:
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "MPU SEND SHUTDOWN CMD" ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            PowerListen();
            break;
        ...
        case SCOM_TL_CMD_MPU_STATUS_SYN:
            ...
            break;
# 202 "../Sources/app/scom/scom_task.c"
...
{
    SCOM_TL_MSG_HDR *tl_hdr = (SCOM_TL_MSG_HDR *) msg;
    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "recv [%u,%u,%u]", tl_hdr->msg_type, tl_hdr->ftype, tl_hdr->flen ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
...
# 260 "../Sources/app/scom/scom_task.c"
void scom_reg_custom_msg_cb(scom_custom_msg_cb callback)
{
...
unsigned int scom_task(unsigned int mask)
{
    ...
    if (mask & (1<<16))
    {
        ...
        kernelEnableTimer(scom_tlsTimer, (200), (1<<19));
        kernelEnableTimer(scom_tlsExTimer, (2000), (1<<20));
        return 0;
    }
    ...
    if (mask & (1<<18))
    {
        ...
        if (ipc_send())
        {
            kernelEnableTimer(scom_sendNextTimer, (10), (1<<18));
        }
    }
    ...
    if (mask & (1<<17))
    {
        ...
        {
            rx_msg.used = 0;
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "rx_msg clean!" ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        }
...
# 378 "../Sources/app/scom/scom_task.c"
    if (mask & (~( (1<<17) | (1<<18) | (1<<23) | (1<<19) | (1<<20) | (1<<21) | (1<<22)| (1<<23) )))
    {

        mask &= (~( (1<<17) | (1<<18) | (1<<23) | (1<<19) | (1<<20) | (1<<21) | (1<<22)| (1<<23) ));
    }
