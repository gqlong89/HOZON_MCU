...
# 15 "../Sources/mid/gpio/gpio.c" 2


#define PORT_ISR_MAX_CNT 6
...
{
    {((PORT_Type *)(0x40049000u)), ((GPIO_Type *)(0x400FF000u)), PORTA_IRQn, porta_isr },
    {((PORT_Type *)(0x4004A000u)), ((GPIO_Type *)(0x400FF040u)), PORTB_IRQn, portb_isr },
    {((PORT_Type *)(0x4004B000u)), ((GPIO_Type *)(0x400FF080u)), PORTC_IRQn, portc_isr },
    {((PORT_Type *)(0x4004C000u)), ((GPIO_Type *)(0x400FF0C0u)), PORTD_IRQn, portd_isr },
    {((PORT_Type *)(0x4004D000u)), ((GPIO_Type *)(0x400FF100u)), PORTE_IRQn, porte_isr },
};
...
static void gpio_irq_handler(PORT_CTX *ctx, uint32_t int_flag)
{
    ...
    {
        if (0 == ctx->used[handle])
        {
            continue;
        }

        if ((int_flag & 1 << ctx->pins[handle]) && (((void *)0) != ctx->handler[handle]))
        {
...
void gpio_isr_init(GPIO_INT_CFG *cfg)
{
    ...
    if (((void *)0) == cfg || ((void *)0) == cfg->handler)
    {
        return;
    }
    ...
    if (handle == 6)
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "port[%d] isr list is full", cfg->port_num ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    GPIO_HAL_SetPinDirection(attr->gpio_base, cfg->port_pin, 0U);
    ...
    if (0 == ctx->cnt)
    {
        INT_SYS_InstallHandler(attr->irq, attr->isr, ((void *)0));
    }
...
void gpio_isr_deinit(PORT_NUM_TYPE port_num, unsigned int pin)
{
    ...
    for (handle = 0; handle < 6; handle++)
    {
        if (1 == ctx->used[handle] && ctx->pins[handle] == pin)
        {
            break;
        }
    }
    ...
    if (0 == ctx->cnt)
    {
        INT_SYS_InstallHandler(attr->irq, ((void *)0), ((void *)0));
        INT_SYS_DisableIRQ(attr->irq);
    }
}
...
static void porta_isr(void)
{
    uint32_t int_flag = PORT_HAL_GetPortIntFlag(((PORT_Type *)(0x40049000u)));
    PORT_HAL_ClearPortIntFlagCmd(((PORT_Type *)(0x40049000u)));
    gpio_irq_handler(port_ctx + PORT_NUM_A, int_flag);
}

static void portb_isr(void)
{
    uint32_t int_flag = PORT_HAL_GetPortIntFlag(((PORT_Type *)(0x4004A000u)));
    PORT_HAL_ClearPortIntFlagCmd(((PORT_Type *)(0x4004A000u)));
...
static void portc_isr(void)
{
    uint32_t int_flag = PORT_HAL_GetPortIntFlag(((PORT_Type *)(0x4004B000u)));
    PORT_HAL_ClearPortIntFlagCmd(((PORT_Type *)(0x4004B000u)));
    gpio_irq_handler(port_ctx + PORT_NUM_C, int_flag);
}

static void portd_isr(void)
{
    uint32_t int_flag = PORT_HAL_GetPortIntFlag(((PORT_Type *)(0x4004C000u)));
    PORT_HAL_ClearPortIntFlagCmd(((PORT_Type *)(0x4004C000u)));
    gpio_irq_handler(port_ctx + PORT_NUM_D, int_flag);
}

static void porte_isr(void)
{
    uint32_t int_flag = PORT_HAL_GetPortIntFlag(((PORT_Type *)(0x4004D000u)));
    PORT_HAL_ClearPortIntFlagCmd(((PORT_Type *)(0x4004D000u)));
