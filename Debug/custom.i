...
# 2 "../Sources/app/custom/custom.c" 2
...
# 3 "../Sources/app/custom/custom.c" 2
...
# 4 "../Sources/app/custom/custom.c" 2
...
# 5 "../Sources/app/custom/custom.c" 2
...
# 6 "../Sources/app/custom/custom.c" 2
...
# 7 "../Sources/app/custom/custom.c" 2
...
# 8 "../Sources/app/custom/custom.c" 2
...
# 9 "../Sources/app/custom/custom.c" 2
...
# 11 "../Sources/app/custom/custom.c" 2
...
# 12 "../Sources/app/custom/custom.c" 2
...
# 13 "../Sources/app/custom/custom.c" 2
...
# 14 "../Sources/app/custom/custom.c" 2
...
# 15 "../Sources/app/custom/custom.c" 2
...
# 16 "../Sources/app/custom/custom.c" 2
...
# 17 "../Sources/app/custom/custom.c" 2
...
# 40 "../Sources/app/custom/custom.c"
        ...
        case mes_app:
            {
                if (ctrl_value == 0)
                {
                    custom_can_ctrl_state &= (~(0x01<<0));
                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "msg APP EN" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                }
                else if (ctrl_value == 1)
                {
                    custom_can_ctrl_state |= (0x01<<0);
                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "msg APP DISEN" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                }
                else
                {}
        ...
        case mes_NM:
            {
                if (ctrl_value == 0)
                {
                    custom_can_ctrl_state &= (~(0x01<<1));
                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "msg NM EN" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                }
                else if (ctrl_value == 1)
                {
                    custom_can_ctrl_state |= (0x01<<1);

                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "msg NM DISEN" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                }
                else
                {
        ...
        case mes_all:
            {
                if (ctrl_value == 0)
                {
                    ...
                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "msg ALL EN" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                }
                else if (ctrl_value == 1)
                {
                    ...
                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "msg ALL DISEN" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                }
                else
                {
                                ...
                                unsigned int len)
{
  ...
  case SCOM_MPU_MCU_0x440:
  {
   ...
   {
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "0x440 len is wrong!!!" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
   }

   break;
  }
  case SCOM_MPU_MCU_0x445:
  {
   if(len == 8)
   {
   ...
   {
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "0x445 len is wrong!!!" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
   }

   break;
  }
  case SOCM_MCU_MPU_0x526:
  {
   if(len == 8)
   {
   ...
   {
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "0x526 len is wrong!!!" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
   }
  ...
  case SCOM_MCU_MPU_0x3d2:
  {
   ...
   {
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "0x3d2 len is wrong!!!" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
   }
...
{
    scom_reg_custom_msg_cb(scom_Custom_Msg_Proc);
    memset(buf_0x440state,0,8);
