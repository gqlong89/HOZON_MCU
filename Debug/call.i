...
# 6 "../Sources/mid/call/call.c" 2


#define CALL_TRIGGER_TIMEOUT (120*100)
...
{
    if ((driverGetUptime() - ecall_trigger_timeout) > (120*100))
    {
        return 1;
    }
    else
...
{
    if ((driverGetUptime() - bcall_trigger_timeout) > (120*100))
    {
        return 1;
    }
    else
...
{
    if ((driverGetUptime() - icall_trigger_timeout) > (120*100))
    {
        return 1;
    }
    else
...
void call_button_poll(void)
{
    ...
    if (pm_get_BCALL())
    {
        pm_B_Indicator_ctrl(1);
        call_button_status = 1;
    }
    else
    {
        pm_B_Indicator_ctrl(0);
    }

    if (pm_get_ECALL())
    {
        pm_E_Indicator_ctrl(1);
        call_button_status = 1;
    }
    else
    {
        pm_E_Indicator_ctrl(0);
    }
