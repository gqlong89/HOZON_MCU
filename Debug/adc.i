...
# 23 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/adc_driver.h" 2
...
# 25 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/adc_driver.h" 2
...
# 26 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/adc_driver.h" 2
...
#define ADC_SET_TIMEOUT_VAL 500

static unsigned int ADCValuePtr[(3)];
static unsigned int ADC_Index[(3)];
static unsigned int ADCBuf[(3)][(10)];

static unsigned int TestNo0 = 0;
...
static unsigned int ADC_CALL_TYPE = 0;

static unsigned int ADC_SPK_P = 0;
static unsigned int ADC_SPK_N = 0;
volatile _Bool spk_test_flag = 0;
volatile _Bool mic_test_flag = 1;

volatile _Bool adcConvDone = 1;
...
void ADC0Start(unsigned char no)
{
    ...
    ADC_DRV_ConfigChan((0UL), (0UL), &adc0_ChnCfg);
}

void ADC1Start(unsigned char no)
{
    adc1_ChnCfg.channel = no;
    ADC_DRV_ConfigChan((1UL), (0UL), &adc1_ChnCfg);
}
...
void ADCPolling(void)
{
    ...
    if (0U != ADC_DRV_GetConvCompleteFlag((0UL), (0UL)))
    {
        ADC_DRV_GetChanResult((0UL), (0UL), (uint16_t *) &g_conversionResult);
    ...
    if (0U != ADC_DRV_GetConvCompleteFlag((1UL), (0UL)))
    {
        ADC_DRV_GetChanResult((1UL), (0UL), (uint16_t *) &g_conversionResult);
    ...
    else if ((driverGetUptime() - tempUptime) > 500)
    {
        ADCSet0();
        tempUptime = driverGetUptime();
    }
...
unsigned int driverInitADC(void)
{
    ...
    ADC_DRV_ConfigConverter((0UL), &adcConvCfg);
    ADC_DRV_AutoCalibration((0UL));
    ADC_DRV_ConfigConverter((1UL), &adcConvCfg);
    ADC_DRV_AutoCalibration((1UL));
...
void spk_check_switch(_Bool enable)
{
    if (enable)
    {
        ...
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF040u)), 10U, 0U);
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF040u)), 11U, 1U);
        set_spk_test_flag(ENABLE);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF000u)), 0U, 1U);
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF040u)), 10U, 1U);
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF040u)), 11U, 0U);
...
void adc_Abat_init(void)
{
    ...
    while (1)
    {
        ...
        {
            abat_count = 0;
            ADC_DRV_GetChanResult((1UL), (0UL), (uint16_t *) &g_conversionResult1);
            abat_count++;
            break;
        }
