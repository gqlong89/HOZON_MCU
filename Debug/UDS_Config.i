# 1 "../Sources/app/tp/uds/UDS_Config.c"
...
# 2 "../Sources/app/tp/uds/UDS_Config.c" 2
# 12 "../Sources/app/tp/uds/UDS_Config.c"
    uds_t tUDS_Server;
    uds_t tUDS_Client;

    uds_t *pt_ServerUDS = &tUDS_Server;
    uds_t *pt_ClientUDS = &tUDS_Client;
    __attribute__((section(".large_data"))) unsigned char UDS_DATA_S[(0xFFF) +
    7];
    __attribute__((section(".large_data"))) unsigned char UDS_DATA_C[(0x800) +
    7];
