# 1 "../Sources/app/can_mgr/can_hardware.c"
...
# 9 "../Sources/app/can_mgr/can_hardware.c" 2

static unsigned int num_flex_can = 0;
void can_check_flexcan_phy_num(void)
{
    if (GPIO_ReadPinInput(((GPIO_Type *)(0x400FF100u)), 4U))
    {
        num_flex_can++;
    }

    if (GPIO_ReadPinInput(((GPIO_Type *)(0x400FF000u)), 12U))
    {
        num_flex_can++;
    }

    if (GPIO_ReadPinInput(((GPIO_Type *)(0x400FF080u)), 16U))
    {
        num_flex_can++;
    }
}
