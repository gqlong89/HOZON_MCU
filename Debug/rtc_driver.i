# 1 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
...
# 1 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
# 19 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
...
status_t CLOCK_SYS_GetFreq(clock_names_t clockName,
                           uint32_t *frequency);
# 24 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/rtc_driver.h" 2
...
# 25 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/rtc_driver.h" 2
...
# 26 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/rtc_driver.h" 2
...
# 20 "../SDK/platform/drivers/src/rtc/rtc_driver.c" 2
# 54 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
static RTC_Type * const g_rtcBase[(1u)] = { ((RTC_Type *)(0x4003D000u)) };


extern const IRQn_Type g_rtcIrqNumbers[(1u)];

extern const IRQn_Type g_rtcSecondsIrqNb[(1u)];
...
status_t RTC_DRV_Init(uint32_t instance, const rtc_init_config_t * const rtcUserCfg)
{
    ...
    g_rtcRuntimeConfig[instance].alarmConfig = ((void *)0);
    g_rtcRuntimeConfig[instance].intConfig = ((void *)0);
    g_rtcRuntimeConfig[instance].secondsIntConfig = ((void *)0);
    g_rtcRuntimeConfig[instance].isAlarmTimeNew = 0;




    if (RTC_HAL_IsRegisterLocked(basePtr, RTC_CTRL_REG_LOCK) == 1)
    {
...
# 165 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
status_t RTC_DRV_Deinit(uint32_t instance)
{
    ((void)0);
    ...
    if (RTC_HAL_IsRegisterLocked(g_rtcBase[instance], RTC_CTRL_REG_LOCK) == 1)
    {
        statusCode = STATUS_ERROR;
    }
    else
...
# 208 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
static _Bool RTC_DRV_CanWriteTCE(uint32_t instance)
{
    ((void)0);
    ...
    if (RTC_HAL_IsRegisterLocked(g_rtcBase[instance], RTC_STATUS_REG_LOCK) == 0)
    {
        result = 1;
    }
    ...
    else if (RTC_HAL_GetUpdateMode(g_rtcBase[instance]))
    {
        ...
        if ((tifFlagSet == 1) || (tofFlagSet == 1) || (tceFlagSet == 0))
        {
            result = 1;
        }
    }
...
# 253 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
status_t RTC_DRV_StartCounter(uint32_t instance)
{
    ((void)0);
    ...
    if (RTC_DRV_CanWriteTCE(instance) == 0)
    {
        statusCode = STATUS_ERROR;
    }
    else
...
# 284 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
status_t RTC_DRV_StopCounter(uint32_t instance)
{
    ((void)0);
...
# 315 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
status_t RTC_DRV_GetCurrentTimeDate(uint32_t instance, rtc_timedate_t * const currentTime)
{
    ((void)0);
    ((void)0);
...
# 370 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
status_t RTC_DRV_SetTimeDate(uint32_t instance, const rtc_timedate_t * const time)
{
    ((void)0);
    ...
    if (RTC_DRV_IsTimeDateCorrectFormat(time) == 0)
    {

        statusCode = STATUS_ERROR;
    }

    else if (RTC_DRV_CanWriteTCE(instance) == 0)
    {
...
# 413 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
status_t RTC_DRV_ConfigureRegisterLock(uint32_t instance, const rtc_register_lock_config_t * const lockConfig)
{
    ((void)0);
    ((void)0);
...
# 460 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
void RTC_DRV_GetRegisterLock(uint32_t instance, rtc_register_lock_config_t * const lockConfig)
{
    ((void)0);
    ((void)0);
...
# 488 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
status_t RTC_DRV_ConfigureTimeCompensation(uint32_t instance, uint8_t compInterval, int8_t compensation)
{
    ((void)0);
    ...
    if (RTC_HAL_IsRegisterLocked(g_rtcBase[instance], RTC_TCL_REG_LOCK) == 1)
    {
...
# 521 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
void RTC_DRV_GetTimeCompensation(uint32_t instance, uint8_t * compInterval, int8_t * compensation)
{
    ((void)0);
    ((void)0);
...
# 538 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
void RTC_DRV_ConvertSecondsToTimeDate(const uint32_t * const seconds, rtc_timedate_t * const timeDate)
{
    ...
    for (i = 1U; i <= 12U; i++)
    {
        uint32_t daysInCurrentMonth = ((yearLeap == 1) ? (uint32_t)LY[i] : (uint32_t)ULY[i]);
...
# 632 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
void RTC_DRV_ConvertTimeDateToSeconds(const rtc_timedate_t * const timeDate, uint32_t * const seconds)
{
    ((void)0);
    ((void)0);
...
# 682 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
_Bool RTC_DRV_IsTimeDateCorrectFormat(const rtc_timedate_t * const timeDate)
{
    ((void)0);
...
# 724 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
_Bool RTC_DRV_IsYearLeap(uint16_t year)
{
    _Bool isYearLeap = 0;
...
# 760 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
void RTC_DRV_IRQHandler(uint32_t instance)
{
    ((void)0);
    ...
    if (RTC_HAL_GetTimeAlarmFlag(g_rtcBase[instance]) == 1)
    {



        if ((alarmConfig != ((void *)0)))
        {



            if ((alarmConfig->numberOfRepeats > 0UL) || (alarmConfig->repeatForever == 1))
            {
                tempSeconds = RTC_HAL_GetTimeSecondsRegister(g_rtcBase[instance]);
                ...
                g_rtcRuntimeConfig[instance].isAlarmTimeNew = 1;



                alarmConfig->numberOfRepeats = (alarmConfig->repeatForever == 0) ? (alarmConfig->numberOfRepeats - 1UL) : 0UL;
            }
            else
            {
            ...
            if (alarmConfig->alarmCallback != ((void *)0))
            {
    ...
    else if ((intConfig->rtcCallback != ((void *)0)) && (intConfig != ((void *)0)))
    {
...
# 832 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
void RTC_DRV_SecondsIRQHandler(uint32_t instance)
{
    ((void)0);
    ...
    if ((intCfg != ((void *)0)) && (intCfg->rtcSecondsCallback != ((void *)0)))
    {
        intCfg->rtcSecondsCallback(intCfg->secondsCallbackParams);
    }
}
# 857 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
void RTC_DRV_ConfigureFaultInt(uint32_t instance, rtc_interrupt_config_t * const intConfig)
{
    ((void)0);
    ((void)0);
...
# 884 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
void RTC_DRV_ConfigureSecondsInt(uint32_t instance, rtc_seconds_int_config_t * const intConfig)
{
    ((void)0);
    ((void)0);
...
# 914 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
status_t RTC_DRV_ConfigureAlarm(uint32_t instance, rtc_alarm_config_t * const alarmConfig)
{
    ((void)0);
    ((void)0);
    ...
    if (RTC_DRV_IsTimeDateCorrectFormat(&(alarmConfig->alarmTime)) == 1)
    {
...
# 968 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
void RTC_DRV_GetAlarmConfig(uint32_t instance, rtc_alarm_config_t * alarmConfig)
{
    ((void)0);
    ((void)0);
...
# 983 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
_Bool RTC_DRV_IsAlarmPending(uint32_t instance)
{
    ((void)0);
...
# 1000 "../SDK/platform/drivers/src/rtc/rtc_driver.c"
status_t RTC_DRV_GetNextAlarmTime(uint32_t instance, rtc_timedate_t * const alarmTime)
{
    ((void)0);
    ((void)0);
    ...
    if (g_rtcRuntimeConfig[instance].isAlarmTimeNew == 1)
    {
