# 1 "../Sources/mid/can_flexcan/can_flexcan.c"
...
# 9 "../Sources/mid/can_flexcan/can_flexcan.c" 2

# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/devassert.h" 1
# 11 "../Sources/mid/can_flexcan/can_flexcan.c" 2
...
# 35 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/flexcan_driver.h" 2
...
# 37 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/flexcan_driver.h" 2
...
# 12 "../Sources/mid/can_flexcan/can_flexcan.c" 2
...
# 14 "../Sources/mid/can_flexcan/can_flexcan.c" 2
...
# 15 "../Sources/mid/can_flexcan/can_flexcan.c" 2
...
# 19 "../Sources/mid/can_flexcan/can_flexcan.c" 2
...
# 20 "../Sources/mid/can_flexcan/can_flexcan.c" 2
...
# 21 "../Sources/mid/can_flexcan/can_flexcan.c" 2

# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/S32K144/include/S32K144.h" 1
# 168 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/S32K144/include/S32K144.h"
extern unsigned int irq_cnt[20];
# 23 "../Sources/mid/can_flexcan/can_flexcan.c" 2
...
# 24 "../Sources/mid/can_flexcan/can_flexcan.c" 2
...
# 25 "../Sources/mid/can_flexcan/can_flexcan.c" 2
...
# 26 "../Sources/mid/can_flexcan/can_flexcan.c" 2
...
# 28 "../Sources/mid/can_flexcan/can_flexcan.c" 2

void flexcan_ecallbl_ctrl(CAN_MSG msg);
flexcan_state_t can_flexcan_State[3];

static volatile uint32_t txComplete[3];
static flexcan_msgbuff_t rxFrame[3];
...
static void flexcan_recv_data(uint8_t instance, uint32_t status)
{
 ...
 CAN_SEND_MSG can;
    ...
    msg.MsgID = (frame->cs & 0x200000u) ? (frame->msgId | (1u << 31)) : (frame->msgId);
    msg.brs = !!(frame->cs & 0x40000000u);
    msg.isEID = !!(frame->cs & 0x200000u);
    msg.canFD = !!(frame->cs & 0x80000000u);
    msg.esi = !!(frame->cs & 0x20000000u);
    msg.isRTR = !!(frame->cs & 0x100000u);
 ...
 NM_PDU_ReceiveCheck(instance, &msg);
    ...
    if ((can_buf = (CAN_MSG *)ipc_can_handle(SPI_GET_FRAME)) != ((void *)0))
    {
...
# 158 "../Sources/mid/can_flexcan/can_flexcan.c"
 if(nm_canState[instance].nm_currentState == NM_SLEEP_MODE_STATE)
 {
  ...
  CanBus_ErrorCheck_AUTUSAR(instance);
    ...
    {
        can_err_set(instance, (1<<2));
    }

    if (result & kFLEXCAN_BusOffIntFlag)
    {
        can_err_set(instance, (1<<1));
    }
}
...
int flexcan_init(uint8_t instance, tCanBaud baud, flexcan_operation_modes_t mode)
{
 ...
 if((instance == CAN_PORT0)&&(baud.canfd_en == 1))
 {
  initConfig.fd_enable = baud.canfd_en;
        ...
        initConfig.max_num_mb = TX_CAN_BUFF_MAX + 1;
        initConfig.num_id_filters = FLEXCAN_RX_FIFO_ID_FILTERS_8;
        initConfig.is_rx_fifo_needed = 0;
 ...
 {
  initConfig.fd_enable = 0;
  initConfig.pe_clock = FLEXCAN_CLK_SOURCE_SYS;
  initConfig.max_num_mb = TX_CAN_NORMAL_BUFF_MAX + 1;
  initConfig.num_id_filters = FLEXCAN_RX_FIFO_ID_FILTERS_8;
  initConfig.is_rx_fifo_needed = 0;
  initConfig.flexcanMode = mode;
 ...
 if((instance == CAN_PORT0)&&(baud.canfd_en == 1))
 {
  memset(&rxFrame[instance], 0, sizeof(flexcan_msgbuff_t));
     ...
     FLEXCAN_DRV_ConfigRxMb(instance, RX_CAN_STD, &dataInfo, 0);

     dataInfo.msg_id_type = FLEXCAN_MSG_ID_EXT;

     FLEXCAN_DRV_ConfigRxMb(instance, RX_CAN_EXT, &dataInfo, 0);
     ...
     FLEXCAN_DRV_InstallEventCallback(instance, flexcan_callback, ((void *)0));
...
int flexcan_deinit(uint8_t instance)
{
    ...
    can_flexcan_State[instance].callback = ((void *)0);
    return (int)ret;
}
...
void flexcan_set_errint(uint8_t instance, _Bool enable)
{
...
void flexcan_ecallbl_ctrl(CAN_MSG msg)
{
    if(msg.MsgID == 0x339)
 {
  if(msg.Data[2] & 0x02)
  {
   GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)),15,1);
  }
  else
  {
   GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)),15,0);
  }
 }
}
