# 1 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
...
# 1 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
# 63 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
...
uint16_t FTM_DRV_ConvertFreqToPeriodTicks(uint32_t instance,
                                          uint32_t freqencyHz);
# 64 "../SDK/platform/drivers/src/ftm/ftm_driver.c" 2
...
static const clock_names_t g_ftmExtClockSel[(4u)][2] = {{SIM_FTM0_CLOCKSEL, PCC_FTM0_CLOCK},
...
# 136 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_Init(uint32_t instance,
                      const ftm_user_config_t * info,
                      ftm_state_t * state)
{
    ...
    if (STATUS_SUCCESS == status)
    {
        ...
        {
            FTM_HAL_SetTimerOverflowInt(ftmBase, 1);
            INT_SYS_EnableIRQ(g_ftmOverflowIrqId[instance]);
        }
        else
        {
            FTM_HAL_SetTimerOverflowInt(ftmBase, 0);
...
# 205 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_Deinit(uint32_t instance)
{
    ((void)0);
    FTM_Type * ftmBase = g_ftmBase[instance];
...
# 228 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_InitCounter(uint32_t instance,
                             const ftm_timer_param_t * timer)
{
    ((void)0);
    ...
    if ((((void *)0) != state) && (FTM_MODE_NOT_INITIALIZED == state->ftmMode))
    {
        ...
        FTM_HAL_SetQuadDecoderCmd(ftmBase, 0);
...
# 287 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_CounterStart(uint32_t instance)
{
    ((void)0);
    FTM_Type * ftmBase = g_ftmBase[instance];
...
# 308 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_CounterStop(uint32_t instance)
{
    ((void)0);
    FTM_Type * ftmBase = g_ftmBase[instance];
...
# 328 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
uint32_t FTM_DRV_CounterRead(uint32_t instance)
{
    ((void)0);
...
# 343 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_DeinitPwm(uint32_t instance)
{
    ((void)0);
    FTM_Type * ftmBase = g_ftmBase[instance];
    ...
    for (channel = 0U; channel < (8U); channel++)
    {
        ...
        FTM_HAL_SetDualChnPwmSyncCmd(ftmBase, chnlPairNum, 0);

        FTM_HAL_SetDualChnMofCombineCmd(ftmBase, chnlPairNum, 0);
        FTM_HAL_SetDualChnCombineCmd(ftmBase, chnlPairNum, 0);
        FTM_HAL_SetDualChnDeadtimeCmd(ftmBase, chnlPairNum, 0);
        FTM_HAL_SetDualChnFaultCmd(ftmBase, chnlPairNum, 0);
    }
...
# 399 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_InitPwm(uint32_t instance,
                         const ftm_pwm_param_t * param)
{
    ((void)0);
    ...
    if ((((void *)0) != state) && (FTM_MODE_NOT_INITIALIZED == state->ftmMode))
    {
        ...
        for (index = 0U; index < param->nNumIndependentPwmChannels; index++)
        {
            ...
            FTM_HAL_SetDualEdgeCaptureCmd(ftmBase, chnlPairNum, 0);
            ...
            FTM_HAL_SetDualChnFaultCmd(ftmBase, chnlPairNum, ((param->faultConfig)->faultMode != FTM_FAULT_CONTROL_DISABLED) ? 1 : 0);

            FTM_HAL_SetDualChnPwmSyncCmd(ftmBase, chnlPairNum, 1);
            FTM_HAL_SetDualChnCombineCmd(ftmBase, chnlPairNum, 0);
            FTM_HAL_SetDualChnMofCombineCmd(ftmBase, chnlPairNum, 0);
        ...
        for (index = 0U; index < param->nNumCombinedPwmChannels; index++)
        {
            ...
            FTM_HAL_SetDualChnCombineCmd(ftmBase, chnlPairNum, 1);
        ...
        FTM_HAL_SetInitChnOutputCmd(ftmBase, 1);

        if ((param->faultConfig)->faultMode != FTM_FAULT_CONTROL_DISABLED)
        {

            FTM_HAL_SetPwmFaultBehavior(ftmBase, ((param->faultConfig)->pwmOutputStateOnFault) ? 1 : 0);
            ...
            for (fltChannel = 0U; fltChannel < (4U); fltChannel++)
            {
                if (1 == (param->faultConfig)->ftmFaultChannelParam[fltChannel].faultChannelEnabled)
                {
                    ...
                    FTM_HAL_SetFaultInputCmd(ftmBase, fltChannel, 1);
        ...
        FTM_HAL_SetCpwms(ftmBase, (param->mode == FTM_MODE_CEN_ALIGNED_PWM) ? 1 : 0);
        ...
        if (STATUS_SUCCESS == retVal)
        {
            ...
            FTM_HAL_Enable(ftmBase, 1);
            FTM_HAL_SetPwmSyncMode(ftmBase, 1);
...
# 606 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_UpdatePwmChannel(uint32_t instance,
                                  uint8_t channel,
                                  ftm_pwm_update_option_t typeOfUpdate,
                                  uint16_t firstEdge,
                                  ...
                                  _Bool softwareTrigger)
{
    ...
    {
        if (1 == FTM_HAL_GetDualChnCombineCmd(ftmBase, chnlPairNum))
        {
            if (1 == FTM_HAL_GetDualChnMofCombineCmd(ftmBase, chnlPairNum))
            {
        ...
        if (softwareTrigger)
        {
            FTM_HAL_SetSoftwareTriggerCmd(ftmBase, 1);
        }
...
# 738 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_UpdatePwmPeriod(uint32_t instance,
                                 ftm_pwm_update_option_t typeOfUpdate,
                                 uint32_t newValue,
                                 _Bool softwareTrigger)
...
# 801 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_MaskOutputChannels(uint32_t instance,
                                    uint32_t channelsMask,
                                    _Bool softwareTrigger)
{
...
# 825 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_SetInitialCounterValue(uint32_t instance,
                                        uint16_t counterValue,
                                        _Bool softwareTrigger)
{
...
# 849 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_SetHalfCycleReloadPoint(uint32_t instance,
                                         uint16_t reloadPoint,
                                         _Bool softwareTrigger)
{
...
# 875 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_SetSoftOutChnValue(uint32_t instance,
                                    uint8_t channelsValues,
                                    _Bool softwareTrigger)
{
...
# 898 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_SetSoftwareOutputChannelControl(uint32_t instance,
                                                 uint8_t channelsMask,
                                                 _Bool softwareTrigger)
{
...
# 921 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_SetInvertingControl(uint32_t instance,
                                     uint8_t channelsPairMask,
                                     _Bool softwareTrigger)
{
...
# 944 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_SetModuloCounterValue(uint32_t instance,
                                       uint16_t counterValue,
                                       _Bool softwareTrigger)
{
...
# 970 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_SetSync(uint32_t instance,
                         const ftm_pwm_sync_t * param)
{
    ((void)0);
    ...
    else if (param->softwareSync)
    {
        ...
        FTM_HAL_SetOutmaskSoftwareSyncModeCmd(ftmBase, 1);

        FTM_HAL_SetInvctrlSoftwareSyncModeCmd(ftmBase, 1);

        FTM_HAL_SetSwoctrlSoftwareSyncModeCmd(ftmBase, 1);

        FTM_HAL_SetModCntinCvSoftwareSyncModeCmd(ftmBase, 1);
    ...
    else
    {
        ...
        FTM_HAL_SetOutmaskHardwareSyncModeCmd(ftmBase, 1);

        FTM_HAL_SetInvctrlHardwareSyncModeCmd(ftmBase, 1);

        FTM_HAL_SetSwoctrlHardwareSyncModeCmd(ftmBase, 1);

        FTM_HAL_SetModCntinCvHardwareSyncModeCmd(ftmBase, 1);

        FTM_HAL_SetCounterHardwareSyncModeCmd(ftmBase, (_Bool)param->syncPoint);
    }

    if (STATUS_SUCCESS == retStatus)
    {

        FTM_HAL_SetPwmSyncModeCmd(ftmBase, 1);
        ...
        FTM_HAL_SetOutmaskPwmSyncModeCmd(ftmBase, (_Bool)param->maskRegSync);
...
# 1047 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_InitOutputCompare(uint32_t instance,
                                   const ftm_output_cmp_param_t * param)
{
    ((void)0);
...
# 1110 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_DeinitOutputCompare(uint32_t instance,
                                     const ftm_output_cmp_param_t * param)
{
    ((void)0);
...
# 1152 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_UpdateOutputCompareChannel(uint32_t instance,
                                            uint8_t channel,
                                            uint16_t nextComparematchValue,
                                            ftm_output_compare_update_t update,
...
# 1205 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_InitInputCapture(uint32_t instance,
                                  const ftm_input_param_t * param)
{
    ((void)0);
    ...
    if ((((void *)0) != state) && (FTM_MODE_NOT_INITIALIZED == state->ftmMode))
    {
        ...
        for (index = 0U; index < param->nNumChannels; index++)
        {
            ...
            if (hwChannel < (4U))
            {
                if (1 == param->inputChConfig[index].filterEn)
                {
            ...
            else if (FTM_SIGNAL_MEASUREMENT == param->inputChConfig[index].inputMode)
            {
                ...
                FTM_HAL_SetDualEdgeCaptureCmd(ftmBase, chnlPairNum, 1);

                FTM_HAL_SetDualChnDecapCmd(ftmBase, chnlPairNum, 1);

                if (1 == param->inputChConfig[index].continuousModeEn)
                {
...
# 1350 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_DeinitInputCapture(uint32_t instance,
                                    const ftm_input_param_t * param)
{
    ((void)0);
...
# 1402 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
uint16_t FTM_DRV_GetInputCaptureMeasurement(uint32_t instance,
                                            uint8_t channel)
{
    ((void)0);
...
# 1431 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_StartNewSignalMeasurement(uint32_t instance,
                                           uint8_t channel)
{
    ((void)0);
    ...
    if ((2U) == FTM_HAL_GetChnMode(ftmBase, channel))
    {
...
# 1468 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_QuadDecodeStart(uint32_t instance,
                                 const ftm_quad_decode_config_t * config)
{
    ((void)0);
    ...
    if ((((void *)0) != state) && (FTM_MODE_NOT_INITIALIZED == state->ftmMode))
    {
        ...
        {
            FTM_HAL_SetChnInputCaptureFilter(ftmBase, (0U), config->phaseAConfig.phaseFilterVal);
        }
        ...
        {
            FTM_HAL_SetChnInputCaptureFilter(ftmBase, (1U), config->phaseBConfig.phaseFilterVal);
        }
        ...
        FTM_HAL_SetQuadDecoderCmd(ftmBase, 1);
...
# 1527 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
status_t FTM_DRV_QuadDecodeStop(uint32_t instance)
{
    ((void)0);
    FTM_Type * ftmBase = g_ftmBase[instance];
...
# 1548 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
ftm_quad_decoder_state_t FTM_DRV_QuadGetState(uint32_t instance)
{
    ((void)0);
    FTM_Type const * ftmBase = g_ftmBase[instance];
...
# 1571 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
uint32_t FTM_DRV_GetFrequency(uint32_t instance)
{
    ((void)0);
    PCC_Type const * pccBase = { ((PCC_Type *)(0x40065000u)) };
    FTM_Type const * ftmBase = g_ftmBase[instance];
...
# 1623 "../SDK/platform/drivers/src/ftm/ftm_driver.c"
uint16_t FTM_DRV_ConvertFreqToPeriodTicks(uint32_t instance,
                                          uint32_t freqencyHz)
{
    ((void)0);
                                        ...
                                        uint8_t channelPair)
{
    ...
    if (FTM_HAL_GetDualEdgeCaptureBit(ftmBase, channelPair))
    {
        ...
        if ((state->channelsCallbacks[(channelPair << 1U)]) != ((void *)0))
        {
    ...
    else
    {
        ...
        else
        {
            ...
            if ((state->channelsCallbacks[(channelPair << 1U) + 1U]) != ((void *)0))
            {
