# 1 "../Sources/app/tp/uds/UDS_NSData.c"
...
# 6 "../Sources/app/tp/uds/UDS_NSData.c" 2
...
# 7 "../Sources/app/tp/uds/UDS_NSData.c" 2
...
# 8 "../Sources/app/tp/uds/UDS_NSData.c" 2
# 21 "../Sources/app/tp/uds/UDS_NSData.c"
void N_USData_Init(uds_t *tUDS)
{
    tUDS->UDS_ApplIndication_Handle = (void*) 0;

    L_Data_Init(tUDS);
    UDS_CAN_Init(tUDS);
    UDS_Timer_Init(tUDS);

    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "UDSTP V2.0" ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
}
# 39 "../Sources/app/tp/uds/UDS_NSData.c"
...
# 81 "../Sources/app/tp/uds/UDS_NSData.c"
void N_USData_confirm(uds_t *tUDS, uint32_t u32AI, uint8_t eNResult)
{
    if (tUDS->UDS_ApplConfirm_Handle != (void*) 0)
    {
