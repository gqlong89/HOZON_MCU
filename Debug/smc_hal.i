# 1 "../SDK/platform/hal/src/smc/smc_hal.c"
...
# 1 "../SDK/platform/hal/src/smc/smc_hal.c"
# 51 "../SDK/platform/hal/src/smc/smc_hal.c"
...
# 23 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/smc_hal.h" 2
...
# 52 "../SDK/platform/hal/src/smc/smc_hal.c" 2
...
# 53 "../SDK/platform/hal/src/smc/smc_hal.c" 2
# 63 "../SDK/platform/hal/src/smc/smc_hal.c"
...
# 82 "../SDK/platform/hal/src/smc/smc_hal.c"
void SMC_HAL_GetVersion(const SMC_Type* const baseAddr, smc_version_info_t* const versionInfo)
{
    uint32_t regValue;
...
# 115 "../SDK/platform/hal/src/smc/smc_hal.c"
status_t SMC_HAL_SetPowerMode(SMC_Type* const baseAddr,
                              const smc_power_mode_config_t* const powerModeConfig)
{
    status_t retCode;
    ...
    case POWER_MANAGER_HSRUN:
        ...
        retCode = STATUS_SUCCESS;
        break;
# 211 "../SDK/platform/hal/src/smc/smc_hal.c"
...
# 273 "../SDK/platform/hal/src/smc/smc_hal.c"
void SMC_HAL_SetProtectionMode(SMC_Type* const baseAddr,
                               const smc_power_mode_protection_config_t* const protectConfig)
{
...
# 305 "../SDK/platform/hal/src/smc/smc_hal.c"
_Bool SMC_HAL_GetProtectionMode(const SMC_Type* const baseAddr, const power_modes_protect_t protect)
{
    _Bool retValue;
...
# 343 "../SDK/platform/hal/src/smc/smc_hal.c"
static _Bool SMC_HAL_WaitForStatChange(const SMC_Type* const baseAddr, const power_mode_stat_t mode, const uint32_t timeout)
{
    uint32_t i;
    _Bool retValue;
