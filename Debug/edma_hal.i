# 1 "../SDK/platform/hal/src/edma/edma_hal.c"
...
# 1 "../SDK/platform/hal/src/edma/edma_hal.c"
# 29 "../SDK/platform/hal/src/edma/edma_hal.c"
...
# 39 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/edma_hal.h" 2
...
# 40 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/edma_hal.h" 2
...
# 41 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/edma_hal.h" 2
...
# 30 "../SDK/platform/hal/src/edma/edma_hal.c" 2
# 42 "../SDK/platform/hal/src/edma/edma_hal.c"
void EDMA_HAL_Init(DMA_Type * base)
{
    uint32_t i;
...
# 70 "../SDK/platform/hal/src/edma/edma_hal.c"
void EDMA_HAL_CancelTransfer(DMA_Type * base)
{
    uint32_t regValTemp;
    regValTemp = base->CR;
...
# 88 "../SDK/platform/hal/src/edma/edma_hal.c"
void EDMA_HAL_CancelTransferWithError(DMA_Type * base)
{
    uint32_t regValTemp;
    regValTemp = base->CR;
...
# 106 "../SDK/platform/hal/src/edma/edma_hal.c"
void EDMA_HAL_SetErrorIntCmd(DMA_Type * base, uint8_t channel, _Bool enable)
{
    if (enable)
    {
...
# 125 "../SDK/platform/hal/src/edma/edma_hal.c"
void EDMA_HAL_SetDmaRequestCmd(DMA_Type * base, uint8_t channel,_Bool enable)
{
...
# 172 "../SDK/platform/hal/src/edma/edma_hal.c"
void EDMA_HAL_TCDClearReg(DMA_Type * base,uint32_t channel)
{
...
# 194 "../SDK/platform/hal/src/edma/edma_hal.c"
void EDMA_HAL_TCDSetAttribute(
                DMA_Type * base, uint32_t channel,
                edma_modulo_t srcModulo, edma_modulo_t destModulo,
                edma_transfer_size_t srcTransferSize, edma_transfer_size_t destTransferSize)
...
# 256 "../SDK/platform/hal/src/edma/edma_hal.c"
uint32_t EDMA_HAL_TCDGetNbytes(const DMA_Type * base, uint32_t channel)
{
...
# 297 "../SDK/platform/hal/src/edma/edma_hal.c"
void EDMA_HAL_TCDSetMinorLoopOffset(DMA_Type * base, uint32_t channel, int32_t offset)
{
...
# 347 "../SDK/platform/hal/src/edma/edma_hal.c"
...
# 388 "../SDK/platform/hal/src/edma/edma_hal.c"
void EDMA_HAL_TCDSetMajorCount(DMA_Type * base, uint32_t channel, uint32_t count)
{
...
# 429 "../SDK/platform/hal/src/edma/edma_hal.c"
uint32_t EDMA_HAL_TCDGetBeginMajorCount(const DMA_Type * base, uint32_t channel)
{
    ...
    if (((base->TCD[channel].BITER.ELINKNO & 0x8000u) >> 15u) != 0U)
    {
        result = (uint16_t)((base->TCD[channel].BITER.ELINKYES & 0x1FFu) >> 0u);
    }
    else
    {
        result = (uint16_t)((base->TCD[channel].BITER.ELINKNO & 0x7FFFu) >> 0u);
    }
    return (uint32_t) result;
}
# 454 "../SDK/platform/hal/src/edma/edma_hal.c"
uint32_t EDMA_HAL_TCDGetCurrentMajorCount(const DMA_Type * base, uint32_t channel)
{
...
# 480 "../SDK/platform/hal/src/edma/edma_hal.c"
uint32_t EDMA_HAL_TCDGetUnfinishedBytes(const DMA_Type * base, uint32_t channel)
{
...
# 510 "../SDK/platform/hal/src/edma/edma_hal.c"
uint32_t EDMA_HAL_TCDGetFinishedBytes(const DMA_Type * base, uint32_t channel)
{
