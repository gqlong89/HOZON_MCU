# 1 "../Sources/mid/power_mode_switch/power_mode_switch.c"
...
# 2 "../Sources/mid/power_mode_switch/power_mode_switch.c" 2
...
# 3 "../Sources/mid/power_mode_switch/power_mode_switch.c" 2
...
void power_mode_switch_init(void)
{
    ...
    POWER_SYS_Init(&pwrCfgArr, (7u), &pwrStaticCallbacksCfgsArr, 0);
}
...
void power_mode_switch_VLPR(void)
{
    POWER_SYS_SetMode((2u), POWER_MANAGER_POLICY_AGREEMENT);
}

void power_mode_switch_STOP(void)
{
    POWER_SYS_SetMode((3u), POWER_MANAGER_POLICY_AGREEMENT);
}

void power_mode_switch_STOP1(void)
{
    POWER_SYS_SetMode((4u), POWER_MANAGER_POLICY_AGREEMENT);
}

void power_mode_switch_STOP2(void)
{
    POWER_SYS_SetMode((5u), POWER_MANAGER_POLICY_AGREEMENT);
}

void power_mode_switch_VLPS(void)
{
    POWER_SYS_SetMode((6u), POWER_MANAGER_POLICY_AGREEMENT);
}
