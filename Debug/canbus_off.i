# 1 "../Sources/app/can_mgr/canbus_off.c"
...
# 6 "../Sources/app/can_mgr/canbus_off.c" 2
...
# 7 "../Sources/app/can_mgr/canbus_off.c" 2
...
# 8 "../Sources/app/can_mgr/canbus_off.c" 2
...
# 10 "../Sources/app/can_mgr/canbus_off.c" 2
...
# 11 "../Sources/app/can_mgr/canbus_off.c" 2
...
# 12 "../Sources/app/can_mgr/canbus_off.c" 2
...
# 13 "../Sources/app/can_mgr/canbus_off.c" 2
...
# 15 "../Sources/app/can_mgr/canbus_off.c" 2
...
static int8_t timer_canport_recover[3] = {(-1), (-1), (-1)};

static int8_t timer_busoff_counter_clear_timer[2] = {(-1),(-1)};

CAN_RECOVER_STRATEGY str_canport_recover[3];
...
#define SPI_TLS_NM_LIMPHOME_STATE TASK_SYS_EVENT_REQST2
...
static void can_recover_port0_ISR(int8_t handle)
{
 ...
 can_basic_cfg.busoff_cfg.busoff_recover_fun(CAN_PORT0);
   ...
   if(count_busoff_port[0] < 6)
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "can%d: fast, busoff = %d", 0, count_busoff_port[0] ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    }
    else
    {
  ltimer_stop(timer_canport_recover[0]);
  ltimer_start(timer_canport_recover[0], can_basic_cfg.busoff_cfg.slow_recover_cycle);
  do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "can%d: slow, busoff = %d", 0, count_busoff_port[0] ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    }
}
...
static void can_recover_port1_ISR(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "can%d: fast busoff = %d", 1, count_busoff_port[1] ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    }
    else
    {
  ltimer_stop(timer_canport_recover[1]);
  ltimer_start(timer_canport_recover[1], can_basic_cfg.busoff_cfg.slow_recover_cycle);
  do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "can%d: slow busoff = %d", 1, count_busoff_port[1] ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    }
}
...
void can_busOffMgr(unsigned char canport, unsigned char state)
{
  ...
  if (can_busoff_flag[canport] != 1)
        {
            can_busoff_flag[canport] = 1;
            stop_BC_timerByChl(canport);
   ...
   else
   {
    ...
    ltimer_start(timer_canport_recover[canport], can_basic_cfg.busoff_cfg.slow_recover_cycle);
   }
# 184 "../Sources/app/can_mgr/canbus_off.c"
        }

        can_init(canport,can_default_baud.baud[canport]);
   ...
   count_busoff_port[canport] = 6;
    ...
    else if (state == (1<<7))
    {
        if (can_busoff_flag[canport] == 1)
        {
            ...
            ltimer_stop(timer_canport_recover[canport]);
            start_BC_timerByChl(canport);
   str_canport_recover[canport].cL1ToL2 = 0;
            APP_ClearTxFifo(canport);
# 217 "../Sources/app/can_mgr/canbus_off.c"
        }
    }
    else
    {}
