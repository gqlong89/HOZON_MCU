...
# 4 "../Sources/mid/srs/srs.c" 2

# 1 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\lib\\gcc\\arm-none-eabi\\4.9.3\\include\\stddef.h" 1 3 4
# 6 "../Sources/mid/srs/srs.c" 2
...
void SRS_CRTL(void)
{
    frequency = FTM_DRV_GetFrequency((0U));


    inputCaptureMeas = FTM_DRV_GetInputCaptureMeasurement((0U), 4U);

    FTM_DRV_ClearInputCaptureMeasurement((0U), 4U);
}
...
void srs_init(void)
{
    ...
    ftm_input_param_t srs_InputCaptureConfig =
    {
        1U,
        65535U,
        srs_InputCaptureChnCfg
    };




    FTM_DRV_Init((0U), &srs_config, &ftm0StateStruct);


    FTM_DRV_InitInputCapture((0U), &srs_InputCaptureConfig);
}
