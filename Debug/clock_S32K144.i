# 1 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.c"
...
# 1 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.c"
# 49 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.c"
# 1 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.h" 1
# 20 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.h"
...
# 23 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/scg_hal.h" 2
...
# 24 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/scg_hal.h" 2
...
# 23 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.h" 2
...
# 24 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.h" 2
...
# 25 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.h" 2
...
# 26 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.h" 2
...
# 27 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.h" 2
# 57 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.h"
status_t CLOCK_SYS_SetScgConfiguration(const scg_config_t *scgConfig);
# 67 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.h"
void CLOCK_SYS_SetPccConfiguration(const pcc_config_t *peripheralClockConfig);
# 77 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.h"
void CLOCK_SYS_SetSimConfiguration(const sim_clock_config_t *simClockConfig);
# 87 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.h"
void CLOCK_SYS_SetPmcConfiguration(const pmc_config_t *pmcConfig);
# 50 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.c" 2
...
status_t CLOCK_SYS_GetFreq(clock_names_t clockName,
                           uint32_t *frequency);
# 51 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.c" 2

# 1 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\lib\\gcc\\arm-none-eabi\\4.9.3\\include\\stddef.h" 1 3 4
# 53 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.c" 2
# 67 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.c"
...
# 109 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.c"
status_t CLOCK_SYS_SetConfiguration(clock_manager_user_config_t const* config)
{
    status_t result;
    ((void)0);
...
# 139 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.c"
status_t CLOCK_SYS_SetScgConfiguration(const scg_config_t *scgConfig)
{
    ...
    if (scgConfig != ((void *)0))
    {
        ...
        if (status == STATUS_SUCCESS)
        {
            ...
            if (scgConfig->clockModeConfig.initialize)
            {
                ...
                status = SCG_HAL_SetSystemClockConfig(((SCG_Type *)(0x40064000u)), SCG_SYSTEM_CLOCK_MODE_RUN, &(scgConfig->clockModeConfig.rccrConfig));
                if (status == STATUS_SUCCESS)
                {
                    status = SCG_HAL_SetSystemClockConfig(((SCG_Type *)(0x40064000u)), SCG_SYSTEM_CLOCK_MODE_VLPR, &(scgConfig->clockModeConfig.vccrConfig));
                }
                if (status == STATUS_SUCCESS)
                {
                    status = SCG_HAL_SetSystemClockConfig(((SCG_Type *)(0x40064000u)), SCG_SYSTEM_CLOCK_MODE_HSRUN, &(scgConfig->clockModeConfig.hccrConfig));
                }
            }
        }
    }
...
# 198 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.c"
void CLOCK_SYS_SetPccConfiguration(const pcc_config_t *peripheralClockConfig)
{
    ((void)0);
    PCC_HAL_SetPeripheralClockConfig(((PCC_Type *)(0x40065000u)), peripheralClockConfig);
}
# 211 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.c"
void CLOCK_SYS_SetSimConfiguration(const sim_clock_config_t *simClockConfig)
{
    ((void)0);
    uint8_t i;
...
# 262 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.c"
void CLOCK_SYS_SetPmcConfiguration(const pmc_config_t *pmcConfig)
{
    ((void)0);
    ...
    if (pmcConfig->lpoClockConfig.initialize)
    {
        ...
        PMC_HAL_SetLpoMode(((PMC_Type *)(0x4007D000u)),pmcConfig->lpoClockConfig.enable);


        PMC_HAL_SetLpoTrimValue(((PMC_Type *)(0x4007D000u)),pmcConfig->lpoClockConfig.trimValue);
    }
}
# 284 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.c"
                                          ...
                                          uint32_t *frequency)
{
    ...
    switch (clockName)
    {
        ...
        case CORE_CLOCK:
            freq = SCG_HAL_GetSystemClockFreq(((SCG_Type *)(0x40064000u)),SCG_SYSTEM_CLOCK_CORE);
            break;
        case BUS_CLOCK:
            freq = SCG_HAL_GetSystemClockFreq(((SCG_Type *)(0x40064000u)),SCG_SYSTEM_CLOCK_BUS);
            break;
        case SLOW_CLOCK:
            freq = SCG_HAL_GetSystemClockFreq(((SCG_Type *)(0x40064000u)),SCG_SYSTEM_CLOCK_SLOW);
            break;
        case CLKOUT_CLOCK:
            freq = CLOCK_SYS_GetSimClkOutFreq(((SIM_Type *)(0x40048000u)));
            break;


        case SIRC_CLOCK:
            freq = SCG_HAL_GetSircFreq(((SCG_Type *)(0x40064000u)));
            break;
        case FIRC_CLOCK:
            freq = SCG_HAL_GetFircFreq(((SCG_Type *)(0x40064000u)));
            break;
        case SOSC_CLOCK:
            freq = SCG_HAL_GetSysOscFreq(((SCG_Type *)(0x40064000u)));
            break;
        case SPLL_CLOCK:
            freq = SCG_HAL_GetSysPllFreq(((SCG_Type *)(0x40064000u)));
            break;
        case RTC_CLKIN_CLOCK:
            freq = SCG_HAL_GetRtcClkInFreq(((SCG_Type *)(0x40064000u)));
            break;
        case SCG_CLKOUT_CLOCK:
            freq = CLOCK_SYS_GetScgClkOutFreq(((SCG_Type *)(0x40064000u)));
            break;
        default:
                                          ...
                                          uint32_t *frequency)
{
    ...
    switch (clockName)
    {
        ...
        case SIM_FTM0_CLOCKSEL:
            freq = SIM_HAL_GetTClkFreq(((SIM_Type *)(0x40048000u)),(uint8_t)SIM_HAL_GetFtmExternalClkPinMode(((SIM_Type *)(0x40048000u)), 0U));
            break;
        case SIM_FTM1_CLOCKSEL:
            freq = SIM_HAL_GetTClkFreq(((SIM_Type *)(0x40048000u)),(uint8_t)SIM_HAL_GetFtmExternalClkPinMode(((SIM_Type *)(0x40048000u)), 1U));
            break;
        case SIM_FTM2_CLOCKSEL:
            freq = SIM_HAL_GetTClkFreq(((SIM_Type *)(0x40048000u)),(uint8_t)SIM_HAL_GetFtmExternalClkPinMode(((SIM_Type *)(0x40048000u)), 2U));
            break;
        case SIM_FTM3_CLOCKSEL:
            freq = SIM_HAL_GetTClkFreq(((SIM_Type *)(0x40048000u)),(uint8_t)SIM_HAL_GetFtmExternalClkPinMode(((SIM_Type *)(0x40048000u)), 3U));
            break;
        case SIM_CLKOUTSELL:
            freq = CLOCK_SYS_GetSimClkOutFreq(((SIM_Type *)(0x40048000u)));
            break;
        case SIM_RTCCLK_CLOCK:
            freq = CLOCK_SYS_GetSimRtcClkFreq(((SIM_Type *)(0x40048000u)));
            break;
        case SIM_LPO_CLOCK:
            if (PMC_HAL_GetLpoMode(((PMC_Type *)(0x4007D000u))))
            {
                freq = SIM_HAL_GetLpoFreq(((SIM_Type *)(0x40048000u)));
            }
            break;
        case SIM_LPO_1K_CLOCK:
            if (PMC_HAL_GetLpoMode(((PMC_Type *)(0x4007D000u))))
            {
                freq = SIM_HAL_GetLpo1KFreq(((SIM_Type *)(0x40048000u)));
            }
            break;
        case SIM_LPO_32K_CLOCK:
            if (PMC_HAL_GetLpoMode(((PMC_Type *)(0x4007D000u))))
            {
                freq = SIM_HAL_GetLpo32KFreq(((SIM_Type *)(0x40048000u)));
            }
            break;
        case SIM_LPO_128K_CLOCK:
            if (PMC_HAL_GetLpoMode(((PMC_Type *)(0x4007D000u))))
            {
                freq = SIM_HAL_GetLpo128KFreq(((SIM_Type *)(0x40048000u)));
            }
            break;
        case SIM_EIM_CLOCK:
...
{ _Bool clockMode;
    ...
    else
    {
        ...
        else if (clockName < PCC_END_OF_BUS_CLOCKS)
        {
            ...
            returnCode = (status_t)((SCG_HAL_GetSystemClockFreq(((SCG_Type *)(0x40064000u)), SCG_SYSTEM_CLOCK_BUS) == 0U) ? STATUS_MCU_GATED_OFF : STATUS_SUCCESS);
        }

        else if (clockName < PCC_END_OF_SYS_CLOCKS)
        {

            returnCode = (status_t)((SCG_HAL_GetSystemClockFreq(((SCG_Type *)(0x40064000u)), SCG_SYSTEM_CLOCK_CORE) == 0U) ? STATUS_MCU_GATED_OFF : STATUS_SUCCESS);
        }

        else if (clockName < PCC_END_OF_SLOW_CLOCKS)
        {

            returnCode = (status_t)((SCG_HAL_GetSystemClockFreq(((SCG_Type *)(0x40064000u)), SCG_SYSTEM_CLOCK_SLOW) == 0U) ? STATUS_MCU_GATED_OFF : STATUS_SUCCESS);
        }

        else if (clockName < PCC_END_OF_ASYNCH_DIV1_CLOCKS)
        {

            if (SCG_HAL_GetSystemClockFreq(((SCG_Type *)(0x40064000u)), SCG_SYSTEM_CLOCK_CORE) != 0U)
            {
        ...
        else
        {
            ...
            if (SCG_HAL_GetSystemClockFreq(((SCG_Type *)(0x40064000u)), SCG_SYSTEM_CLOCK_BUS) != 0U)
            {
...
# 549 "../SDK/platform/drivers/src/clock/S32K144/clock_S32K144.c"
status_t CLOCK_SYS_GetFreq(clock_names_t clockName,
                           uint32_t *frequency)
{
    status_t returnCode;
...
static status_t CLOCK_SYS_TransitionSystemClock(const scg_system_clock_config_t *to_clk)
{
    ...
    retValue = SCG_HAL_SetSystemClockConfig(((SCG_Type *)(0x40064000u)), run_mode, to_clk);
    ...
    if (sim_clkout_config.enable)
    {
        switch (sim_clkout_config.source)
        {
            ...
            case SIM_CLKOUT_SEL_SYSTEM_LPO_128K_CLK:
                frequency = SIM_HAL_GetLpo128KFreq(((SIM_Type *)(0x40048000u)));
                break;
...
static status_t CLOCK_SYS_ConfigureSIRC(const scg_sirc_config_t *sircConfig)
{
    ...
    if (sircCfg->initialize && (status == STATUS_SUCCESS))
    {
        ...
        status = SCG_HAL_InitSirc(((SCG_Type *)(0x40064000u)), sircCfg);
...
static status_t CLOCK_SYS_ConfigureFIRC(const scg_firc_config_t *fircConfig)
{
    ...
    if (fircCfg->initialize && (status == STATUS_SUCCESS))
    {
        ...
        status = SCG_HAL_InitFirc(((SCG_Type *)(0x40064000u)), fircCfg);
        if (status == STATUS_SUCCESS)
        {

            timeout = 10U;;
            while((SCG_HAL_GetFircFreq(((SCG_Type *)(0x40064000u))) == 0U) && (timeout > 0U))
            {
                timeout--;
            }
            if (timeout == 0U)
...
static status_t CLOCK_SYS_ConfigureSOSC(const scg_sosc_config_t *soscConfig)
{
    ...
    if (soscCfg->initialize && (status == STATUS_SUCCESS))
    {
        ...
        status = SCG_HAL_InitSysOsc(((SCG_Type *)(0x40064000u)), soscCfg);
        if (status == STATUS_SUCCESS)
        {
...
static status_t CLOCK_SYS_ConfigureSPLL(const scg_spll_config_t *spllConfig)
{
    ...
    if (spllCfg->initialize && (status == STATUS_SUCCESS))
    {
        ...
        status = SCG_HAL_InitSysPll(((SCG_Type *)(0x40064000u)), spllCfg);

        if (status == STATUS_SUCCESS)
        {

            timeout = 1000U;;
            while((SCG_HAL_GetSysPllFreq(((SCG_Type *)(0x40064000u))) == 0U) && (timeout > 0U))
            {
                timeout--;
            }
            if (timeout == 0U)
...
static status_t CLOCK_SYS_ConfigureTemporarySystemClock(void)
{
    ...
    if (current_config.src != SCG_SYSTEM_CLOCK_SRC_FIRC)
    {
        ...
        if (SCG_HAL_GetFircFreq(((SCG_Type *)(0x40064000u))) == 0UL)
        {
            status = CLOCK_SYS_ConfigureFIRC(((void *)0));
        }
...
static status_t CLOCK_SYS_ConfigureModulesFromScg(const scg_config_t *scgConfig)
{
    ...
    switch(CLOCK_SYS_GetCurrentRunMode(((SMC_Type *)(0x4007E000u))))
    {
