# 1 "../SDK/platform/drivers/src/edma/edma_driver.c"
...
# 1 "../SDK/platform/drivers/src/edma/edma_driver.c"
# 60 "../SDK/platform/drivers/src/edma/edma_driver.c"
...
# 48 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/edma_driver.h" 2
...
# 61 "../SDK/platform/drivers/src/edma/edma_driver.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/clock_manager.h" 1
# 62 "../SDK/platform/drivers/src/edma/edma_driver.c" 2
...
# 63 "../SDK/platform/drivers/src/edma/edma_driver.c" 2
...
# 91 "../SDK/platform/drivers/src/edma/edma_driver.c"
status_t EDMA_DRV_Init(edma_state_t *edmaState, const edma_user_config_t *userConfig,
                       edma_chn_state_t * const chnStateArray[],
                       const edma_channel_config_t * const chnConfigArray[],
                       uint8_t chnCount)
{
    ...
    ((void)0);
# 125 "../SDK/platform/drivers/src/edma/edma_driver.c"
    s_edma = edmaState;
...
# 199 "../SDK/platform/drivers/src/edma/edma_driver.c"
status_t EDMA_DRV_Deinit(void)
{
    uint32_t i;
    IRQn_Type irqNumber;
...
# 246 "../SDK/platform/drivers/src/edma/edma_driver.c"
status_t EDMA_DRV_ChannelInit(edma_chn_state_t *edmaChannelState, const edma_channel_config_t *edmaChannelConfig)
{
...
# 285 "../SDK/platform/drivers/src/edma/edma_driver.c"
status_t EDMA_DRV_InstallCallback(uint8_t channel, edma_callback_t callback, void *parameter)
{
                                        ...
                                        edma_chn_state_t *chn)
{
    ...
    uint8_t sourceDmamuxChannel = (uint8_t)(source);

    uint32_t dmamuxChannel = (requestedChannel);
    ...
    EDMA_HAL_SetErrorIntCmd(edmaRegBase, requestedChannel, 1);


    DMAMUX_HAL_SetChannelCmd(dmamuxRegBase, dmamuxChannel, 0);
    DMAMUX_HAL_SetChannelSource(dmamuxRegBase, dmamuxChannel, sourceDmamuxChannel);
    DMAMUX_HAL_SetChannelCmd(dmamuxRegBase, dmamuxChannel, 1);
...
# 359 "../SDK/platform/drivers/src/edma/edma_driver.c"
status_t EDMA_DRV_ReleaseChannel(uint8_t channel)
{
    ...
    EDMA_HAL_SetDmaRequestCmd(edmaRegBase, channel, 0);
...
# 487 "../SDK/platform/drivers/src/edma/edma_driver.c"
status_t EDMA_DRV_ConfigSingleBlockTransfer(uint8_t channel, edma_transfer_type_t type,
                                            uint32_t srcAddr, uint32_t destAddr,
                                            edma_transfer_size_t transferSize, uint32_t dataBufferSize)
{
    ...
    if (status == STATUS_SUCCESS)
    {
        ...
        EDMA_HAL_TCDSetIntCmd(edmaRegBase, channel, 1);
    }

    return status;
}
# 577 "../SDK/platform/drivers/src/edma/edma_driver.c"
status_t EDMA_DRV_ConfigLoopTransfer(uint8_t channel, const edma_transfer_config_t *transferConfig)
{
...
# 614 "../SDK/platform/drivers/src/edma/edma_driver.c"
status_t EDMA_DRV_ConfigScatterGatherTransfer(uint8_t channel, edma_software_tcd_t *stcd,
                                              edma_transfer_size_t transferSize, uint32_t bytesOnEachRequest,
                                              const edma_scatter_gather_list_t *srcList,
                                              const edma_scatter_gather_list_t *destList, uint8_t tcdCount)
...
# 765 "../SDK/platform/drivers/src/edma/edma_driver.c"
status_t EDMA_DRV_StartChannel(uint8_t channel)
{
    ...
    DMA_Type * edmaRegBase = g_edmaBase[0U];
    EDMA_HAL_SetDmaRequestCmd(edmaRegBase, channel, 1);

    return STATUS_SUCCESS;
}
# 790 "../SDK/platform/drivers/src/edma/edma_driver.c"
status_t EDMA_DRV_StopChannel(uint8_t channel)
{
...
# 815 "../SDK/platform/drivers/src/edma/edma_driver.c"
void EDMA_DRV_PushConfigToSTCD(const edma_transfer_config_t *config, edma_software_tcd_t *stcd)
{
...
# 853 "../SDK/platform/drivers/src/edma/edma_driver.c"
void EDMA_DRV_PushConfigToReg(uint8_t channel, const edma_transfer_config_t *tcd)
{
...
# 953 "../SDK/platform/drivers/src/edma/edma_driver.c"
edma_chn_status_t EDMA_DRV_GetChannelStatus(uint8_t channel)
{
