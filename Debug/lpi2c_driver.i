# 1 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
...
# 1 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
# 89 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
...
# 90 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c" 2
...
# 91 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c" 2

# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/clock_manager.h" 1
# 93 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c" 2
# 101 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
...
const clock_names_t g_lpi2cClock[(1u)] = {PCC_LPI2C0_CLOCK};
...
# 165 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
...
# 179 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
...
# 194 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
...
# 228 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
...
# 261 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
                                        ...
                                        _Bool receive)
{
    ...
    ((void)0);
    ((void)0);
# 286 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
    {
...
# 324 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
...
# 354 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
                                        ...
                                        _Bool resetFIFO)
{
    ...
    LPI2C_HAL_MasterSetInt(baseAddr, 0x1000UL |
                                     0x800UL |
                                     0x400UL |
                                     0x1UL |
                                     0x2UL,
    ...
    if (master->transferType == LPI2C_USING_DMA)
    {
        ...
        {
            (void)LPI2C_HAL_MasterSetRxDMA(baseAddr, 0);
        }
        else
        {
            (void)LPI2C_HAL_MasterSetTxDMA(baseAddr, 0);
        }
    }
...
# 413 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
                                    ...
                                    lpi2c_slave_state_t *slave)
{
    ...
    LPI2C_HAL_SlaveSetInt(baseAddr, 0x400UL |
                                    0x800UL |
                                    0x200UL |
                                    0x100UL |
                                    0x4UL |
    ...
    if (slave->transferType == LPI2C_USING_DMA)
    {
        ...
        {
            (void)LPI2C_HAL_SlaveSetRxDMA(baseAddr, 0);
        }
        else
        {
            (void)LPI2C_HAL_SlaveSetTxDMA(baseAddr, 0);
        }
    }


    LPI2C_HAL_SlaveSetEnable(baseAddr, 0);
...
# 460 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
static void LPI2C_DRV_MasterSetOperatingMode(uint32_t instance, lpi2c_mode_t operatingMode)
{
    ...
    ((void)0);
# 477 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
    {
...
# 492 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
static void LPI2C_DRV_SlaveSetOperatingMode(uint32_t instance, lpi2c_mode_t operatingMode)
{
    ...
    ((void)0);
# 514 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
    {
        ...
        LPI2C_HAL_SlaveSetACKStall(baseAddr, 0);
        LPI2C_HAL_SlaveSetTXDStall(baseAddr, 1);
        LPI2C_HAL_SlaveSetRXStall(baseAddr, 1);
        LPI2C_HAL_SlaveSetAddrStall(baseAddr, 1);
    }
# 532 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
    {

        LPI2C_HAL_SlaveSetHighSpeedModeDetect(baseAddr, 0);
    }

    slave->operatingMode = operatingMode;
}
# 547 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
static void LPI2C_DRV_ConfigureDmaTransfer(uint32_t instance, const lpi2c_dma_transfer_params_t *dmaTransParams)
{
    DMA_Type *baseDma = g_edmaBase[0U];
    DMAMUX_Type *baseDmaMux = g_dmamuxBase[0U];
...
# 575 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
static void LPI2C_DRV_MasterStartDmaTransfer(uint32_t instance)
{
    ...
    (void)EDMA_HAL_TCDSetDisableDmaRequestAfterTCDDoneCmd(g_edmaBase[0U], dmaTransParams.dmaChannel, 1);
    ...
    {
        (void)LPI2C_HAL_MasterSetTxDMA(baseAddr, 1);
    }
    else
    {
        LPI2C_DRV_MasterQueueCmd(baseAddr, master, LPI2C_MASTER_COMMAND_RECEIVE, (uint8_t)(master->rxSize - 1U));
        (void)LPI2C_HAL_MasterSetRxDMA(baseAddr, 1);
    }
}
# 646 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
static void LPI2C_DRV_SlaveStartDmaTransfer(uint32_t instance)
{
    ...
    EDMA_HAL_TCDSetSrcLastAdjust(g_edmaBase[0U],dmaTransParams.dmaChannel, -(int32_t)(slave->txSize));
    ...
    if (slave->txSize > (uint32_t)0U)
    {
        (void)LPI2C_HAL_SlaveSetTxDMA(baseAddr, 1);
    }
    else
    {
        (void)LPI2C_HAL_SlaveSetRxDMA(baseAddr, 1);
    }
}
# 698 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
static void LPI2C_DRV_MasterCompleteDMATransfer(void* parameter, edma_chn_status_t status)
{
    LPI2C_Type *baseAddr;
    lpi2c_master_state_t *master;
...
# 728 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
...
# 758 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
...
# 788 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
static void LPI2C_DRV_MasterHandleTransmitDataRequest(uint32_t instance, LPI2C_Type *baseAddr, lpi2c_master_state_t *master)
{
    ...
    else
    {
        ...
        LPI2C_HAL_MasterSetInt(baseAddr, 0x1UL, 0);
    }
}
# 837 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
...
# 885 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
static void LPI2C_DRV_SlaveHandleAddressValidEvent(uint32_t instance, const LPI2C_Type *baseAddr, lpi2c_slave_state_t *slave)
{
    ...
    if ((receivedAddr & 1U) != (uint16_t)0U)
    {
        ...
        if (slave->transferType == LPI2C_USING_INTERRUPTS) {
            ...
            LPI2C_HAL_SlaveSetInt(g_lpi2cBase[instance], 0x1UL, 1);
        }
...
# 937 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
...
# 980 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
...
# 1018 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
status_t LPI2C_DRV_MasterInit(uint32_t instance,
                                    const lpi2c_master_user_config_t * userConfigPtr,
                                    lpi2c_master_state_t * master)
{
    ...
    LPI2C_HAL_MasterSetEnable(baseAddr, 1);

    (void)retVal;

    return STATUS_SUCCESS;
}
# 1100 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
status_t LPI2C_DRV_MasterDeinit(uint32_t instance)
{
    LPI2C_Type *baseAddr;
    ...
    LPI2C_HAL_MasterSetEnable(baseAddr, 0);
...
# 1133 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
void LPI2C_DRV_MasterGetBaudRate(uint32_t instance, lpi2c_baud_rate_params_t *baudRate)
{
...
# 1173 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
    (void)retVal;
    (void)master;
}
# 1185 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
void LPI2C_DRV_MasterSetBaudRate(uint32_t instance,
                                const lpi2c_mode_t operatingMode,
                                const lpi2c_baud_rate_params_t baudRate)
{
...
# 1326 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
...
# 1343 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
void LPI2C_DRV_MasterSetSlaveAddr(uint32_t instance, const uint16_t address, const _Bool is10bitAddr)
{
    lpi2c_master_state_t * master;
...
# 1364 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
status_t LPI2C_DRV_MasterSendData(uint32_t instance,
                                            const uint8_t * txBuff,
                                            uint32_t txSize,
                                            _Bool sendStop)
...
# 1422 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
        {
            LPI2C_HAL_MasterSetInt(baseAddr, 0x1000UL |
                                             0x800UL |
                                             0x400UL |
...
status_t LPI2C_DRV_MasterSlaveAddrSendData(uint32_t instance,
                                           uint16_t slave_addr,
                                            const uint8_t * txBuff,
                                            uint32_t txSize,
                                            _Bool sendStop)
{
    ...
    master->i2cIdle = 0;
    master->status = STATUS_BUSY;
    master->slaveAddress = slave_addr;
    ...
    else
    {
        ...
        LPI2C_HAL_MasterSetTxFIFOWatermark(baseAddr, 0U);
# 1494 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
        {
            LPI2C_HAL_MasterSetInt(baseAddr, 0x1000UL |
                                             0x800UL |
                                             0x400UL |
...
# 1515 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
status_t LPI2C_DRV_MasterSendDataBlocking(uint32_t instance,
                                    const uint8_t * txBuff,
                                    uint32_t txSize,
                                    _Bool sendStop,
                                    ...
                                    uint32_t timeout)
{
    ...
    retVal = LPI2C_DRV_MasterSlaveAddrSendData(instance, slave_addr, txBuff, txSize, sendStop);
    if (retVal != STATUS_SUCCESS)
    {
        master->blocking = 0;
        return retVal;
...
# 1582 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
status_t LPI2C_DRV_MasterAbortTransferData(uint32_t instance)
{
    LPI2C_Type *baseAddr;
    lpi2c_master_state_t * master;
...
# 1617 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
status_t LPI2C_DRV_MasterReceiveData(uint32_t instance,
                                       uint8_t * rxBuff,
                                       uint32_t rxSize,
                                       _Bool sendStop)
{
    ...
    ((void)0);
# 1648 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
...
status_t LPI2C_DRV_MasterSlaveAddrReceiveData(uint32_t instance,
                                       uint16_t slave_addr,
                                       uint8_t * rxBuff,
                                       uint32_t rxSize,
                                       _Bool sendStop)
{
    ...
    ((void)0);
# 1734 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
    master->rxSize = rxSize;
    master->i2cIdle = 0;
    master->sendStop = sendStop;
    master->rxBuff = rxBuff;
...
# 1796 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
status_t LPI2C_DRV_MasterReceiveDataBlocking(uint32_t instance,
                                           uint8_t * rxBuff,
                                           uint32_t rxSize,
                                           _Bool sendStop,
                                           ...
                                           uint32_t timeout)
{
    ...
    retVal = LPI2C_DRV_MasterSlaveAddrReceiveData(instance, slave_addr, rxBuff, rxSize, sendStop);
    if (retVal != STATUS_SUCCESS)
    {
        master->blocking = 0;
        return retVal;
...
# 1867 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
...
# 1909 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
void LPI2C_DRV_MasterIRQHandler(uint32_t instance)
{
    LPI2C_Type *baseAddr;
    lpi2c_master_state_t * master;
...
# 2025 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
status_t LPI2C_DRV_SlaveInit(uint32_t instance,
                                   const lpi2c_slave_user_config_t * userConfigPtr,
                                   lpi2c_slave_state_t * slave)
{
    ...
    if (userConfigPtr->slaveListening)
    {
        ...
        if (slave->transferType == LPI2C_USING_INTERRUPTS)
        {
            ...
            LPI2C_HAL_SlaveSetInt(baseAddr, 0x400UL |
                                            ...
                                            0x2UL,
                                   1);
# 2125 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
        }


        LPI2C_HAL_SlaveSetEnable(baseAddr, 1);
    }
...
# 2144 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
status_t LPI2C_DRV_SlaveDeinit(uint32_t instance)
{
    LPI2C_Type *baseAddr;
...
# 2183 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
status_t LPI2C_DRV_SlaveSetTxBuffer(uint32_t instance,
                                                 const uint8_t * txBuff,
                                                 uint32_t txSize)
{
...
# 2210 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
status_t LPI2C_DRV_SlaveSetRxBuffer(uint32_t instance,
                                                 uint8_t * rxBuff,
                                                 uint32_t rxSize)
{
...
# 2237 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
status_t LPI2C_DRV_SlaveSendData(uint32_t instance,
                                   const uint8_t * txBuff,
                                   uint32_t txSize)
{
    ...
    else
    {
        ...
        LPI2C_HAL_SlaveSetInt(baseAddr, 0x400UL |
                                        ...
                                        0x4UL,
                              1);
# 2304 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
        LPI2C_HAL_SlaveSetEnable(baseAddr, 1);
...
# 2320 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
status_t LPI2C_DRV_SlaveSendDataBlocking(uint32_t instance,
                                           const uint8_t * txBuff,
                                           uint32_t txSize,
                                           uint32_t timeout)
...
# 2355 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
status_t LPI2C_DRV_SlaveReceiveData(uint32_t instance,
                                       uint8_t * rxBuff,
                                       uint32_t rxSize)
{
...
# 2425 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
status_t LPI2C_DRV_SlaveReceiveDataBlocking(uint32_t instance,
                                               uint8_t *rxBuff,
                                               uint32_t rxSize,
                                               uint32_t timeout)
...
# 2464 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
status_t LPI2C_DRV_SlaveGetTransferStatus(uint32_t instance,
                                               uint32_t *bytesRemaining)
{
...
# 2503 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
status_t LPI2C_DRV_SlaveAbortTransferData(uint32_t instance)
{
    lpi2c_slave_state_t * slave;
    LPI2C_Type *baseAddr;
...
# 2532 "../SDK/platform/drivers/src/lpi2c/lpi2c_driver.c"
void LPI2C_DRV_SlaveIRQHandler(uint32_t instance)
{
    LPI2C_Type *baseAddr;
    lpi2c_slave_state_t * slave;
    ...
    {
        if (LPI2C_HAL_SlaveGetInt(baseAddr, 0x1UL))
        {
    ...
    {
        if (LPI2C_HAL_SlaveGetInt(baseAddr, 0x2UL))
        {
    ...
    if ((stopDetect == 1) || (repeatStartDetect == 1))
    {
        ...
        LPI2C_HAL_SlaveSetInt(baseAddr, 0x1UL, 0);
