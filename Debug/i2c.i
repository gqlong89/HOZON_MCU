...
# 24 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/lpi2c_driver.h" 2
...
# 25 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/lpi2c_driver.h" 2
...
# 26 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/lpi2c_driver.h" 2
...
# 27 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/lpi2c_driver.h" 2
...
# 28 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/lpi2c_driver.h" 2
...
# 29 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/lpi2c_driver.h" 2
...
# 11 "../Sources/mid/i2c/i2c.c" 2
# 19 "../Sources/mid/i2c/i2c.c"
...
static void I2C_Fail_recover(void)
{
    ...
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF000u)), 2U, 0U);
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF000u)), 3U, 0U);
        I2C_Gpio_delay(2);
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF000u)), 2U, 1U);
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF000u)), 3U, 1U);
        I2C_Gpio_delay(2);
    }
                         ...
                         uint32_t txSize)
{
    ...
    txSize++;
    ret |= LPI2C_DRV_MasterSlaveAddrSendDataBlocking(instance, slave_addr, txbuff, txSize, 1,
            50);
                        ...
                        uint32_t rxSize)
{
    ...
    txbuff[0] = reg_addr;
    ret |= LPI2C_DRV_MasterSlaveAddrSendDataBlocking(instance, slave_addr, txbuff, 1, 0,
            50);
    ret |= LPI2C_DRV_MasterSlaveAddrReceiveDataBlocking(instance, slave_addr, rxBuff, rxSize, 1,
            50);
...
int driverI2CWrite(uint16_t slave_addr, unsigned int addr, unsigned char *buf,
                   unsigned int num)
{
    return I2C_WriteRegs((0U), slave_addr, addr, buf, num);
}

int driverI2CRead(uint16_t slave_addr, unsigned int addr, unsigned char *buf,
                  unsigned int num)
{
    return I2C_ReadRegs((0U), slave_addr, addr, buf, num);
}
...
void driverI2CInit(void)
{
    ...
    LPI2C_DRV_MasterInit((0U), &i2cMasterCfg, &i2cMasterState);
}

void driverI2CDeinit(void)
{
    LPI2C_DRV_MasterDeinit((0U));
}
...
int shell_i2c_read(unsigned int argc, unsigned char **argv)
{
    ...
    if (argc == 2 && argv[0][0] == '!')
    {
        do { if( !g_xModemCommEnable ) { printf( " %10s - i2cr <dev addr> <reg addr> <lenth>.\r\n", argv[1] ); if( shellRedirectBufSize > 1 ) { redirectLen = snprintf( (char *)shellRedirectBuf, shellRedirectBufSize , " %10s - i2cr <dev addr> <reg addr> <lenth>.\r\n", argv[1] ); if ( (redirectLen > 0) && ( redirectLen < shellRedirectBufSize ) ) { shellRedirectBufSize -= redirectLen; shellRedirectBuf += redirectLen; } else { shellRedirectBufSize = 0; } } } } while (0);
        return 0;
    }
    ...
    if (!ret)
    {
        do { if( !g_xModemCommEnable ) { printf( " [0x%x,0x%x,%u]data:", dev, reg, len ); if( shellRedirectBufSize > 1 ) { redirectLen = snprintf( (char *)shellRedirectBuf, shellRedirectBufSize , " [0x%x,0x%x,%u]data:", dev, reg, len ); if ( (redirectLen > 0) && ( redirectLen < shellRedirectBufSize ) ) { shellRedirectBufSize -= redirectLen; shellRedirectBuf += redirectLen; } else { shellRedirectBufSize = 0; } } } } while (0);

        for (i = 0; i < len; i++)
        {
            do { if( !g_xModemCommEnable ) { printf( " 0x%x", buf[i] ); if( shellRedirectBufSize > 1 ) { redirectLen = snprintf( (char *)shellRedirectBuf, shellRedirectBufSize , " 0x%x", buf[i] ); if ( (redirectLen > 0) && ( redirectLen < shellRedirectBufSize ) ) { shellRedirectBufSize -= redirectLen; shellRedirectBuf += redirectLen; } else { shellRedirectBufSize = 0; } } } } while (0);
        }
    ...
    {
        do { if( !g_xModemCommEnable ) { printf( " read error ret:%d\r\n", ret ); if( shellRedirectBufSize > 1 ) { redirectLen = snprintf( (char *)shellRedirectBuf, shellRedirectBufSize , " read error ret:%d\r\n", ret ); if ( (redirectLen > 0) && ( redirectLen < shellRedirectBufSize ) ) { shellRedirectBufSize -= redirectLen; shellRedirectBuf += redirectLen; } else { shellRedirectBufSize = 0; } } } } while (0);
    }
