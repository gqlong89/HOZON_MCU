# 1 "../SDK/platform/drivers/src/power/power_manager_common.c"
...
# 1 "../SDK/platform/drivers/src/power/power_manager_common.c"
# 51 "../SDK/platform/drivers/src/power/power_manager_common.c"
...
# 52 "../SDK/platform/drivers/src/power/power_manager_common.c" 2
...
# 53 "../SDK/platform/drivers/src/power/power_manager_common.c" 2
...
# 91 "../SDK/platform/drivers/src/power/power_manager_common.c"
status_t POWER_SYS_Init(power_manager_user_config_t *(* powerConfigsPtr)[],
                                                                                    uint8_t configsNumber,
                                                                                    power_manager_callback_user_config_t *(* callbacksPtr)[],
                                                                                    uint8_t callbacksNumber)
{
    ...
    {
        gPowerManagerState.staticCallbacks = ((void *)0);
...
# 131 "../SDK/platform/drivers/src/power/power_manager_common.c"
status_t POWER_SYS_Deinit(void)
{
    gPowerManagerState.configs = ((void *)0);
...
# 154 "../SDK/platform/drivers/src/power/power_manager_common.c"
status_t POWER_SYS_GetLastMode(uint8_t* powerModeIndexPtr)
{
    status_t returnCode;
...
# 184 "../SDK/platform/drivers/src/power/power_manager_common.c"
status_t POWER_SYS_GetLastModeConfig(power_manager_user_config_t** powerModePtr)
{
    status_t returnCode;
...
# 213 "../SDK/platform/drivers/src/power/power_manager_common.c"
uint8_t POWER_SYS_GetErrorCallbackIndex (void)
{
    return gPowerManagerState.errorCallbackIndex;
}
# 225 "../SDK/platform/drivers/src/power/power_manager_common.c"
power_manager_callback_user_config_t* POWER_SYS_GetErrorCallback(void) {
...
# 241 "../SDK/platform/drivers/src/power/power_manager_common.c"
static status_t POWER_SYS_CallbacksManagement(power_manager_notify_struct_t *notifyStruct, uint8_t *currentStaticCallback, power_manager_policy_t policy)
{
    uint8_t callbacksNumber;
...
# 342 "../SDK/platform/drivers/src/power/power_manager_common.c"
status_t POWER_SYS_SetMode(uint8_t powerModeIndex, power_manager_policy_t policy)
{
    power_manager_user_config_t * configPtr;
    status_t returnCode;
    status_t errorCode;
    _Bool successfulSwitch;
