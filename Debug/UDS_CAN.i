# 1 "../Sources/app/tp/uds/UDS_CAN.c"
...
# 6 "../Sources/app/tp/uds/UDS_CAN.c" 2
...
# 8 "../Sources/app/tp/uds/UDS_CAN.c" 2


extern uint8_t task_uds_id ;
# 19 "../Sources/app/tp/uds/UDS_CAN.c"
...
# 37 "../Sources/app/tp/uds/UDS_CAN.c"
uint32_t UDS_CANSend(uds_t *tUDS, uint32_t u32CANID, uint8_t u8Can_Dl, uint8_t *Ar_u8CANData)
{
    uint8_t Ret = 1;
    uint8_t i = 0;
...
# 78 "../Sources/app/tp/uds/UDS_CAN.c"
UDS_CANMsg_T *UDS_CANRead(uds_t *tUDS)
{
    ...
    if (tUDS->canReadBuf_ValidCnt > 0)
    {
        ...
        tUDS->canReadBuf_Tail = (tUDS->canReadBuf_Tail + 1) % 10;
        tUDS->canReadBuf_ValidCnt--;
        kernelSetTaskEvent(task_uds_id, (1<<17));
    }

    return (pt_UDSCANMsg);
}
# 100 "../Sources/app/tp/uds/UDS_CAN.c"
uint32_t UDS_CANAccept(uint32_t canport, CAN_MSG *tCANMsg)
{
    uint32_t i = 0;
    uds_t *tUDS = (void*) 0;
# 123 "../Sources/app/tp/uds/UDS_CAN.c"
    ...
    tUDS->canReadBuf_Header = (tUDS->canReadBuf_Header + 1) % 10;
    tUDS->canReadBuf_ValidCnt = (tUDS->canReadBuf_ValidCnt + 1) % 10;
    kernelSetTaskEvent(task_uds_id, (1<<17));
