...
# 10 "../Sources/mid/acc/icm_acc.c" 2
...
# 11 "../Sources/mid/acc/icm_acc.c" 2
# 1 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\math.h" 1 3
...
# 6 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\math.h" 2 3
# 1 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\machine\\ieeefp.h" 1 3
# 7 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\math.h" 2 3
...
# 108 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\math.h" 3
...
# 12 "../Sources/mid/acc/icm_acc.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/mid/acc/icm_acc.h" 1
...
_Bool is_icm_acc(void);
_Bool icm_acc_init(void);
void icm_standby(void);
void icm_sleep(void);
int icm_get_xyz(double *angle);
# 13 "../Sources/mid/acc/icm_acc.c" 2
...
# 14 "../Sources/mid/acc/icm_acc.c" 2
...
_Bool is_icm_acc(void)
{
    ...
    ret = icm_read((0x75), &temp_val, 1);

    if (!ret)
    {
        if (temp_val != (0x11))
        {
            do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "is not icm acc:(0x%x)", temp_val ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            ret = 1;
        }
    }
    else
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "icm read faild,ret:%d", ret ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    }
...
_Bool icm_acc_init(void)
{
    int ret;
    unsigned char temp_val = 0;
    ret = icm_write((0X6B), 0x00, 1);


    ret |= icm_write((0x1B), 0x00, 1);

    ret |= icm_write((0x1C), 0x10, 1);

    ret |= icm_write((0x19), 0x09, 1);
    ret |= icm_write((0X6C), 0x00, 1);
    ret |= icm_write((0X6B), 0x01, 1);

    icm_read((0x1B), &temp_val, 1);

    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "ICM_REG_GYRO_CONFIGret:%x", temp_val ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);


    if (cfg_get_anti_thief())
    {
        ret |= icm_write((0X38), 0xE0, 1);
        ret |= icm_write((0X20), 0x80, 1);
        ret |= icm_write((0X21), 0x80, 1);
        ret |= icm_write((0X22), 0x80, 1);
        ret |= icm_write((0X69), 0xC0, 1);
        ret |= icm_write((0X37), 0x81, 1);
    }
    else
    {
        ret |= icm_write((0X38), 0x00, 1);
    }

    if (ret)
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "icm write faild,ret:%d", ret ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 0;
    }
    else
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "icm acc init ok" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 1;
    }
}
...
int icm_get_interrupt_src(void)
{
    ...
    ret = icm_read((0X3A), &int_src, 1);

    if (ret)
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "reg read error:%d", ret ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return -1;
    }

    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_DEBUG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "int_src:0x%x", int_src ); printf("\r\n"); if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
...
static void icm_xyz_convent(signed short *accvel, double *angle)
{
    ...
    static unsigned char crash_state = 0;
    ...
    if (crash_state & 0x01)
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Crash!!! the acc is:(%d)", (int)crash_acc ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    }
    ...
    if (pcnt % 1000 == 0)
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_DEBUG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "acc_x,acc_y,acc_z,acc_w:%d,%d,%d,  %d", (int)acc_x, (int)acc_y, (int)acc_z, (int)acc_w ); printf("\r\n"); if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
                                      ;
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_DEBUG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "angle_x,angle_y,angle_z:%d,%d,%d", (int)angle_x, (int)angle_y, (int)angle_z ); printf("\r\n"); if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
                            ;

        if (crash_state & 0x02)
        {
            do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_DEBUG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Once Crash!!! the acc is:(%d)", (int)crash_acc ); printf("\r\n"); if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        }

        if (rollover_state & 0x01)
        {
            do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Roll over!!! the angle is:(%d)", (int)rollover_angle ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        }

        if (rollover_state & 0x02)
        {
            do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_DEBUG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Once Roll over,now get right !!! " ); printf("\r\n"); if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        }
    }
# 280 "../Sources/mid/acc/icm_acc.c"
}
...
void getaccVal( unsigned char *buf )
{
    ...
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_DEBUG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "acc_xyz=[%x,%x,%x] [%5d,%5d,%5d]\r\n", accVal[0], accVal[1], accVal[2], accVal[0], accVal[1], accVal[2] ); printf("\r\n"); if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
...
void getgyroVal( unsigned char *buf )
{
    ...
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_DEBUG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "gyro_xyz=[%x,%x,%x] [%5d,%5d,%5d]\r\n", gyroVal[0], gyroVal[1], gyroVal[2], gyroVal[0], gyroVal[1], gyroVal[2] ); printf("\r\n"); if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    return;
}
...
int icm_get_xyz(double *angle)
{
    ...
    if (!ret)
    {
        ...
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_DEBUG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "acc_xyz=[%5d,%5d,%5d]", accVal[0], accVal[1], accVal[2] ); printf("\r\n"); if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);

        tempVal = (((signed short)((XYZ[6] << 8) + XYZ[7])));
        temperature = tempVal * 10 / 3268 + 25;
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_DEBUG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "temperature=%5d,tempVal=%5d", temperature, tempVal ); printf("\r\n"); if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);

        gyroVal[0] = (((signed short)((XYZ[8] << 8) + XYZ[9])));
        gyroVal[1] = (((signed short)((XYZ[10] << 8) + XYZ[11])));
        gyroVal[2] = (((signed short)((XYZ[12] << 8) + XYZ[13])));
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_DEBUG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "gyro_xyz=[%5d,%5d,%5d]", gyroVal[0], gyroVal[1], gyroVal[2] ); printf("\r\n"); if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 0;
    }
    else
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Fatal error!,ret:%d", ret ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return -1;
    }
}
...
void icm_standby(void)
{
    ...
    int ret;
    unsigned char value;
    ret = icm_read((0X6B), &value, 1);

    if (!ret)
    {
        icm_write((0X6C), 0x3F, 1);
        icm_write((0X6B), 0x41, 1);
    }
    else
    {
        value |= 0x40;
        icm_write((0X6C), 0x07, 1);
        icm_write((0X6B), value, 1);
    }
}
...
void icm_sleep(void)
{
    ...
    icm_write((0X6C), 0x07, 1);
    icm_write((0X6B), 0x09, 1);
# 385 "../Sources/mid/acc/icm_acc.c"
}
