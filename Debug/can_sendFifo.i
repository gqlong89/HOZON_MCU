# 1 "../Sources/app/can_mgr/can_sendFifo.c"
...
# 6 "../Sources/app/can_mgr/can_sendFifo.c" 2
...
# 7 "../Sources/app/can_mgr/can_sendFifo.c" 2
...
# 8 "../Sources/app/can_mgr/can_sendFifo.c" 2
...
# 9 "../Sources/app/can_mgr/can_sendFifo.c" 2
...
# 10 "../Sources/app/can_mgr/can_sendFifo.c" 2
...
# 11 "../Sources/app/can_mgr/can_sendFifo.c" 2
...
# 12 "../Sources/app/can_mgr/can_sendFifo.c" 2
...
# 13 "../Sources/app/can_mgr/can_sendFifo.c" 2
...
# 14 "../Sources/app/can_mgr/can_sendFifo.c" 2
...
# 15 "../Sources/app/can_mgr/can_sendFifo.c" 2
...
# 16 "../Sources/app/can_mgr/can_sendFifo.c" 2
...
# 17 "../Sources/app/can_mgr/can_sendFifo.c" 2
...
# 19 "../Sources/app/can_mgr/can_sendFifo.c" 2
...
# 20 "../Sources/app/can_mgr/can_sendFifo.c" 2
...
# 21 "../Sources/app/can_mgr/can_sendFifo.c" 2
...
# 22 "../Sources/app/can_mgr/can_sendFifo.c" 2
...
# 23 "../Sources/app/can_mgr/can_sendFifo.c" 2
...
# 24 "../Sources/app/can_mgr/can_sendFifo.c" 2
...
void APP_ClearTxFifo(unsigned char canport)
{
    ...
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Clear CAN %d Tx FIFO OK!!!", canport ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
}
# 54 "../Sources/app/can_mgr/can_sendFifo.c"
unsigned char APP_CANSend(unsigned char canport, CAN_SEND_MSG *canMsg)
{
    if (canport >= 2)
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "CAN PORT %d is Wrong!!!", canport ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return (1);
    }

    if (check_busOffState(canport) == 1)
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "CAN %d BUS off,can not send message!!!", canport ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return (2);
    }


    if ((APP_CANSendFifo[canport].p_in + 1) % (10) == APP_CANSendFifo[canport].p_out)
    {
    ...
    APP_CANSendFifo[canport].p_in = (APP_CANSendFifo[canport].p_in + 1) % (10);

    return (0);
}
# 91 "../Sources/app/can_mgr/can_sendFifo.c"
unsigned char APP_CANSendFifoHandle(unsigned char canport)
{
    ...
    {
        ret = can_send(canport, 0xff, &APP_CANSendFifo[canport].buf[APP_CANSendFifo[canport].p_out]);
  ...
  if (ret != 0)
   ...
   return ret;
        ...
        {
            APP_CANSendFifo[canport].p_out = (APP_CANSendFifo[canport].p_out + 1) % (10);
        }
    }
