# 1 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
...
# 1 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
# 81 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
...
# 82 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c" 2
...
# 149 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
status_t LPUART_DRV_Init(uint32_t instance, lpuart_state_t * lpuartStatePtr,
                         const lpuart_user_config_t * lpuartUserConfig)
{
    ((void)0);
    ...
    LPUART_HAL_SetRxFIFOCmd(base, 1);
...
# 245 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
status_t LPUART_DRV_Deinit(uint32_t instance)
{
    ((void)0);
...
# 290 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
lpuart_rx_callback_t LPUART_DRV_InstallRxCallback(uint32_t instance,
                                                  lpuart_rx_callback_t function,
                                                  void * callbackParam)
{
...
# 313 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
lpuart_tx_callback_t LPUART_DRV_InstallTxCallback(uint32_t instance,
                                                  lpuart_tx_callback_t function,
                                                  void * callbackParam)
{
...
# 336 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
status_t LPUART_DRV_SendDataBlocking(uint32_t instance,
                                     const uint8_t * txBuff,
                                     uint32_t txSize,
                                     uint32_t timeout)
{
    ...
    if (lpuartState->transferType == LPUART_USING_INTERRUPTS ||
        lpuartState->transferType == LPUART_USING_TX_INTERRUPTS_RX_DMA )
    {
...
# 408 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
status_t LPUART_DRV_SendData(uint32_t instance,
                             const uint8_t * txBuff,
                             uint32_t txSize)
{
...
# 455 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
status_t LPUART_DRV_GetTransmitStatus(uint32_t instance, uint32_t * bytesRemaining)
{
    ((void)0);
    ((void)0);
...
# 501 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
status_t LPUART_DRV_AbortSendingData(uint32_t instance)
{
    ((void)0);
...
# 539 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
status_t LPUART_DRV_ReceiveDataBlocking(uint32_t instance,
                                        uint8_t * rxBuff,
                                        uint32_t rxSize,
                                        uint32_t timeout)
{
    ...
    if (lpuartState->transferType == LPUART_USING_INTERRUPTS ||
        lpuartState->transferType == LPUART_USING_TX_DMA_RX_INTERRUPTS )
    {
...
# 614 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
status_t LPUART_DRV_ReceiveData(uint32_t instance,
                                uint8_t * rxBuff,
                                uint32_t rxSize)
{
...
# 660 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
...
# 705 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
status_t LPUART_DRV_AbortReceivingData(uint32_t instance)
{
    ((void)0);
...
# 744 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
void LPUART_DRV_IRQHandler(uint32_t instance)
{
    ...
    if (LPUART_HAL_GetIntMode(base, LPUART_INT_RX_DATA_REG_FULL))
    {
        ...
        {
            lpuartState->receiveStatus = STATUS_UART_RX_AVAILABLE;
...
# 865 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
static status_t LPUART_DRV_StartSendDataUsingInt(uint32_t instance,
                                                 const uint8_t * txBuff,
                                                 uint32_t txSize)
{
...
# 907 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
static status_t LPUART_DRV_StartSendDataUsingDma(uint32_t instance,
                                                 const uint8_t * txBuff,
                                                 uint32_t txSize)
{
    ...
    EDMA_HAL_TCDSetDisableDmaRequestAfterTCDDoneCmd(edmaBase, lpuartState->txDMAChannel, 1);
...
# 960 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
static void LPUART_DRV_CompleteSendDataUsingInt(uint32_t instance)
{
    ((void)0);
...
# 991 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
static void LPUART_DRV_CompleteSendDataUsingDma(void * parameter, edma_chn_status_t status)
{
...
# 1035 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
static status_t LPUART_DRV_StartReceiveDataUsingInt(uint32_t instance,
                                                    uint8_t * rxBuff,
                                                    uint32_t rxSize)
{
...
# 1081 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
static status_t LPUART_DRV_StartReceiveDataUsingDma(uint32_t instance,
                                                    uint8_t * rxBuff,
                                                    uint32_t rxSize)
{
    ...
    EDMA_HAL_TCDSetDisableDmaRequestAfterTCDDoneCmd(edmaBase, lpuartState->rxDMAChannel, 1);
...
# 1139 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
static void LPUART_DRV_CompleteReceiveDataUsingInt(uint32_t instance)
{
    ((void)0);
...
# 1171 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
static void LPUART_DRV_CompleteReceiveDataUsingDma(void * parameter, edma_chn_status_t status)
{
    if (status != EDMA_CHN_NORMAL)
    {
...
# 1215 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
static void LPUART_DRV_PutData(uint32_t instance)
{
    const lpuart_state_t * lpuartState = (lpuart_state_t *)g_lpuartStatePtr[instance];
    LPUART_Type * base = g_lpuartBase[instance];
...
# 1257 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
static void LPUART_DRV_GetData(uint32_t instance)
{
    const lpuart_state_t * lpuartState = (lpuart_state_t *)g_lpuartStatePtr[instance];
...
# 1302 "../SDK/platform/drivers/src/lpuart/lpuart_driver.c"
_Bool LPUART_DRV_GetChar(uint32_t instance, uint8_t *ch )
{
    const lpuart_state_t *lpuartState = (lpuart_state_t *)g_lpuartStatePtr[instance];
    const LPUART_Type *base = g_lpuartBase[instance];

    uint32_t value = base->DATA;
    if (lpuartState->bitCountPerChar == LPUART_8_BITS_PER_CHAR &&
        (value & 0x2000u) == 0)
    {
        *ch = (uint8_t)value;
