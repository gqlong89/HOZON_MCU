# 1 "../Sources/app/battery/panasonic.c"
...
# 2 "../Sources/app/battery/panasonic.c" 2
...
# 3 "../Sources/app/battery/panasonic.c" 2
...
# 4 "../Sources/app/battery/panasonic.c" 2
...
# 5 "../Sources/app/battery/panasonic.c" 2
...
# 6 "../Sources/app/battery/panasonic.c" 2
...
# 7 "../Sources/app/battery/panasonic.c" 2
...
# 8 "../Sources/app/battery/panasonic.c" 2
...
# 10 "../Sources/app/battery/panasonic.c" 2
...
{
    if (BATTERY_HARD_2 == BATTERY_HARD_2)
    {
...
static void PanasonicBatteryTrickleCharge(void)
{
    if (BATTERY_HARD_2 == BATTERY_HARD_2)
    {
        pm_cpu_charge_trickle_ctrl(1);
...
static int PanasonicBatteryTempratue(void)
{
    ...
    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( ":temprature = %d", temprature ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    ...
    if (PanasonicBatteryTempratue())
        ...
        if (Ritestflag == 0)
        {
            if (flag == 0)
            {
                ...
                do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( ":time1 = %d", (uint32_t)driverGetUptime() ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            }
            else if (driverGetUptime() > (time + 500))
            {
                flag = 0;
                ...
                do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( ":time2 = %d", (uint32_t)driverGetUptime() ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);

                if (Ri <= 1.35)
                {
                    batteryhealthstatus = 0;
                    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "Ri <= 1.35" ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                }
                else
                {
...
void PanasonicBatteryChargeStrategy(void)
{
    ...
    if (((temprature < (-20)) || (temprature > 60)) && (temp_first_index == 0))
    {
    ...
    if ((temprature < (-20)) || (temprature > 70))
    {
        if (batterychargestatus.stopchargeflag == 0)
        {
            PanasonicBatteryStopCharge();
    ...
    else if ((result > 402) && (temprature >= (-20)) && (temprature <= 70))
    {
        if ((batterychargestatus.tricklechargeflag == 0) && (tricklechargetimeoutflag == 0))
        {
            ...
            tricklechargetime = driverGetUptime() + 1440000;
        }
    ...
    else if ((result > 390) && (temprature >= (-20)) && (temprature <= 70))
    {
        if ((batterychargestatus.standardchargeflag == 0) && (standardchargetimeoutflag == 0))
        {
            ...
            batterychargestatus.tricklechargeflag = 0;
            standardchargetime = driverGetUptime() + 2160000;
        }
    ...
    else if ((temprature >= (-20)) && (temprature <= 70))
    {
        if ((batterychargestatus.standardchargeflag == 0) && (standardchargetimeoutflag == 0))
        {
            ...
            batterychargestatus.standardchargeflag = 1;
            batterychargestatus.tricklechargeflag = 0;
            standardchargetime = driverGetUptime() + 4320000;
        }
        else if (driverGetUptime() > standardchargetime)
        {
            if (batterychargestatus.stopchargeflag == 0)
