# 1 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c"
...
# 1 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c"
# 87 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c"
...
# 88 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c" 2
...
# 38 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/lpspi_shared_function.h" 2
...
# 55 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/lpspi_hal.h" 2
...
# 58 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/lpspi_hal.h" 2
...
# 59 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/lpspi_hal.h" 2
...
# 39 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/lpspi_shared_function.h" 2
...
# 89 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/clock_manager.h" 1
# 90 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c" 2
...
# 91 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/lpspi_shared_function.h" 1
# 92 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/S32K144/include/S32K144_features.h" 1
# 93 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c" 2
...
# 107 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c"
...
# 140 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c"
status_t LPSPI_DRV_MasterInit(uint32_t instance, lpspi_state_t * lpspiState,
                                    const lpspi_master_config_t * spiConfig)
{
    ((void)0);
    ...
    (void)LPSPI_HAL_SetPinConfigMode(base, LPSPI_SDI_IN_SDO_OUT, LPSPI_DATA_OUT_RETAINED, 1);

    LPSPI_HAL_GetFifoSizes(base, &(lpspiState->fifoSize), ((void *)0));
...
# 191 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c"
status_t LPSPI_DRV_MasterDeinit(uint32_t instance)
{
    ((void)0);
...
# 237 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c"
status_t LPSPI_DRV_MasterSetDelay(uint32_t instance, uint32_t delayBetwenTransfers,
                uint32_t delaySCKtoPCS, uint32_t delayPCStoSCK)
{
    ((void)0);
...
# 311 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c"
status_t LPSPI_DRV_MasterConfigureBus(uint32_t instance,
                                            const lpspi_master_config_t * spiConfig,
                                            uint32_t * calculatedBaudRate)
{
...
# 420 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c"
status_t LPSPI_DRV_MasterTransferBlocking(uint32_t instance,
                                                const uint8_t * sendBuffer,
                                                uint8_t * receiveBuffer,
                                                uint16_t transferByteCount,
                                                uint32_t timeout)
{
    ...
    if (error != STATUS_SUCCESS)
    {
        ...
        LPSPI_HAL_SetIntMode(base, LPSPI_TX_DATA_FLAG, 0);
        LPSPI_HAL_SetIntMode(base, LPSPI_RX_DATA_FLAG, 0);

        LPSPI_DRV_DisableTEIEInterrupts(instance);
        LPSPI_HAL_SetIntMode(base, LPSPI_TRANSFER_COMPLETE, 0);
...
# 498 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c"
status_t LPSPI_DRV_MasterTransfer(uint32_t instance,
                                        const uint8_t * sendBuffer,
                                        uint8_t * receiveBuffer,
                                        uint16_t transferByteCount)
...
# 535 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c"
status_t LPSPI_DRV_MasterGetTransferStatus(uint32_t instance, uint32_t * bytesRemained)
{
    ((void)0);
...
# 563 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c"
status_t LPSPI_DRV_MasterAbortTransfer(uint32_t instance)
{
    ((void)0);
    LPSPI_Type *base = g_lpspiBase[instance];
    ...
    LPSPI_DRV_MasterCompleteTransfer(instance);
    LPSPI_HAL_SetFlushFifoCmd(base, 1, 1);

    LPSPI_HAL_SetFlushFifoCmd(base, 1, 1);
    return STATUS_SUCCESS;
}
# 584 "../SDK/platform/drivers/src/lpspi/lpspi_master_driver.c"
static status_t LPSPI_DRV_MasterStartTransfer(uint32_t instance,
                                                    const uint8_t * sendBuffer,
                                                    uint8_t * receiveBuffer,
                                                    uint16_t transferByteCount)
{
    ...
    LPSPI_HAL_SetIntMode(base,LPSPI_TRANSMIT_ERROR , 1);
    LPSPI_HAL_SetIntMode(base,LPSPI_RECEIVE_ERROR , 1);
    ...
    if (lpspiState->transferType == LPSPI_USING_INTERRUPTS)
    {
        ...
        else
        {
            ...
            LPSPI_HAL_SetIntMode(base, LPSPI_RX_DATA_FLAG, 1);
            lpspiState->rxCount = transferByteCount;
        }

        LPSPI_HAL_SetIntMode(base, LPSPI_TX_DATA_FLAG, 1);
    }
    else
    {
        ...
        EDMA_HAL_TCDSetDisableDmaRequestAfterTCDDoneCmd(baseDma, lpspiState->txDMAChannel, 1);
        ...
        if(receiveBuffer != ((void *)0))
        {
            ...
            EDMA_HAL_TCDSetDisableDmaRequestAfterTCDDoneCmd(baseDma, lpspiState->rxDMAChannel, 1);
        ...
        if (receiveBuffer!=((void *)0))
        {
            LPSPI_HAL_SetRxDmaCmd(base, 1);
        }
        LPSPI_HAL_SetTxDmaCmd(base, 1);
    }
    return STATUS_SUCCESS;
}
...
static void LPSPI_DRV_MasterCompleteTransfer(uint32_t instance)
{
    ...
    if(lpspiState->transferType == LPSPI_USING_DMA)
    {
        ...
        LPSPI_HAL_SetRxDmaCmd(base, 0);
        LPSPI_HAL_SetTxDmaCmd(base, 0);
    }
    else
    {
...
void LPSPI_DRV_MasterIRQHandler(uint32_t instance)
{
    ...
    if ((_Bool)LPSPI_HAL_GetStatusFlag(base, LPSPI_TRANSMIT_ERROR))
    {
    ...
    if (txCount == (uint16_t)0)
    {
        ...
        LPSPI_HAL_SetIntMode(base, LPSPI_TX_DATA_FLAG, 0);
        LPSPI_HAL_SetIntMode(base, LPSPI_TRANSFER_COMPLETE, 1);

        if (rxCount == (uint16_t)0)
        {
            if (LPSPI_HAL_GetStatusFlag(base, LPSPI_TRANSFER_COMPLETE) == 1)
            {
                LPSPI_DRV_MasterCompleteTransfer(instance);
            }
        }
