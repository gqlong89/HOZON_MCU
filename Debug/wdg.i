...
# 22 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/interrupt_manager.h" 2
...
# 5 "../Sources/mid/wdg/wdg.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/S32K144/include/S32K144.h" 1
# 168 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/S32K144/include/S32K144.h"
extern unsigned int irq_cnt[20];
# 6 "../Sources/mid/wdg/wdg.c" 2
...
# 47 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Generated_Code/watchdog1.h" 2
...
# 7 "../Sources/mid/wdg/wdg.c" 2



#define WDG_INSTANCE (0U)
#define WDG_TIME_OUT (5*500)
...
void driverWDGInit(void)
{
    ...
    wdog_config.timeoutValue = (5*500);
    WDOG_DRV_Init((0U), &wdog_config);
}
...
{
    uint32_t status = 0;
    status = ((RCM_Type *)(0x4007F000u))->SRS;
