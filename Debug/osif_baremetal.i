# 1 "../SDK/rtos/osif/osif_baremetal.c"
...
# 1 "../SDK/rtos/osif/osif_baremetal.c"
# 50 "../SDK/rtos/osif/osif_baremetal.c"
...
status_t CLOCK_SYS_GetFreq(clock_names_t clockName,
                           uint32_t *frequency);
# 51 "../SDK/rtos/osif/osif_baremetal.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/devassert.h" 1
# 52 "../SDK/rtos/osif/osif_baremetal.c" 2
...
# 53 "../SDK/rtos/osif/osif_baremetal.c" 2
...
# 54 "../SDK/rtos/osif/osif_baremetal.c" 2
...
# 55 "../SDK/rtos/osif/osif_baremetal.c" 2
...
# 56 "../SDK/rtos/osif/osif_baremetal.c" 2
...
# 168 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/S32K144/include/S32K144.h"
extern unsigned int irq_cnt[20];
# 60 "../SDK/rtos/osif/osif_baremetal.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/S32K144/include/S32K144_features.h" 1
# 61 "../SDK/rtos/osif/osif_baremetal.c" 2
# 77 "../SDK/rtos/osif/osif_baremetal.c"
#define MSEC_TO_TICK(msec) (msec/10)

volatile uint64_t s_osif_tick_cnt = 0u;
void SysTick_Handler(void);
# 89 "../SDK/rtos/osif/osif_baremetal.c"
_Bool osif_IsIsrContext(void)
{
    _Bool is_isr = 0;
    uint32_t ipsr_code = (uint32_t)( (((S32_SCB_Type *)(0xE000E000u))->ICSR & 0x1FFu) >> 0u );
    if (ipsr_code != 0u)
    {
        is_isr = 1;
    }
...
uint32_t tag_fifo[16];
uint32_t tag_in = 0, tag_out = 0;

void SysTick_Handler(void)
{
    ((S32_SysTick_Type *)(0xE000E010u))->CSR &= ~0x10000u;
    SysTick_put_tag(++s_osif_tick_cnt);
    kernelUpdateTaskUsage();

    kernelScanTimer(s_osif_tick_cnt);
}

static inline uint32_t osif_GetCurrentTickCount(void)
{
    return (uint32_t)s_osif_tick_cnt;
}
...
static inline void osif_UpdateSystickConfig( void )
{
    ...
    ((S32_SysTick_Type *)(0xE000E010u))->RVR = (((uint32_t)(((uint32_t)(core_freq / (100u)))<<0u))&0xFFFFFFu);
...
# 149 "../SDK/rtos/osif/osif_baremetal.c"
void OSIF_TimeDelay( const uint32_t delay )
{
    osif_UpdateSystickConfig();
...
# 174 "../SDK/rtos/osif/osif_baremetal.c"
uint32_t OSIF_GetMilliseconds( void )
{
# 184 "../SDK/rtos/osif/osif_baremetal.c"
    return ( osif_GetCurrentTickCount() * 10 + ( ((S32_SysTick_Type *)(0xE000E010u))->CVR * 10 ) / ((S32_SysTick_Type *)(0xE000E010u))->RVR );
}
# 194 "../SDK/rtos/osif/osif_baremetal.c"
...
# 209 "../SDK/rtos/osif/osif_baremetal.c"
status_t OSIF_MutexUnlock( const mutex_t * const pMutex )
{
    (void) pMutex;
...
# 223 "../SDK/rtos/osif/osif_baremetal.c"
status_t OSIF_MutexCreate( mutex_t * const pMutex )
{
    (void) pMutex;
...
# 237 "../SDK/rtos/osif/osif_baremetal.c"
status_t OSIF_MutexDestroy( const mutex_t * const pMutex )
{
    (void) pMutex;
...
# 251 "../SDK/rtos/osif/osif_baremetal.c"
...
# 301 "../SDK/rtos/osif/osif_baremetal.c"
status_t OSIF_SemaPost( semaphore_t * const pSem )
{
    ((void)0);
...
# 328 "../SDK/rtos/osif/osif_baremetal.c"
...
# 346 "../SDK/rtos/osif/osif_baremetal.c"
status_t OSIF_SemaDestroy( const semaphore_t * const pSem )
{
    ((void)0);
