# 1 "../SDK/platform/hal/src/rtc/rtc_hal.c"
...
# 1 "../SDK/platform/hal/src/rtc/rtc_hal.c"
# 33 "../SDK/platform/hal/src/rtc/rtc_hal.c"
...
# 22 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/rtc_hal.h" 2
...
# 23 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/rtc_hal.h" 2
...
# 24 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/rtc_hal.h" 2
...
# 34 "../SDK/platform/hal/src/rtc/rtc_hal.c" 2
# 47 "../SDK/platform/hal/src/rtc/rtc_hal.c"
status_t RTC_HAL_Init(RTC_Type * const base)
{
    ...
    else
    {
        ...
        if (RTC_HAL_GetTimeInvalidFlag(base) == 1)
        {
            statusCode = STATUS_ERROR;
        }
    }
...
# 95 "../SDK/platform/hal/src/rtc/rtc_hal.c"
status_t RTC_HAL_Enable(RTC_Type * const base)
{
    status_t statusCode = STATUS_SUCCESS;
    _Bool isCounterEnabled;
    ...
    else
    {
        ...
        RTC_HAL_SetTimeCounterEnable(base, 1);
    }

    return statusCode;
}
# 125 "../SDK/platform/hal/src/rtc/rtc_hal.c"
status_t RTC_HAL_Disable(RTC_Type * const base)
{
    if (RTC_HAL_GetTimeCounterEnable(base) == 1)
    {
        RTC_HAL_SetTimeCounterEnable(base, 0);
    }
...
# 151 "../SDK/platform/hal/src/rtc/rtc_hal.c"
status_t RTC_HAL_SetTimeSecondsRegister(RTC_Type * const base, uint32_t seconds)
{
    status_t statusCode = STATUS_SUCCESS;
...
# 179 "../SDK/platform/hal/src/rtc/rtc_hal.c"
status_t RTC_HAL_SetTimePrescalerRegister(RTC_Type * const base, uint16_t value)
{
    status_t statusCode = STATUS_SUCCESS;
    ...
    else
    {
        uint32_t tmp = base->TPR;
        tmp &= ~(0xFFFFu);
        tmp |= (((uint32_t)(((uint32_t)(value))<<0u))&0xFFFFu);
        base->TPR = tmp;
        statusCode = STATUS_SUCCESS;
    }
...
# 210 "../SDK/platform/hal/src/rtc/rtc_hal.c"
status_t RTC_HAL_ConfigureRegisterLock(RTC_Type * const base, rtc_lock_register_select_t registerToConfig)
{
    status_t statusCode = STATUS_SUCCESS;
    ...
    if (RTC_HAL_GetLockRegisterLock(base) == 1)
    {
        statusCode = STATUS_ERROR;
    }
    else
...
# 258 "../SDK/platform/hal/src/rtc/rtc_hal.c"
_Bool RTC_HAL_IsRegisterLocked(const RTC_Type * const base, rtc_lock_register_select_t reg)
{
    _Bool state = 0;
...
# 293 "../SDK/platform/hal/src/rtc/rtc_hal.c"
status_t RTC_HAL_ConfigureClockOut(RTC_Type * const base, rtc_clk_out_config_t config)
{
    status_t statusCode = STATUS_SUCCESS;
    ...
    if (RTC_HAL_GetControlRegisterLock(base) == 1)
    {
        statusCode = STATUS_ERROR;
    }
    else
