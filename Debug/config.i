...
# 2 "../Sources/mid/config/config.c" 2
...
# 3 "../Sources/mid/config/config.c" 2
...
# 4 "../Sources/mid/config/config.c" 2
...
# 5 "../Sources/mid/config/config.c" 2
...
# 6 "../Sources/mid/config/config.c" 2
...
unsigned int cfg_restore_pcode(unsigned char *pdata)
{
    ...
    if (flash_eeprom_checksum_read(((((0x14000000U)))), (unsigned char *) &str, size))
    {
        if (flash_eeprom_checksum_read(((((0x14000000U)))) + size, (unsigned char *) &str, size))
        {
            return 1;
        }
    }
...
unsigned int cfg_save_pcode(unsigned char *pdata)
{
    ...
    flash_eeprom_checksum_write(((((0x14000000U)))), (unsigned char *) &str, size);
    flash_eeprom_checksum_write(((((0x14000000U)))) + size, (unsigned char *) &str, size);
    return 0;
}
...
unsigned int cfg_restore_sn(unsigned int *sn)
{
    ...
    if (flash_eeprom_checksum_read((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2), (unsigned char *) &str, size))
    {
        if (flash_eeprom_checksum_read((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + size, (unsigned char *) &str, size))
        {
            return 1;
        }
    }
...
unsigned int cfg_save_sn(unsigned int sn)
{
    ...
    str.sn = sn;
    mcu_sn = sn;
    flash_eeprom_checksum_write((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2), (unsigned char *) &str, size);
    flash_eeprom_checksum_write((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + size, (unsigned char *) &str, size);
    return 0;
}
...
unsigned int cfg_restore_rbt(unsigned int *cnt)
{
    ...
    if (flash_eeprom_checksum_read(((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2), (unsigned char *) &str, size))
    {
        if (flash_eeprom_checksum_read(((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + size, (unsigned char *) &str, size))
        {
            return 1;
        }
    }
...
unsigned int cfg_save_rbt(unsigned int cnt)
{
    ...
    str.cnt = cnt;
    mcu_reboot = cnt;
    flash_eeprom_checksum_write(((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2), (unsigned char *) &str, size);
    flash_eeprom_checksum_write(((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + size, (unsigned char *) &str, size);
    return 0;
}
...
unsigned int cfg_restore_sysruntime(unsigned int *time)
{
    ...
    if (flash_eeprom_checksum_read((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2), (unsigned char *) &str, size))
    {
        if (flash_eeprom_checksum_read((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + size, (unsigned char *) &str, size))
        {
            return 1;
        }
    }
...
unsigned int cfg_save_sysruntime(unsigned int time)
{
    ...
    str.time = time;
    flash_eeprom_checksum_write((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2), (unsigned char *) &str, size);
    flash_eeprom_checksum_write((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + size, (unsigned char *) &str, size);
    return 0;
}
...
unsigned int cfg_restore_candftbaud(CanDftBaudStr *pdata)
{
    ...
    if (flash_eeprom_checksum_read(((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + sizeof(SYSRunTimeStr) * 2), (unsigned char *) pdata, size))
    {
        if (flash_eeprom_checksum_read(((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + sizeof(SYSRunTimeStr) * 2) + size, (unsigned char *) pdata, size))
        {
            return 1;
        }
    }
...
{
    unsigned int size = sizeof(CanDftBaudStr);
    flash_eeprom_checksum_write(((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + sizeof(SYSRunTimeStr) * 2), (unsigned char *) data, size);
    flash_eeprom_checksum_write(((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + sizeof(SYSRunTimeStr) * 2) + size, (unsigned char *) data, size);
    return 0;
}
...
unsigned int cfg_restore_mcu_conf(MCUConfStr *conf)
{
    ...
    if (flash_eeprom_checksum_read((((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + sizeof(SYSRunTimeStr) * 2) + sizeof(CanDftBaudStr) * 2), (unsigned char *) conf, size))
    {
        if (flash_eeprom_checksum_read((((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + sizeof(SYSRunTimeStr) * 2) + sizeof(CanDftBaudStr) * 2) + size, (unsigned char *) conf, size))
        {
            return 1;
        }
    }
...
unsigned int cfg_save_mcu_conf(MCUConfStr *conf)
{
    ...
    flash_eeprom_checksum_write((((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + sizeof(SYSRunTimeStr) * 2) + sizeof(CanDftBaudStr) * 2), (unsigned char *) conf, size);
    flash_eeprom_checksum_write((((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + sizeof(SYSRunTimeStr) * 2) + sizeof(CanDftBaudStr) * 2) + size, (unsigned char *) conf, size);
    return 0;
}
...
unsigned int cfg_restore_canmsgsend(CanMsgSendStr *msg)
{
    ...
    if (flash_eeprom_checksum_read(((((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + sizeof(SYSRunTimeStr) * 2) + sizeof(CanDftBaudStr) * 2) + sizeof(MCUConfStr) * 2), (unsigned char *) msg, size))
    {
        if (flash_eeprom_checksum_read(((((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + sizeof(SYSRunTimeStr) * 2) + sizeof(CanDftBaudStr) * 2) + sizeof(MCUConfStr) * 2) + size, (unsigned char *) msg, size))
        {
            return 1;
        }
    }
...
unsigned int cfg_save_canmsgsend(unsigned char *msg)
{
    ...
    flash_eeprom_checksum_write(((((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + sizeof(SYSRunTimeStr) * 2) + sizeof(CanDftBaudStr) * 2) + sizeof(MCUConfStr) * 2), (unsigned char *) msg, size);
    flash_eeprom_checksum_write(((((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + sizeof(SYSRunTimeStr) * 2) + sizeof(CanDftBaudStr) * 2) + sizeof(MCUConfStr) * 2) + size, (unsigned char *) msg, size);
    return 0;
}
...
void cfg_save_sysmode(unsigned char mode)
{
    ...
    if (mcu_conf.sys_mode != mode)
    {
        ...
        flash_eeprom_checksum_write((((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + sizeof(SYSRunTimeStr) * 2) + sizeof(CanDftBaudStr) * 2), (unsigned char *) &mcu_conf, size);
        flash_eeprom_checksum_write((((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + sizeof(SYSRunTimeStr) * 2) + sizeof(CanDftBaudStr) * 2) + size, (unsigned char *) &mcu_conf, size);
    }
}
...
void cfg_init(void)
{
    if (cfg_restore_mcu_conf(&mcu_conf))
    {
        ...
        mcu_conf.sleep_time = (7*24*60);
        mcu_conf.deep_sleep_time = (14*24*60);
        mcu_conf.acc_vecm_ths = (500*2048/1000);
...
unsigned int cfg_restore_standbyflag(unsigned char *flag)
{
    ...
    if (flash_eeprom_checksum_read(((((0x14000000U)) + 1024)), (unsigned char *) &str, size))
    {
        if (flash_eeprom_checksum_read(((((0x14000000U)) + 1024)) + size, (unsigned char *) &str, size))
        {
            return 1;
        }
    }
...
unsigned int cfg_save_standbyflag(unsigned char flag)
{
    ...
    if (flag_standby != flag)
    {
        str.standby = flag;
        flag_standby = flag;
        flash_eeprom_checksum_write(((((0x14000000U)) + 1024)), (unsigned char *) &str, size);
        flash_eeprom_checksum_write(((((0x14000000U)) + 1024)) + size, (unsigned char *) &str, size);
    }
...
unsigned int cfg_restore_batchktime(unsigned int *time)
{
    ...
    if (flash_eeprom_checksum_read((((((0x14000000U)) + 1024)) + sizeof(MCUFlag1Str) * 2), (unsigned char *) &str, size))
    {
        if (flash_eeprom_checksum_read((((((0x14000000U)) + 1024)) + sizeof(MCUFlag1Str) * 2) + size, (unsigned char *) &str, size))
        {
            return 1;
        }
    }
...
unsigned int cfg_save_batchktime(unsigned int time)
{
    ...
    unsigned int size = sizeof(MCUFlag2Str);
    str.time = time;
    flash_eeprom_checksum_write((((((0x14000000U)) + 1024)) + sizeof(MCUFlag1Str) * 2), (unsigned char *) &str, size);
    flash_eeprom_checksum_write((((((0x14000000U)) + 1024)) + sizeof(MCUFlag1Str) * 2) + size, (unsigned char *) &str, size);
    return 0;
}
...
unsigned int cfg_restore_wake_cnt(unsigned char *wake_cnt)
{
    ...
    if (flash_eeprom_checksum_read(((((((0x14000000U)) + 1024)) + sizeof(MCUFlag1Str) * 2) + sizeof(MCUFlag2Str) * 2), (unsigned char *) &str, size))
    {
        if (flash_eeprom_checksum_read(((((((0x14000000U)) + 1024)) + sizeof(MCUFlag1Str) * 2) + sizeof(MCUFlag2Str) * 2) + size, (unsigned char *) &str, size))
        {
            return 1;
        }
    }
...
unsigned int cfg_save_wake_cnt(unsigned char wake_cnt)
{
    ...
    if (flag_wake_cnt != wake_cnt)
    {
        ...
        flash_eeprom_checksum_write(((((((0x14000000U)) + 1024)) + sizeof(MCUFlag1Str) * 2) + sizeof(MCUFlag2Str) * 2), (unsigned char *) &str, size);
        flash_eeprom_checksum_write(((((((0x14000000U)) + 1024)) + sizeof(MCUFlag1Str) * 2) + sizeof(MCUFlag2Str) * 2) + size, (unsigned char *) &str, size);
    }
...
unsigned int cfg_restore_uds(unsigned char *pdata)
{
    ...
    if (flash_eeprom_checksum_read((((((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + sizeof(SYSRunTimeStr) * 2) + sizeof(CanDftBaudStr) * 2) + sizeof(MCUConfStr) * 2) + sizeof(CanMsgSendStr) * 2), (unsigned char *) &str, size))
    {
        if (flash_eeprom_checksum_read((((((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + sizeof(SYSRunTimeStr) * 2) + sizeof(CanDftBaudStr) * 2) + sizeof(MCUConfStr) * 2) + sizeof(CanMsgSendStr) * 2) + size, (unsigned char *) &str, size))
        {
            return 1;
        }
    }
...
unsigned int cfg_save_uds(unsigned char *pdata)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "save uds config" ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        flash_eeprom_checksum_write((((((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + sizeof(SYSRunTimeStr) * 2) + sizeof(CanDftBaudStr) * 2) + sizeof(MCUConfStr) * 2) + sizeof(CanMsgSendStr) * 2), (unsigned char *) &str, size);
        flash_eeprom_checksum_write((((((((((((0x14000000U)))) + sizeof(ProductCodeStr) * 2) + sizeof(SerialNumStr) * 2) + sizeof(RebootCntStr) * 2) + sizeof(SYSRunTimeStr) * 2) + sizeof(CanDftBaudStr) * 2) + sizeof(MCUConfStr) * 2) + sizeof(CanMsgSendStr) * 2) + size, (unsigned char *) &str, size);
    }
...
void cfg_dump(unsigned int addr, unsigned int len)
{
    dumphex((unsigned char *)addr, len, __func__, 590);
}
