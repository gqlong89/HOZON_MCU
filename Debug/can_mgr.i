# 1 "../Sources/app/can_mgr/can_mgr.c"
...
# 2 "../Sources/app/can_mgr/can_mgr.c" 2
...
# 3 "../Sources/app/can_mgr/can_mgr.c" 2
...
# 4 "../Sources/app/can_mgr/can_mgr.c" 2
...
# 5 "../Sources/app/can_mgr/can_mgr.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/tp/uds/UDS_Config.h" 1
...
void uds_data_indication(void *uds_para, uint32_t u32AI, uint16_t u32PDU_DLC, uint8_t *pu8_PDUData,
                         uint8_t eNResult);
# 5 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/tp/uds/UDS_Config.h" 2



#define UDSTP_VER_NO "UDSTP V2.0"
#define UDSRUNMODE (1)
# 18 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/tp/uds/UDS_Config.h"
...
#define UDS_CLIENT_MAX_BYTE (0x800)
...
typedef struct UDS_tag
{
    ...
    UDS_CANMsg_T canReadBuf[10];
} uds_t;
# 168 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/tp/uds/UDS_Config.h"
    ...
    extern unsigned char UDS_DATA_S[(0xFFF) + 7];
    extern unsigned char UDS_DATA_C[(0x800) + 7];
...
# 6 "../Sources/app/can_mgr/can_mgr.c" 2
...
# 7 "../Sources/app/can_mgr/can_mgr.c" 2
...
# 8 "../Sources/app/can_mgr/can_mgr.c" 2
...
# 9 "../Sources/app/can_mgr/can_mgr.c" 2
...
# 10 "../Sources/app/can_mgr/can_mgr.c" 2
...
# 11 "../Sources/app/can_mgr/can_mgr.c" 2
...
# 12 "../Sources/app/can_mgr/can_mgr.c" 2
...
# 14 "../Sources/app/can_mgr/can_mgr.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/shell/shell_list.h" 1
...
#define APP_SHELL_SHELL_LIST_H_ 

    void shell_list_init(void);
# 15 "../Sources/app/can_mgr/can_mgr.c" 2
...
# 16 "../Sources/app/can_mgr/can_mgr.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/can_mgr/can_voltage.h" 1


#define _CAN_VOLTAGE_H_ 

#define COMM_VOL_NORMAL (0)
#define COMM_VOL_LOW (1)
#define COMM_VOL_HIGH (2)

#define COMM_VOL_LOW_THRESHOLD (6.3)
#define COMM_VOL_HIGH_THRESHODL (18)
...
# 17 "../Sources/app/can_mgr/can_mgr.c" 2
...
# 18 "../Sources/app/can_mgr/can_mgr.c" 2
...
# 19 "../Sources/app/can_mgr/can_mgr.c" 2

# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/custom/custom.h" 1
...
# 6 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/custom/custom.h" 2
typedef enum CUSTOM_EVENT
{
    CUSTOM_CTRL_EVT = (1<<17),
} CUSTOM_EVENT;
...
#define APP_DIS (0x01<<0)
#define NM_DIS (0x01<<1)
...
# 21 "../Sources/app/can_mgr/can_mgr.c" 2
...
# 17 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/nm_autosar/nm_autosar.h"
typedef enum
{
...
# 22 "../Sources/app/can_mgr/can_mgr.c" 2



static CAN_PARAM_STR can_param[5];
static MES_PARAM_STR mes_param[5];
...
void can_deinit(uint8_t canport)
{
    ...
    else if (CAN_PORT3 > canport)
    {
        ...
        {
            do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "can deinit fail" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        }
    }
...
# 306 "../Sources/app/can_mgr/can_mgr.c"
uint8_t can_send(uint8_t canport, uint8_t can_mail, CAN_SEND_MSG *canMsg)
{
    uint8_t ret = 1;
  ...
  return (2);
    ...
    if (get_Current_COMM_VolState() != (0))
    {
  return (3);
    }
# 329 "../Sources/app/can_mgr/can_mgr.c"
 ...
 if((custom_can_ctrl_state & (0x01<<0))&&(canport == 1))
 {
  if(can_mail > TX_CAN_NORMAL_NM_AUTOSAR)
  {
   return(6);
 ...
 if((custom_can_ctrl_state & (0x01<<1))&&(canport == 1))
 {
  if(can_mail == TX_CAN_NORMAL_NM_AUTOSAR)
  {
   return(7);
    ...
    if (CAN_PORT2 < canport)
    {
# 382 "../Sources/app/can_mgr/can_mgr.c"
    }
    else
    {
        if (0xff == can_mail)
...
# 462 "../Sources/app/can_mgr/can_mgr.c"
uint8_t can_send_busoff(uint8_t canport, uint8_t can_mail, CAN_SEND_MSG *canMsg)
{
    uint8_t ret = 1;
    static unsigned char bak_mail = 0;
  ...
  return (3);
    ...
    if (CAN_PORT2 < canport)
    {
# 502 "../Sources/app/can_mgr/can_mgr.c"
    }
    else
    {
        if (0xff == can_mail)
...
int can_receive(uint32_t canport, CAN_MSG *tCANMsg)
{
    if (0 == UDS_CANAccept(canport, tCANMsg))
    {

        tCANMsg->port = canport + 1;

        if ((tCANMsg->MsgID < 0X400) || (tCANMsg->MsgID > 0x7ff))
        {
            if ((custom_can_ctrl_state & (0x01<<0))&&(canport == 1))
            {
                do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "app message NOT SEND TO mpu" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                return 0;
            }
        ...
        else if ((tCANMsg->MsgID >= 0X400) && (tCANMsg->MsgID <= 0x7ff))
        {
            if ((custom_can_ctrl_state & (0x01<<1))&&(canport == 1))
            {
                do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "NM message NOT SEND TO mpu" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                return 0;
            }
...
uint8_t can_sta_get(uint8_t port)
{
    ...
    if (driverGetUptime() < (400 + can_param[port].rectime))
    {
        return 1;
    }
    else
...
uint8_t can_state_busoff(uint8_t port)
{
    if ((1<<1) & can_param[port].workstate)
    {
        return MPU_SYN_DATA_STATUS_ERROR;
    }
    else
...
uint8_t can_state_buserr(uint8_t port)
{
    if ((1<<2) & can_param[port].workstate)
    {
        return MPU_SYN_DATA_STATUS_ERROR;
    }
    else
