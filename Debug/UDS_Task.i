# 1 "../Sources/app/tp/uds/UDS_Task.c"
...
void uds_data_indication(void *uds_para, uint32_t u32AI, uint16_t u32PDU_DLC, uint8_t *pu8_PDUData,
                         uint8_t eNResult);
# 6 "../Sources/app/tp/uds/UDS_Task.c" 2
...
# 7 "../Sources/app/tp/uds/UDS_Task.c" 2
...
# 9 "../Sources/app/tp/uds/UDS_Task.c" 2
...
# 10 "../Sources/app/tp/uds/UDS_Task.c" 2
...
# 11 "../Sources/app/tp/uds/UDS_Task.c" 2
...
#define UDS_N_CR (150)
#define UDS_N_BS (90)
# 33 "../Sources/app/tp/uds/UDS_Task.c"
...
static void UDS_Server_Init__(uds_t *tUDS)
{
    ...
    tUDS->u32Phy_CANID = (0x7A0);
    tUDS->u32Fun_CANID = (0x7DF);
    tUDS->u32Respond_CANID = (0x7B0);

    tUDS->canport = (1);

    tUDS->PDU_MF = UDS_DATA_S + 7;
...
static void UDS_Init__(void)
{
    ...
    kernelEnableTimer(PollingTimerNo, (10), (1<<19));
    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "UDS task is ready to work." ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
}
