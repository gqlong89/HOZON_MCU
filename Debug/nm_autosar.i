# 1 "../Sources/app/nm_autosar/nm_autosar.c"
...
# 1 "../Sources/app/nm_autosar/nm_autosar.c"
# 9 "../Sources/app/nm_autosar/nm_autosar.c"
...
# 10 "../Sources/app/nm_autosar/nm_autosar.c" 2
...
# 11 "../Sources/app/nm_autosar/nm_autosar.c" 2
...
# 12 "../Sources/app/nm_autosar/nm_autosar.c" 2
...
# 33 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/ftm_driver.h" 2
...
# 23 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/clock_manager.h" 2
...
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/interrupt_manager.h" 1
# 14 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/include/timer.h" 2
...
# 13 "../Sources/app/nm_autosar/nm_autosar.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/nm_autosar/nm_autosar.h" 1
...
# 10 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/nm_autosar/nm_autosar.h" 2
...
# 11 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/nm_autosar/nm_autosar.h" 2
...
typedef struct
{
    unsigned char nm_lastState;
    unsigned char nm_currentState;
    unsigned char WakeUp_reason;
...
#define T_NM_ImmediateCycleTime (20*1000)
#define T_NM_MessageCycle (500*1000)
...
#define SignalLine_OK (!0)
#define SignalLine_DIS (0)
...
#define Request_Repeat_YES (1<<0)
#define Request_Repeat_NONE (0)

#define accelerate_YES (1)
#define accelerate_NONE (0)

#define CAN_STATUS_NORMAL (0)
#define CAN_STATUS_LISTEN (1)
...
#define Active_WakeUp (1<<4)

#define UDS_TYPE1 (1<<0)
#define T_WAIT_DIAG_REQ (5000)
...
# 14 "../Sources/app/nm_autosar/nm_autosar.c" 2
...
# 15 "../Sources/app/nm_autosar/nm_autosar.c" 2
...
# 16 "../Sources/app/nm_autosar/nm_autosar.c" 2
...
# 17 "../Sources/app/nm_autosar/nm_autosar.c" 2
...
# 19 "../Sources/app/nm_autosar/nm_autosar.c" 2
...
# 20 "../Sources/app/nm_autosar/nm_autosar.c" 2
...
# 22 "../Sources/app/nm_autosar/nm_autosar.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/can_mgr/canbus_off.h" 1
# 9 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/can_mgr/canbus_off.h"
#define CANBUS_OFF_H_ 



#define L1TOL2 5
#define L1RECOVER 100
#define L2RECOVER 1000
...
# 23 "../Sources/app/nm_autosar/nm_autosar.c" 2

# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/can_mgr/can_broadCast.h" 1


#define CAN_BROADCAST_H_ 
# 13 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/can_mgr/can_broadCast.h"
...
#define MAX_BC_EVENT_NUMBER (5)
#define MAX_BC_CYCLE_NUMBER (5)
#define MAX_BC_CE_NUMBER (5)
#define MAX_BC_ACTIVE_NUMBER (1)



#define BC_TYPE_INVALID (0)
#define BC_TYPE_EVENT (1)
#define BC_TYPE_CYCLE (2)
#define BC_TYPE_CE (3)
#define BC_TYPE_ACTIVE (4)
...
extern unsigned char BC_Event_handle(unsigned int id ,
                                     unsigned char port,
                                     unsigned char len,
                                     unsigned char *pdata,
                                     unsigned char num_Event,
...
# 25 "../Sources/app/nm_autosar/nm_autosar.c" 2
...
# 26 "../Sources/app/nm_autosar/nm_autosar.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/S32K144/include/S32K144.h" 1
# 168 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/S32K144/include/S32K144.h"
extern unsigned int irq_cnt[20];
# 27 "../Sources/app/nm_autosar/nm_autosar.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/mid/can_flexcan/can_flexcan.h" 1
...
_Bool flexcan_get_tx_status(uint8_t instance, uint8_t mbIdx);
extern unsigned int flexcan_get_errstatus(uint8_t instance);
extern void flexcan_clear_errstatus(uint8_t instance);
extern void flexcan_set_errint(uint8_t instance, _Bool enable);
# 28 "../Sources/app/nm_autosar/nm_autosar.c" 2





extern LOCAL_WAKEUPCOND_ST NM_Local_WakeupCondition;
...
unsigned char nm_AutosarEN[2];
CAN_PORT_STATE nm_canState[2];


unsigned char receive_NM_PDU_Flag[2];
unsigned char receive_RMB_Flag[2];
unsigned char request_NM_Repeat_Message_Flag[2];


unsigned char T_REPEAT_MESSAG_ExpiredFlag[2];
unsigned char T_NM_TIMEROUT_ExpiredFlag[2];
unsigned char T_WAIT_BUS_SLEEP_ExpiredFlag[2];

unsigned char T_NM_PDU_ExpiredFlag[2];

unsigned char accelerate_PDU_Flag[2];
unsigned char accelerate_PDU_count[2];

unsigned char autosar_busSleep_Error[2];
unsigned char can_status[2];

CAN_SEND_MSG NM_PDU[2];

unsigned int ID_NM_PDU_MIN[2];
unsigned int ID_NM_PDU_MAX[2];



static int8_t timer_T_NM_TIMEROUT_CanPort0 = (-1);
static int8_t timer_T_REPEAT_MESSAGE_CanPort0 = (-1);
static int8_t timer_T_WAIT_BUS_SLEEP_CanPort0 = (-1);

static int8_t timer_T_NM_TIMEROUT_CanPort1 = (-1);
static int8_t timer_T_REPEAT_MESSAGE_CanPort1 = (-1);
static int8_t timer_T_WAIT_BUS_SLEEP_CanPort1 = (-1);


static int8_t timer_SEND_PDU_CanPort0 = (-1);
static int8_t timer_SEND_PDU_CanPort1 = (-1);


unsigned char receive_UDS_Message[2];
unsigned char during_UDS[2];
static int8_t timer_UDS_Type1[2] = {(-1), (-1)};
...
static void USD_Type1_PORT0_isr(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "timer_UDS_Type1[0]" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    during_UDS[0] = 0;
    ltimer_stop(timer_UDS_Type1[0]);
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "CanPort0 UDS Finished!!!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
}
...
static void USD_Type1_PORT1_isr(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "timer_UDS_Type1[1]" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    during_UDS[1] = 0;
    ltimer_stop(timer_UDS_Type1[1]);
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "CanPort1 UDS Finished!!!" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
}

void start_timer_T_NM_TIMEROUT(unsigned char canport, unsigned int timeout)
{
    if (canport == 0)
    {
...
void stop_timer_T_NM_TIMEROUT(unsigned char canport)
{
    if (canport == 0)
    {
...
void restart_timer_T_NM_TIMEROUT(unsigned char canport, unsigned int timeout)
{
    stop_timer_T_NM_TIMEROUT(canport);
    start_timer_T_NM_TIMEROUT(canport, timeout);
}

void start_timer_T_REPEAT_MESSAGE(unsigned char canport, unsigned int timeout)
{
    if (canport == 0)
    {
...
void stop_timer_T_REPEAT_MESSAGE(unsigned char canport)
{
    if (canport == 0)
    {
...
static void CanPort0_T_NM_TIMEROUT_isr(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "not timer_T_NM_TIMEROUT" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    T_NM_TIMEROUT_ExpiredFlag[0] = (1);
    kernelSetTaskEvent(canBasic_taskid, (1<<22));
...
static void CanPort0_T_REPEAT_MESSAGE_isr(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "not timer_T_REPEAT_MESSAGE" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    T_REPEAT_MESSAG_ExpiredFlag[0] = (1);
    kernelSetTaskEvent(canBasic_taskid, (1<<22));
}
...
static void CanPort0_T_WAIT_BUS_SLEEP_isr(int8_t handle)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "not" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }

    T_WAIT_BUS_SLEEP_ExpiredFlag[0] = (1);
 kernelSetTaskEvent(canBasic_taskid, (1<<22));
}
...
static void CanPort1_T_REPEAT_MESSAGE_isr(int8_t handle)
{
    ...
    T_REPEAT_MESSAG_ExpiredFlag[1] = (1);
 kernelSetTaskEvent(canBasic_taskid, (1<<22));
}
...
static void CanPort1_T_WAIT_BUS_SLEEP_isr(int8_t handle)
{
    ...
    T_WAIT_BUS_SLEEP_ExpiredFlag[1] = (1);
 kernelSetTaskEvent(canBasic_taskid, (1<<22));
}

void canPort_Listen(unsigned char canport)
{
 CAN_Type *base = g_flexcanBase[canport];
 FLEXCAN_HAL_SetOperationMode(base, FLEXCAN_LISTEN_ONLY_MODE);
 can_status[canport] = (1);
   flexcan_clear_errstatus(canport);
    flexcan_set_errint(canport, 1);
    autosar_busSleep_Error[canport] = 0;
}

void canPort_Normal(unsigned char canport)
{
 CAN_Type *base = g_flexcanBase[canport];
    FLEXCAN_HAL_SetOperationMode(base, FLEXCAN_NORMAL_MODE);
    can_status[canport] = (0);
}

void CanBus_ErrorCheck_AUTUSAR(unsigned char canport)
{
    autosar_busSleep_Error[canport] = 1;
    kernelSetTaskEvent(canBasic_taskid, (1<<22));
}
                          ...
                          unsigned int timeout)
{
    ...
    if (timeout == (20*1000))
    {
        accelerate_PDU_Flag[canport] = (1);
        accelerate_PDU_count[canport] = 0;
    }

    if (timeout == (500*1000))
    {
        accelerate_PDU_Flag[canport] = (0);
        accelerate_PDU_count[canport] = 0;
    }
}
...
static void CanPort0_SEND_PDU_isr(int8_t handle)
{
    ...
    T_NM_PDU_ExpiredFlag[0] = T_NM_PDU_ExpiredFlag[0] | (1<<0);

    Autosar_PDU_CAN0_SendHandle();
...
static void CanPort1_SEND_PDU_isr(int8_t handle)
{
    ...
    T_NM_PDU_ExpiredFlag[1] = T_NM_PDU_ExpiredFlag[1] | (1<<0);

 Autosar_PDU_CAN1_SendHandle();
...
void Autosar_PDU_CAN0_SendHandle(void)
{
    if (T_NM_PDU_ExpiredFlag[0] == 0)
    {
        return;
    }

    if (T_NM_PDU_ExpiredFlag[0] & (1<<0))
    {
        T_NM_PDU_ExpiredFlag[0] &= (~(1<<0));


        PDU_CAN_Send(CAN_PORT0);

  restart_timer_T_NM_TIMEROUT(CAN_PORT0, (2000));

        if (accelerate_PDU_Flag[0] == (1))
        {
            accelerate_PDU_count[0] = accelerate_PDU_count[0] + 1;

            if (accelerate_PDU_count[0] >= ((5) - 1))
            {
                accelerate_PDU_count[0] = 0;
                accelerate_PDU_Flag[0] = (0);

                restart_timer_SEND_PDU(CAN_PORT0, (500*1000));

                nm_canState[0].nm_lastState = nm_canState[0].nm_currentState;
                nm_canState[0].nm_currentState = NM_REPEATE_MSG_NORMAL_STATE;
                do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "STATE CHANGE!   CAN 0 Be in NORMAL REPEAT MESSAGE STATE" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            }
        }
        else
        {
    ...
    if (T_NM_PDU_ExpiredFlag[0] & (1<<1))
    {
        T_NM_PDU_ExpiredFlag[0] &= (~(1<<1));
    }
}

void Autosar_PDU_CAN1_SendHandle(void)
{
    if (T_NM_PDU_ExpiredFlag[1] == 0)
    {
        return;
    }

    if (T_NM_PDU_ExpiredFlag[1] & (1<<0))
    {
        T_NM_PDU_ExpiredFlag[1] &= (~(1<<0));


        PDU_CAN_Send(CAN_PORT1);
        restart_timer_T_NM_TIMEROUT(CAN_PORT1, (2000));

        if (accelerate_PDU_Flag[1] == (1))
        {
            accelerate_PDU_count[1] = accelerate_PDU_count[1] + 1;

            if (accelerate_PDU_count[1] >= ((5) - 1))
            {
                accelerate_PDU_count[1] = 0;
                accelerate_PDU_Flag[1] = (0);

                restart_timer_SEND_PDU(CAN_PORT1, (500*1000));

                nm_canState[1].nm_lastState = nm_canState[1].nm_currentState;
                nm_canState[1].nm_currentState = NM_REPEATE_MSG_NORMAL_STATE;
                do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "STATE CHANGE!   CAN 1 Be in NORMAL REPEAT MESSAGE STATE" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            }
        }
        else
        {
    ...
    if (T_NM_PDU_ExpiredFlag[1] & (1<<1))
    {
        T_NM_PDU_ExpiredFlag[1] &= (~(1<<1));
    }
}
...
void PDU_CAN_Send(unsigned char canport)
{
    if (canport > 1)
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "ERROR CanPort!!!" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }
    ...
    NM_PDU[canport].Data[1] = 0;

    NM_PDU[canport].Data[1] |= request_NM_Repeat_Message_Flag[canport];
 NM_PDU[canport].Data[1] |= nm_canState[canport].AWB;
    NM_PDU[canport].Data[2] = nm_canState[canport].WakeUp_reason;
# 535 "../Sources/app/nm_autosar/nm_autosar.c"
    NM_PDU[canport].Data[3] = nm_canState[canport].stateChange;
    NM_PDU[canport].Data[4] = nm_canState[canport].StayAwake_reason;

    can_send(canport, TX_CAN_NORMAL_NM_AUTOSAR, &NM_PDU[canport]);
    return ;
}

void NM_Autosar_PDU_Init(unsigned char canport)
{
    ...
    NM_PDU[canport].Data[0] = 0x01;


    NM_PDU[canport].Data[3] = 0;
...
unsigned char NM_PDU_ReceiveCheck(unsigned char canport, CAN_MSG *tCANMsg)
{
   ...
   restart_timer_T_NM_TIMEROUT(canport, (2000));

   receive_NM_PDU_Flag[canport] = (1);
            kernelSetTaskEvent(canBasic_taskid, (1<<22));


            if ((tCANMsg->Data[1] & 0x01) != 0)
            {
                receive_RMB_Flag[canport] = (1);
                kernelSetTaskEvent(canBasic_taskid, (1<<22));
...
void nm_AutosarInit(unsigned char canport)
{
 ...
 if(can_basic_cfg.nm_cfg[canport].nm_type == NM_TYPE_AUTOSAR)
 {
  nm_AutosarEN[canport] = 1;
    ...
    if (nm_AutosarEN[canport] == ENABLE)
    {
        ...
        nm_canState[canport].WakeUp_reason = (0x00);
        nm_canState[canport].StayAwake_reason = (0);
        nm_canState[canport].AWB = (0);
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "POWER ON!CAN %d Be in sleep Mode", canport ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    }
    else
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "CAN %d has no AutoSar Function!", canport ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    }

    NM_Autosar_PDU_Init(canport);
 ...
 can_status[canport] = (0);
    ...
    receive_NM_PDU_Flag[canport] = (0);

    receive_RMB_Flag[canport] = (0);

    request_NM_Repeat_Message_Flag[canport] = (0);

    receive_UDS_Message[canport] = 0;

    during_UDS[canport] = 0;

    T_NM_TIMEROUT_ExpiredFlag[canport] = (0);

    T_REPEAT_MESSAG_ExpiredFlag[canport] = (0);

    T_WAIT_BUS_SLEEP_ExpiredFlag[canport] = (0);
    ...
    {
        if ((-1) == timer_T_NM_TIMEROUT_CanPort0)
        {
            timer_T_NM_TIMEROUT_CanPort0 = ltimer_create(CanPort0_T_NM_TIMEROUT_isr);
        }

        if ((-1) == timer_T_REPEAT_MESSAGE_CanPort0)
        {
            timer_T_REPEAT_MESSAGE_CanPort0 = ltimer_create(CanPort0_T_REPEAT_MESSAGE_isr);
        }

        if ((-1) == timer_T_WAIT_BUS_SLEEP_CanPort0)
        {
            timer_T_WAIT_BUS_SLEEP_CanPort0 = ltimer_create(CanPort0_T_WAIT_BUS_SLEEP_isr);
        }

        if ((-1) == timer_SEND_PDU_CanPort0)
        {
            timer_SEND_PDU_CanPort0 = htimer_create(CanPort0_SEND_PDU_isr);
        }

        if ((-1) == timer_UDS_Type1[0])
        {
            timer_UDS_Type1[0] = ltimer_create(USD_Type1_PORT0_isr);
        }
    }

    if (nm_AutosarEN[1] == ENABLE)
    {
        if ((-1) == timer_T_NM_TIMEROUT_CanPort1)
        {
            timer_T_NM_TIMEROUT_CanPort1 = ltimer_create(CanPort1_T_NM_TIMEROUT_isr);

        }

        if ((-1) == timer_T_REPEAT_MESSAGE_CanPort1)
        {
            timer_T_REPEAT_MESSAGE_CanPort1 = ltimer_create(CanPort1_T_REPEAT_MESSAGE_isr);
        }

        if ((-1) == timer_T_WAIT_BUS_SLEEP_CanPort1)
        {
            timer_T_WAIT_BUS_SLEEP_CanPort1 = ltimer_create(CanPort1_T_WAIT_BUS_SLEEP_isr);
        }

        if ((-1) == timer_SEND_PDU_CanPort1)
        {
            timer_SEND_PDU_CanPort1 = htimer_create(CanPort1_SEND_PDU_isr);
        }

        if ((-1) == timer_UDS_Type1[1])
        {
            timer_UDS_Type1[1] = ltimer_create(USD_Type1_PORT1_isr);
        }
    }
}
...
void nm_AutosarMainFunction(void)
{
    ...
    for (i = 0; i < 2; i++)
    {
        ...
        {
            case NM_SLEEP_MODE_STATE:




                receive_UDS_Message[i] = (0);
                ...
                {
                    nm_canState[i].AWB = (1<<4);
     canPort_Normal(i);


                    if (nm_canState[i].WakeUp_reason == (0x00))
                    {
                        if (NM_Local_WakeupCondition.current_state & (1<<4))
                        {
                            nm_canState[i].WakeUp_reason = (0x04);
                            do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "WakeUp by ACC!!!" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                        }
                        else if (NM_Local_WakeupCondition.current_state & (1<<0))
                        {
                            nm_canState[i].WakeUp_reason = (0x01);
                            do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "WakeUp by KL15!!!" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                        }
                        else if ((NM_Local_WakeupCondition.current_state & (1<<1)) || (NM_Local_WakeupCondition.current_state & (1<<1)))
                        {
                            nm_canState[i].WakeUp_reason = (0x03);
                            do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "WakeUp by CHARGE!!!" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                        }
      else if(NM_Local_WakeupCondition.current_state & (1<<5))
      {
       nm_canState[i].WakeUp_reason = (0x05);
                            do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "WakeUp by telematics service!!!" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
      }
                        else
                        {
                        }
                    ...
                    {
                        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "State Error!IN Sleep Mode ,WakeUp reason should be null ", NM_Local_WakeupCondition.current_state ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
                                                                      ;
                    }

                    nm_canState[i].nm_lastState = nm_canState[i].nm_currentState;
                    nm_canState[i].nm_currentState = NM_REPEATE_MSG_IMMEDIATE_STATE;
                    nm_canState[i].stateChange = (1<<0);
                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "STATE CHANGE!   CAN %d Be in IMMEDIATE REPEAT MESSAGE STATE", i ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);


                    receive_NM_PDU_Flag[i] = (0);

                    restart_timer_T_NM_TIMEROUT(i, (2000));
                    restart_timer_T_REPEAT_MESSAGE(i, (1600));


                    PDU_CAN_Send(i);


                    start_timer_SEND_PDU(i, (20*1000));
     ...
     restart_timer_T_NM_TIMEROUT(i, (2000));
                ...
                if (receive_NM_PDU_Flag[i] == (1))
                {
                    ...
                    if (nm_canState[i].WakeUp_reason == (0x00))
                    {
                        nm_canState[i].WakeUp_reason = (0x02);
                        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "WakeUp by Receive PDU!!!" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                    }
                    else
                    {
                        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "State Error!IN Sleep Mode ,WakeUp reason should be null ", NM_Local_WakeupCondition.current_state ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
                    ...
                    nm_canState[i].stateChange = (1<<0);
                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "STATE CHANGE!CAN %d Be in NM_REPEATE_MSG_NORMAL_STATE", i ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);

                    start_timer_T_NM_TIMEROUT(i, (2000));
                    start_timer_T_REPEAT_MESSAGE(i, (1600));
                    ...
                    start_timer_SEND_PDU(i, (500*1000));
    ...
    if((nm_canState[i].nm_currentState == NM_SLEEP_MODE_STATE)&&(can_status[i] == (0)))
    {
     autosar_busSleep_Error[i] = 0;
     canPort_Listen(i);
     break;
            ...
            case NM_PREPARE_SLEEP_MODE_SATATE:
                ...
                receive_RMB_Flag[i] = (0);
                request_NM_Repeat_Message_Flag[i] = (0);
                receive_UDS_Message[i] = 0;
                ...
                if (NM_Local_WakeupCondition.current_state == (!0))
                {
                    ...
                    if (nm_canState[i].WakeUp_reason == (0x00))
                    {
                        ...
                        else if (NM_Local_WakeupCondition.current_state & (!0))
                        {
                            nm_canState[i].WakeUp_reason = (0x01);
                            do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "WakeUp by KL15!!!" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                        }
                    ...
                    {
                        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "State Error!IN Prepare Sleep Mode ,WakeUp reason should be null ", NM_Local_WakeupCondition.current_state ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
                                                                      ;
                    }

                    nm_canState[i].nm_lastState = nm_canState[i].nm_currentState;
                    nm_canState[i].nm_currentState = NM_REPEATE_MSG_IMMEDIATE_STATE;
                    nm_canState[i].stateChange = (1<<1);
                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "STATE CHANGE!   CAN %d Be in IMMEDIATE REPEAT MESSAGE STATE", i ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                ...
                if (receive_NM_PDU_Flag[i] == (1))
                {
                    ...
                    nm_canState[i].nm_currentState = NM_REPEATE_MSG_NORMAL_STATE;
                     nm_canState[i].stateChange = (1<<1);
                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "STATE CHANGE!CAN %d Be in NORMAL REPEAT MESSAGE STATE", i ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
     ...
     start_BC_timerByChl(i);
        break;
                ...
                if (T_WAIT_BUS_SLEEP_ExpiredFlag[i] == (1))
                {
                    T_WAIT_BUS_SLEEP_ExpiredFlag[i] = (0);

                    T_NM_TIMEROUT_ExpiredFlag[i] = (0);

                    T_REPEAT_MESSAG_ExpiredFlag[i] = (0);
                    ...
                    nm_canState[i].nm_lastState = nm_canState[i].nm_currentState;
                    nm_canState[i].nm_currentState = NM_SLEEP_MODE_STATE;
                    receive_RMB_Flag[i] = (0);
                    request_NM_Repeat_Message_Flag[i] = (0);
     canPort_Listen(i);

                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "STATE CHANGE!CAN %d Be in SLEEP MODE STATE", i ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                }
            ...
            case NM_REPEATE_MSG_NORMAL_STATE:
                ...
                if ((receive_UDS_Message[i] & (1<<0)) != 0)
                {
                    restart_timer_UDS_Type1(i, (5000));
                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "CAN %d Start UDS timer", i ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                    receive_UDS_Message[i] &= (~(1<<0));
                    during_UDS[i] = 1;

                }

                if (T_REPEAT_MESSAG_ExpiredFlag[i] == (1))
                {
                    T_REPEAT_MESSAG_ExpiredFlag[i] = (0);
                    stop_timer_T_REPEAT_MESSAGE(i);
       ...
       nm_canState[i].stateChange = (1<<2);
                        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "STATE CHANGE!CAN %d Be in NORMAL OPERATION STATE", i ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                    ...
                    if (NM_Local_WakeupCondition.current_state == (0))
                    {
                        ...
                        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "STATE CHANGE!CAN %d Be in READY SLEEP STATE STATE", i ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                        stop_timer_SEND_PDU(i);
                        break;
                    }
                    else {}
                ...
                if (T_NM_TIMEROUT_ExpiredFlag[i] == (1))
                {
                    T_NM_TIMEROUT_ExpiredFlag[i] = (0);
                    restart_timer_T_NM_TIMEROUT(i, (2000));
                    break;
            ...
            case NM_NORMAL_STATE:
                ...
                if (request_NM_Repeat_Message_Flag[i] == (1<<0))
                {
                    request_NM_Repeat_Message_Flag[i] = (0);
                    ...
                    PDU_CAN_Send(i);
                    restart_timer_T_NM_TIMEROUT(i, (2000));
                    restart_timer_SEND_PDU(i, (20*1000));
                    break;
                }

                if (receive_RMB_Flag[i] == (1))
                {
                    receive_RMB_Flag[i] = (0);
                    nm_canState[i].nm_lastState = nm_canState[i].nm_currentState;
                    nm_canState[i].nm_currentState = NM_REPEATE_MSG_NORMAL_STATE;
                    ...
                    restart_timer_SEND_PDU(i, (500*1000));
                    break;
                }
                ...
                if (NM_Local_WakeupCondition.current_state == (0))
                {
                    nm_canState[i].nm_lastState = nm_canState[i].nm_currentState;
                    nm_canState[i].nm_currentState = NM_READY_SLEEP_STATE;
                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "STATE CHANGE!   CAN %d Be in READY SLEEP STATE", i ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                    stop_timer_SEND_PDU(i);
                    break;
                }
    ...
    receive_NM_PDU_Flag[i] = 0;
     ...
     PDU_CAN_Send(i);
                    nm_canState[i].nm_currentState = NM_NORMAL_STATE;
     nm_canState[i].stateChange = (1<<3);
                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "STATE CHANGE!   CAN %d Be in NORMAL OPERATION STATE", i ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                    start_timer_SEND_PDU(i, (500*1000));
                }


                if ((T_NM_TIMEROUT_ExpiredFlag[i] == (1)) && (during_UDS[i] == 0))
                {
                    T_NM_TIMEROUT_ExpiredFlag[i] = (0);
                    nm_canState[i].nm_lastState = nm_canState[i].nm_currentState;
                    ...
                    nm_canState[i].AWB = (0);
                    nm_canState[i].WakeUp_reason = (0x00);

                    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "STATE CHANGE!   CAN %d Be in PREPARE SLEEP  MODE STATE", i ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                    stop_timer_T_NM_TIMEROUT(i);
                    restart_timer_T_WAIT_BUS_SLEEP(i, (2000));
                    stop_timer_SEND_PDU(i);
