# 1 "../SDK/platform/drivers/src/flash/flash_driver.c"
...
# 1 "../SDK/platform/drivers/src/flash/flash_driver.c"
# 71 "../SDK/platform/drivers/src/flash/flash_driver.c"
...
# 72 "../SDK/platform/drivers/src/flash/flash_driver.c" 2


static status_t FLASH_DRV_CommandSequence(const flash_ssd_config_t * pSSDConfig)
__attribute__((section (".code_ram")));
# 86 "../SDK/platform/drivers/src/flash/flash_driver.c"
static void FLASH_DRV_GetDEPartitionCode(flash_ssd_config_t * const pSSDConfig,
                                         uint8_t DEPartitionCode)
{

    if (0x00U == DEPartitionCode) {pSSDConfig->DFlashSize = (uint32_t)(0x00010000u);}
    else if (0x01U == DEPartitionCode) {pSSDConfig->DFlashSize = (uint32_t)(0xFFFFFFFFu);}
    else if (0x02U == DEPartitionCode) {pSSDConfig->DFlashSize = (uint32_t)(0xFFFFFFFFu);}
    else if (0x03U == DEPartitionCode) {pSSDConfig->DFlashSize = (uint32_t)(0x00008000u);}
    else if (0x04U == DEPartitionCode) {pSSDConfig->DFlashSize = (uint32_t)(0x00000000u);}
    else if (0x05U == DEPartitionCode) {pSSDConfig->DFlashSize = (uint32_t)(0xFFFFFFFFu);}
    else if (0x06U == DEPartitionCode) {pSSDConfig->DFlashSize = (uint32_t)(0xFFFFFFFFu);}
    else if (0x07U == DEPartitionCode) {pSSDConfig->DFlashSize = (uint32_t)(0xFFFFFFFFu);}
    else if (0x08U == DEPartitionCode) {pSSDConfig->DFlashSize = (uint32_t)(0x00000000u);}
    else if (0x09U == DEPartitionCode) {pSSDConfig->DFlashSize = (uint32_t)(0xFFFFFFFFu);}
    else if (0x0AU == DEPartitionCode) {pSSDConfig->DFlashSize = (uint32_t)(0x00004000u);}
    else if (0x0BU == DEPartitionCode) {pSSDConfig->DFlashSize = (uint32_t)(0x00008000u);}
    else if (0x0CU == DEPartitionCode) {pSSDConfig->DFlashSize = (uint32_t)(0x00010000u);}
    else if (0x0DU == DEPartitionCode) {pSSDConfig->DFlashSize = (uint32_t)(0xFFFFFFFFu);}
    else if (0x0EU == DEPartitionCode) {pSSDConfig->DFlashSize = (uint32_t)(0xFFFFFFFFu);}
    else if (0x0FU == DEPartitionCode) {pSSDConfig->DFlashSize = (uint32_t)(0x00010000u);}
    else { }
}
# 148 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_Init(const flash_user_config_t * const pUserConf,
                        flash_ssd_config_t * const pSSDConfig)
{
    ((void)0);
    ...
    if (pSSDConfig->DFlashSize < (65536u))
    {
...
# 194 "../SDK/platform/drivers/src/flash/flash_driver.c"
...
# 238 "../SDK/platform/drivers/src/flash/flash_driver.c"
void FLASH_DRV_GetPFlashProtection(uint32_t * protectStatus)
{
    ((void)0);
...
# 261 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_SetPFlashProtection(uint32_t protectStatus)
{
    status_t ret = STATUS_SUCCESS;
    uint8_t reg0, reg1, reg2, reg3;
    _Bool flag0, flag1, flag2, flag3;
...
# 302 "../SDK/platform/drivers/src/flash/flash_driver.c"
void FLASH_DRV_GetSecurityState(uint8_t * securityState)
{
    ((void)0);
...
# 344 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_SecurityBypass(const flash_ssd_config_t * pSSDConfig,
                                  const uint8_t * keyBuffer)
{
    ((void)0);
...
# 377 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_EraseAllBlock(const flash_ssd_config_t * pSSDConfig)
{
    ((void)0);
    status_t ret;
...
# 403 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_VerifyAllBlock(const flash_ssd_config_t * pSSDConfig,
                                  uint8_t marginLevel)
{
    ((void)0);
...
# 431 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_EraseSector(const flash_ssd_config_t * pSSDConfig,
                               uint32_t dest,
                               uint32_t size)
{
...
# 502 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_VerifySection(const flash_ssd_config_t * pSSDConfig,
                                 uint32_t dest,
                                 uint16_t number,
                                 uint8_t marginLevel)
...
# 562 "../SDK/platform/drivers/src/flash/flash_driver.c"
void FLASH_DRV_EraseSuspend(void)
{
...
# 584 "../SDK/platform/drivers/src/flash/flash_driver.c"
void FLASH_DRV_EraseResume(void)
{
    uint16_t i = 0U;
...
# 609 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_ReadOnce(const flash_ssd_config_t * pSSDConfig,
                            uint8_t recordIndex,
                            uint8_t * pDataArray)
{
...
# 652 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_ProgramOnce(const flash_ssd_config_t * pSSDConfig,
                               uint8_t recordIndex,
                               const uint8_t * pDataArray)
{
...
# 759 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_Program(const flash_ssd_config_t * pSSDConfig,
                           uint32_t dest,
                           uint32_t size,
                           const uint8_t * pData)
...
# 842 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_ProgramCheck(const flash_ssd_config_t * pSSDConfig,
                                uint32_t dest,
                                uint32_t size,
                                const uint8_t * pExpectedData,
...
# 950 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_CheckSum(const flash_ssd_config_t * pSSDConfig,
                            uint32_t dest,
                            uint32_t size,
                            uint32_t * pSum)
...
# 1024 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_ProgramSection(const flash_ssd_config_t * pSSDConfig,
                                  uint32_t dest,
                                  uint16_t number)
{
...
# 1093 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_EraseBlock(const flash_ssd_config_t * pSSDConfig,
                              uint32_t dest)
{
    ((void)0);
...
# 1150 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_VerifyBlock(const flash_ssd_config_t * pSSDConfig,
                               uint32_t dest,
                               uint8_t marginLevel)
{
...
# 1210 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_GetEERAMProtection(uint8_t * protectStatus)
{
    ((void)0);
    status_t ret = STATUS_SUCCESS;
...
# 1238 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_SetEERAMProtection(uint8_t protectStatus)
{
    status_t ret = STATUS_SUCCESS;
...
# 1278 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_SetFlexRamFunction(const flash_ssd_config_t * pSSDConfig,
                                      flash_flexRam_function_control_code_t flexRamFuncCode,
                                      uint16_t byteOfQuickWrite,
                                      flash_eeprom_status_t * const pEEPROMStatus)
...
# 1389 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_EEEWrite(const flash_ssd_config_t * pSSDConfig,
                            uint32_t dest,
                            uint32_t size,
                            const uint8_t * pData)
...
# 1451 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_DEFlashPartition(const flash_ssd_config_t * pSSDConfig,
                                    uint8_t uEEEDataSizeCode,
                                    uint8_t uDEPartitionCode,
                                    uint8_t uCSEcKeySize,
...
# 1486 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_GetDFlashProtection(const flash_ssd_config_t * pSSDConfig,
                                       uint8_t * protectStatus)
{
    ((void)0);
...
# 1516 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_SetDFlashProtection(const flash_ssd_config_t * pSSDConfig,
                                       uint8_t protectStatus)
{
    ((void)0);
...
# 1742 "../SDK/platform/drivers/src/flash/flash_driver.c"
status_t FLASH_DRV_EraseAllBlockUnsecure(const flash_ssd_config_t * pSSDConfig)
{
    ((void)0);
    status_t ret;
