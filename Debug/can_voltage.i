# 1 "../Sources/app/can_mgr/can_voltage.c"
...
# 3 "../Sources/app/can_mgr/can_voltage.c" 2
...
# 4 "../Sources/app/can_mgr/can_voltage.c" 2
...
# 5 "../Sources/app/can_mgr/can_voltage.c" 2
...
# 6 "../Sources/app/can_mgr/can_voltage.c" 2
...
# 7 "../Sources/app/can_mgr/can_voltage.c" 2
...
# 8 "../Sources/app/can_mgr/can_voltage.c" 2
...
# 9 "../Sources/app/can_mgr/can_voltage.c" 2
...
# 10 "../Sources/app/can_mgr/can_voltage.c" 2
...
# 11 "../Sources/app/can_mgr/can_voltage.c" 2
...
# 12 "../Sources/app/can_mgr/can_voltage.c" 2
...
# 13 "../Sources/app/can_mgr/can_voltage.c" 2
...
# 15 "../Sources/app/can_mgr/can_voltage.c" 2
...
# 16 "../Sources/app/can_mgr/can_voltage.c" 2
...
# 18 "../Sources/app/can_mgr/can_voltage.c" 2
...
# 19 "../Sources/app/can_mgr/can_voltage.c" 2
...
# 20 "../Sources/app/can_mgr/can_voltage.c" 2
...
# 22 "../Sources/app/can_mgr/can_voltage.c" 2

extern CAN_BASIC_CFG_ST can_basic_cfg;
extern unsigned char accelerate_PDU_Flag[2];

static COMM_VOL_ST COMM_Vol_SM;
...
void COMM_VoltageCheck(void)
{
 static unsigned char comm_vol_wrongFlag = 0;
 unsigned char i;

 if (get_powervoltage() < (6.3))
    {
        COMM_Vol_SM.currrentState = (1);

    }
    else if (get_powervoltage() > (18))
    {
        COMM_Vol_SM.currrentState = (2);
 ...
 if (COMM_Vol_SM.currrentState != (0))
 {
  if (comm_vol_wrongFlag == 0)
   ...
   {
    if(can_basic_cfg.comm_vol_cfg.comm_vol_report_fun != ((void *)0))
    {
