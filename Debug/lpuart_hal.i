# 1 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
...
# 1 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
# 48 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
...
# 49 "../SDK/platform/hal/src/lpuart/lpuart_hal.c" 2
# 62 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
void LPUART_HAL_Init(LPUART_Type * base)
{
...
# 95 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
status_t LPUART_HAL_SetBaudRate(LPUART_Type * base,
                                uint32_t sourceClockInHz,
                                uint32_t desiredBaudRate)
{
...
# 187 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
...
# 248 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
void LPUART_HAL_Putchar10(LPUART_Type * base, uint16_t data)
{
...
# 274 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
void LPUART_HAL_Getchar9(const LPUART_Type * base, uint16_t *readData)
{
    ((void)0);
...
# 293 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
void LPUART_HAL_Getchar10(const LPUART_Type * base, uint16_t *readData)
{
    ((void)0);
...
# 314 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
...
# 337 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
...
# 371 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
void LPUART_HAL_SetIntMode(LPUART_Type * base, lpuart_interrupt_t intSrc, _Bool enable)
{
...
# 418 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
_Bool LPUART_HAL_GetIntMode(const LPUART_Type * base, lpuart_interrupt_t intSrc)
{
    uint32_t reg = (uint32_t)(intSrc) >> (16U);
    _Bool retVal = 0;
...
# 469 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
void LPUART_HAL_SetLoopbackCmd(LPUART_Type * base, _Bool enable)
{
...
# 492 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
void LPUART_HAL_SetSingleWireCmd(LPUART_Type * base, _Bool enable)
{
...
# 510 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
status_t LPUART_HAL_SetReceiverInStandbyMode(LPUART_Type * base)
{
...
# 543 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
void LPUART_HAL_SetIdleLineDetect(LPUART_Type * base,
                                  const lpuart_idle_line_config_t *config)
{
    ((void)0);
    ...
    base->STAT = (base->STAT & (~(0xC01FC000U) & ~0x8000000u)) |
                 ((uint32_t)config->rxWakeIdleDetect << 27u);
}
# 564 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
void LPUART_HAL_SetMatchAddressReg1(LPUART_Type * base, _Bool enable, uint8_t value)
{
...
# 588 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
void LPUART_HAL_SetMatchAddressReg2(LPUART_Type * base, _Bool enable, uint8_t value)
{
    uint32_t matchRegValTemp;
...
# 613 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
void LPUART_HAL_SetInfrared(LPUART_Type * base, _Bool enable,
                            lpuart_ir_tx_pulsewidth_t pulseWidth)
{
...
# 636 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
_Bool LPUART_HAL_GetStatusFlag(const LPUART_Type * base, lpuart_status_flag_t statusFlag)
{
...
# 684 "../SDK/platform/hal/src/lpuart/lpuart_hal.c"
