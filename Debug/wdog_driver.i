# 1 "../SDK/platform/drivers/src/wdog/wdog_driver.c"
...
# 1 "../SDK/platform/drivers/src/wdog/wdog_driver.c"
# 47 "../SDK/platform/drivers/src/wdog/wdog_driver.c"
...
# 28 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/wdog_driver.h" 2
...
# 29 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/wdog_driver.h" 2
...
# 30 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/wdog_driver.h" 2
...
# 31 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/wdog_driver.h" 2
...
status_t CLOCK_SYS_GetFreq(clock_names_t clockName,
                           uint32_t *frequency);
# 32 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/wdog_driver.h" 2
...
# 48 "../SDK/platform/drivers/src/wdog/wdog_driver.c" 2
...
WDOG_Type * const g_wdogBase[] = { ((WDOG_Type *)(0x40052000u)) };


const IRQn_Type g_wdogIrqId[] = { WDOG_EWM_IRQn };




static status_t WDOG_DRV_Config(uint32_t instance, wdog_user_config_t wdogUserConfig);
# 106 "../SDK/platform/drivers/src/wdog/wdog_driver.c"
status_t WDOG_DRV_Init(uint32_t instance,
                            const wdog_user_config_t *userConfigPtr)
{
    ...
    ((void)0);
    ((void)0);
# 126 "../SDK/platform/drivers/src/wdog/wdog_driver.c"
...
# 146 "../SDK/platform/drivers/src/wdog/wdog_driver.c"
void WDOG_DRV_Deinit(uint32_t instance)
{
    WDOG_Type *baseAddr;
...
# 172 "../SDK/platform/drivers/src/wdog/wdog_driver.c"
static status_t WDOG_DRV_Config(uint32_t instance, wdog_user_config_t wdogUserConfig)
{
    WDOG_Type *baseAddr;
    status_t status = STATUS_SUCCESS;
...
# 208 "../SDK/platform/drivers/src/wdog/wdog_driver.c"
 void WDOG_DRV_GetConfig(uint32_t instance, wdog_user_config_t *config)
{
...
# 227 "../SDK/platform/drivers/src/wdog/wdog_driver.c"
 status_t WDOG_DRV_SetInt(uint32_t instance, _Bool enable, void (*handler)(void))
{
    WDOG_Type *baseAddr;
    status_t status = STATUS_SUCCESS;
...
# 269 "../SDK/platform/drivers/src/wdog/wdog_driver.c"
 void WDOG_DRV_Trigger(uint32_t instance)
{
    WDOG_Type *baseAddr;
