...
# 22 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/port_hal.h" 2
...
#define PM_4G_SAFE_OFF_HOLD (700)
#define PM_4G_SAFE_ON_HOLD (150)
#define PM_4G_RESET_HOLD (200)

#define PM_ACC_RESET_HOLD (100)
...
static int virtual_on = 0;

GPIO_IO_CFG pm_gpio[] =
{
    {((GPIO_Type *)(0x400FF100u)), 14U, GPIO_OUT_HI_CONF },
    {((GPIO_Type *)(0x400FF0C0u)), 8U, GPIO_OUT_HI_CONF },
    {((GPIO_Type *)(0x400FF040u)), 14U, GPIO_OUT_HI_CONF },
    {((GPIO_Type *)(0x400FF0C0u)), 10U, GPIO_OUT_HI_CONF },
    {((GPIO_Type *)(0x400FF080u)), 5U, GPIO_OUT_HI_CONF },
    {((GPIO_Type *)(0x400FF0C0u)), 4U, GPIO_OUT_HI_CONF },

    {((GPIO_Type *)(0x400FF100u)), 2U, GPIO_IN_CONF },
    {((GPIO_Type *)(0x400FF000u)), 15U, GPIO_IN_CONF },
    {((GPIO_Type *)(0x400FF100u)), 12U, GPIO_IN_CONF },

    {((GPIO_Type *)(0x400FF000u)), 1U, GPIO_IN_CONF },
    {((GPIO_Type *)(0x400FF100u)), 13U, GPIO_IN_CONF },

    {((GPIO_Type *)(0x400FF040u)), 9U, GPIO_IN_CONF },
    {((GPIO_Type *)(0x400FF080u)), 7U, GPIO_IN_CONF },
    {((GPIO_Type *)(0x400FF100u)), 7U, GPIO_IN_CONF },
    {((GPIO_Type *)(0x400FF040u)), 15U, GPIO_IN_CONF },

    {((GPIO_Type *)(0x400FF080u)), 10U, GPIO_IN_CONF },
    {((GPIO_Type *)(0x400FF080u)), 12U, GPIO_OUT_LOW_CONF },
    {((GPIO_Type *)(0x400FF080u)), 13U, GPIO_OUT_LOW_CONF },
    {((GPIO_Type *)(0x400FF040u)), 8U, GPIO_OUT_HI_CONF },
    {((GPIO_Type *)(0x400FF0C0u)), 9U, GPIO_OUT_HI_CONF },
    {((GPIO_Type *)(0x400FF000u)), 0U, GPIO_OUT_LOW_CONF },

    {((GPIO_Type *)(0x400FF100u)), 3U, GPIO_OUT_LOW_CONF },
    {((GPIO_Type *)(0x400FF000u)), 16U, GPIO_OUT_LOW_CONF },
    {((GPIO_Type *)(0x400FF0C0u)), 12U, GPIO_OUT_LOW_CONF },
    {((GPIO_Type *)(0x400FF0C0u)), 16U, GPIO_OUT_LOW_CONF},
    {((GPIO_Type *)(0x400FF0C0u)), 5U, GPIO_OUT_LOW_CONF},

    {((GPIO_Type *)(0x400FF0C0u)), 13U, GPIO_OUT_LOW_CONF },
    {((GPIO_Type *)(0x400FF0C0u)), 15U, GPIO_OUT_LOW_CONF },

    {((GPIO_Type *)(0x400FF100u)), 9U, GPIO_OUT_LOW_CONF },
    {((GPIO_Type *)(0x400FF0C0u)), 14U, GPIO_OUT_LOW_CONF },

    {((GPIO_Type *)(0x400FF000u)), 14U, GPIO_OUT_HI_CONF },
    {((GPIO_Type *)(0x400FF000u)), 17U, GPIO_OUT_LOW_CONF },
    {((GPIO_Type *)(0x400FF100u)), 6U, GPIO_OUT_LOW_CONF },
...
void pm_4g_timeout_handler(int handle)
{
    ...
    {
        case PM_4G_RESET_OP:
            GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF080u)), 13U, 0U);
            pm_4g_op = PM_4G_NO_OP;
            break;

        case PM_4G_SAFE_ON_OP:
            GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF080u)), 12U, 0U);
            pm_4g_op = PM_4G_NO_OP;
            break;
...
void pm_timeout_handler(int handle)
{
    ...
    switch (pm_op)
    {
        case PM_ACC_RESET_OP:
            GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF000u)), 17U, 0U);
            pm_op = PM_NO_OP;
            break;
...
void pm_5v_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF100u)), 14U, 1U);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF100u)), 14U, 0U);
    }
}
...
void pm_12v_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF040u)), 8U, 1U);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF040u)), 8U, 0U);
    }
}
...
void pm_3v3c_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF040u)), 14U, 1U);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF040u)), 14U, 0U);
    }
}
...
void pm_4g_power_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 8U, 1U);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 8U, 0U);
    }
}

_Bool pm_get_4g_status(void)
{
    if (!GPIO_ReadPinInput(((GPIO_Type *)(0x400FF080u)), 10U))
    {
        return 1;
    }
    else
...
void pm_4g_safe_on(void)
{
    ...
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF080u)), 12U, 1U);
        ltimer_start(pm_4g_timer_handle, (150));
...
void pm_4g_safe_off(void)
{
    ...
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF080u)), 12U, 1U);
        ltimer_start(pm_4g_timer_handle, (700));
...
void pm_4g_reset(void)
{
    ...
    if (PM_4G_NO_OP == pm_4g_op)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF080u)), 13U, 1U);
        ltimer_start(pm_4g_timer_handle, (200));
...
void pm_acc_reset(void)
{
    if (PM_NO_OP == pm_op)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF000u)), 17U, 1U);
        htimer_start(pm_timer_handle, (100));
...
void pm_can_stb_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF100u)), 3U, 1U);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF100u)), 3U, 0U);
    }
}
...
void pm_bat_k_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF000u)), 16U, 1U);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF000u)), 16U, 0U);
    }
}
...
void pm_cpu_charge_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 12U, 1U);

    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 12U, 0U);
    }
}
...
void pm_cpu_charge_trickle_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 16U, 1U);

    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 16U, 0U);
    }
}
...
void pm_cpu_charge_trickle_varta_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 5U, 1U);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 5U, 0U);
    }
}
...
void pm_vsc_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 10U, 1U);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 10U, 0U);
    }
}
...
void pm_ethernet_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF080u)), 5U, 1U);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF080u)), 5U, 0U);
    }
}
...
void pm_vbus_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 4U, 1U);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 4U, 0U);
    }
}
...
void pm_offset_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 9U, 1U);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 9U, 0U);
    }
}
...
void pm_ap_en_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF000u)), 0U, 1U);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF000u)), 0U, 0U);
    }
}

_Bool pm_get_s_charge_wakeup(void)
{
    if (!GPIO_ReadPinInput(((GPIO_Type *)(0x400FF100u)), 2U))
    {
        return 1;
    }
    else
...
_Bool pm_get_f_charge_wakeup(void)
{
    if (!GPIO_ReadPinInput(((GPIO_Type *)(0x400FF000u)), 15U))
    {
        return 1;
    }
    else
...
_Bool pm_get_acc_wakeup(void)
{
    if (!GPIO_ReadPinInput(((GPIO_Type *)(0x400FF100u)), 12U))
    {
        return 1;
    }
    else
...
_Bool pm_get_on_wakeup(void)
{
    if (!GPIO_ReadPinInput(((GPIO_Type *)(0x400FF000u)), 1U))
    {
        return 1;
    }
    else
...
_Bool pm_get_usb_wakeup(void)
{
    if (!GPIO_ReadPinInput(((GPIO_Type *)(0x400FF100u)), 13U))
    {
        return 1;
    }
    else
...
_Bool pm_get_ring_wakeup(void)
{
    if (!GPIO_ReadPinInput(((GPIO_Type *)(0x400FF040u)), 9U))
    {
        return 1;
    }
    else
...
_Bool pm_get_rtc_wakeup(void)
{
    if (!GPIO_ReadPinInput(((GPIO_Type *)(0x400FF080u)), 7U))
    {
        return 1;
    }
    else
...
_Bool pm_get_gsensor_wakeup(void)
{
    if (!GPIO_ReadPinInput(((GPIO_Type *)(0x400FF100u)), 7U))
    {
        return 1;
    }
    else
...
_Bool pm_get_pm_wakeup(void)
{
    if (GPIO_ReadPinInput(((GPIO_Type *)(0x400FF040u)), 15U))
    {
        return 1;
    }
    else
...
_Bool pm_get_ICALL(void)
{
# 566 "../Sources/mid/pm/pm.c"
    return 0;
}

_Bool pm_get_BCALL(void)
{
# 583 "../Sources/mid/pm/pm.c"
    return 0;
}

_Bool pm_get_ECALL(void)
{
# 600 "../Sources/mid/pm/pm.c"
    return 0;
}
...
void pm_DC1_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 13U, 1U);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 13U, 0U);
    }
}
...
void pm_DC2_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 15U, 1U);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 15U, 0U);
    }
}
...
void pm_B_Indicator_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF100u)), 9U, 1U);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF100u)), 9U, 0U);
    }
}
...
void pm_E_Indicator_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 14U, 1U);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF0C0u)), 14U, 0U);
    }
}
...
void pm_sleep_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF000u)), 14U, 1U);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF000u)), 14U, 0U);
    }
}
...
void pm_wakeup_ec20_ctrl(_Bool enable)
{
    if (enable)
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF100u)), 6U, 1U);
    }
    else
    {
        GPIO_HAL_WritePin(((GPIO_Type *)(0x400FF100u)), 6U, 0U);
    }
}
