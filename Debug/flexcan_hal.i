# 1 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
...
# 1 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
# 82 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
...
# 83 "../SDK/platform/hal/src/flexcan/flexcan_hal.c" 2
# 92 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
...
# 180 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
...
# 253 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
...
static uint32_t FLEXCAN_HAL_MaxMbRAMSize(const CAN_Type * base)
{
    ...
    if (base == ((CAN_Type *)(0x40024000u)))
    {
        ret = (32U) * 16U;
    }


    if (base == ((CAN_Type *)(0x40025000u)))
    {
        ret = (16U) * 16U;
    }
...
static void FLEXCAN_HAL_ClearRAM(CAN_Type * base)
{
    ...
    for (databyte = 0; databyte < 16u; databyte++) {
        RAM[databyte] = 0;
    }
# 371 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
    FLEXCAN_HAL_ExitFreezeMode(base);
}
# 386 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_Enable(CAN_Type * base)
{
...
# 413 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_Disable(CAN_Type * base)
{
...
# 440 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
...
# 458 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_Init(CAN_Type * base)
{
...
# 501 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
...
# 555 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
...
# 586 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
...
# 611 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
status_t FLEXCAN_HAL_SetTxMsgBuff(
    CAN_Type * base,
    uint32_t msgBuffIdx,
    const flexcan_msgbuff_code_status_t *cs,
...
# 761 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
status_t FLEXCAN_HAL_SetRxMsgBuff(
    CAN_Type * base,
    uint32_t msgBuffIdx,
    const flexcan_msgbuff_code_status_t *cs,
...
# 847 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
status_t FLEXCAN_HAL_GetMsgBuff(
    CAN_Type * base,
    uint32_t msgBuffIdx,
    flexcan_msgbuff_t *msgBuff)
...
# 927 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
status_t FLEXCAN_HAL_LockRxMsgBuff(
    CAN_Type * base,
    uint32_t msgBuffIdx)
{
...
# 956 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
status_t FLEXCAN_HAL_EnableRxFifo(CAN_Type * base, uint32_t numOfFilters)
{
    uint32_t i;
    status_t stat = STATUS_SUCCESS;
...
# 1000 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_DisableRxFifo(CAN_Type * base)
{
    ...
    base->MCR = (base->MCR & ~0x20000000u) | (((uint32_t)(((uint32_t)(0U))<<29u))&0x20000000u);


    FLEXCAN_HAL_ExitFreezeMode(base);
}
# 1020 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
    ...
    uint32_t number)
{
    ...
    (base->CTRL2) = (((base->CTRL2) & ~(0xF000000u)) | (((uint32_t)(((uint32_t)(number))<<24u))&0xF000000u));


    FLEXCAN_HAL_ExitFreezeMode(base);
}
# 1042 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
status_t FLEXCAN_HAL_SetMaxMsgBuffNum(
    CAN_Type * base,
    uint32_t maxMsgBuffNum)
{
...
# 1099 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_SetRxFifoFilter(
    CAN_Type * base,
    flexcan_rx_fifo_id_element_format_t idFormat,
    const flexcan_id_table_t *idFilterTable)
...
# 1219 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
status_t FLEXCAN_HAL_SetMsgBuffIntCmd(
    CAN_Type * base,
    uint32_t msgBuffIdx, _Bool enable)
{
...
# 1256 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_SetErrIntCmd(CAN_Type * base, flexcan_int_type_t errType, _Bool enable)
{
...
# 1281 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_ExitFreezeMode(CAN_Type * base)
{
    base->MCR = (base->MCR & ~0x10000000u) | (((uint32_t)(((uint32_t)(0U))<<28u))&0x10000000u);
    base->MCR = (base->MCR & ~0x40000000u) | (((uint32_t)(((uint32_t)(0U))<<30u))&0x40000000u);
...
# 1297 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_EnterFreezeMode(CAN_Type * base)
{
...
# 1313 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
uint8_t FLEXCAN_HAL_GetMsgBuffIntStatusFlag(
    const CAN_Type * base,
    uint32_t msgBuffIdx)
{
...
# 1328 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_GetErrCounter(
    const CAN_Type * base,
    flexcan_buserr_counter_t *errCount)
{
    ...
    errCount->rxerr = (uint16_t)(((base->ECR) & 0xFF00u) >> 8u);
    errCount->txerr = (uint16_t)(((base->ECR) & 0xFFu) >> 0u);
}
# 1346 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_ClearErrIntStatusFlag(CAN_Type * base)
{
...
# 1367 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_ReadRxFifo(
    const CAN_Type * base,
    flexcan_msgbuff_t *rxFifo)
{
...
# 1413 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
...
# 1443 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_SetRxFifoGlobalStdMask(
    CAN_Type * base,
    uint32_t stdMask)
{
...
# 1464 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_SetRxFifoGlobalExtMask(
    CAN_Type * base,
    uint32_t extMask)
{
    ...
    (base->RXFGMASK) = (((uint32_t)(((uint32_t)(extMask)) << 0)) & (0x1FFC0000u | 0x3FFFFu));


    FLEXCAN_HAL_ExitFreezeMode(base);
}
# 1485 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
status_t FLEXCAN_HAL_SetRxIndividualStdMask(
    CAN_Type * base,
    uint32_t msgBuffIdx,
    uint32_t stdMask)
...
# 1519 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
status_t FLEXCAN_HAL_SetRxIndividualExtMask(
    CAN_Type * base,
    uint32_t msgBuffIdx,
    uint32_t extMask)
...
# 1552 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_SetRxMsgBuffGlobalStdMask(
    CAN_Type * base,
    uint32_t stdMask)
{
...
# 1574 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_SetRxMsgBuff14StdMask(
    CAN_Type * base,
    uint32_t stdMask)
{
...
# 1595 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_SetRxMsgBuff15StdMask(
    CAN_Type * base,
    uint32_t stdMask)
{
...
# 1616 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_SetRxMsgBuffGlobalExtMask(
    CAN_Type * base,
    uint32_t extMask)
{
    ...
    (base->RXMGMASK) = (((uint32_t)(((uint32_t)(extMask)) << 0)) & (0x1FFC0000u | 0x3FFFFu));


    FLEXCAN_HAL_ExitFreezeMode(base);
}
# 1637 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_SetRxMsgBuff14ExtMask(
    CAN_Type * base,
    uint32_t extMask)
{
    ...
    (base->RX14MASK) = (((uint32_t)(((uint32_t)(extMask)) << 0)) & (0x1FFC0000u | 0x3FFFFu));


    FLEXCAN_HAL_ExitFreezeMode(base);
}
# 1658 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_SetRxMsgBuff15ExtMask(
    CAN_Type * base,
    uint32_t extMask)
{
    ...
    (base->RX15MASK) = (((uint32_t)(((uint32_t)(extMask)) << 0)) & (0x1FFC0000u | 0x3FFFFu));


    FLEXCAN_HAL_ExitFreezeMode(base);
}
# 1680 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_SetOperationMode(
    CAN_Type * base,
    flexcan_operation_modes_t mode)
{
...
# 1731 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_ExitOperationMode(
    CAN_Type * base,
    flexcan_operation_modes_t mode)
{
    ...
    else
    {
        ...
        if (mode == FLEXCAN_NORMAL_MODE)
        {
            base->MCR = (base->MCR & ~0x800000u) | (((uint32_t)(((uint32_t)(1U))<<23u))&0x800000u);
        }
        else if (mode == FLEXCAN_LISTEN_ONLY_MODE)
        {
            base->CTRL1 = (base->CTRL1 & ~0x8u) | (((uint32_t)(((uint32_t)(0U))<<3u))&0x8u);
...
# 1780 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_SetFDEnabled(CAN_Type * base, _Bool enable)
{
    FLEXCAN_HAL_EnterFreezeMode(base);
    ...
    base->CBT = base->CBT | (((uint32_t)(((uint32_t)(1U))<<31u))&0x80000000u);

    FLEXCAN_HAL_ExitFreezeMode(base);
}
# 1799 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
_Bool FLEXCAN_HAL_IsFDEnabled(const CAN_Type * base)
{
    return (((base->MCR & 0x800u) >> 11u) != 0U);
}
# 1811 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_SetPayloadSize(
    CAN_Type * base,
    flexcan_fd_payload_size_t payloadSize)
{
...
# 1845 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
uint8_t FLEXCAN_HAL_GetPayloadSize(const CAN_Type * base)
{
...
# 1870 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_SetStuffBitCount(CAN_Type * base, _Bool enable)
{
    FLEXCAN_HAL_EnterFreezeMode(base);
...
# 1891 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_SetSelfReception(CAN_Type * base, _Bool enable)
{
    FLEXCAN_HAL_EnterFreezeMode(base);
...
# 1908 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
status_t FLEXCAN_HAL_SetRxFifoDMA(CAN_Type * base, _Bool enable)
{
    uint32_t rxFifoEnabled = (base->MCR & 0x20000000u);
...
# 1934 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_SetTDCOffset(CAN_Type * base, _Bool enable, uint8_t offset)
{
    uint32_t tmp;
...
# 1967 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_ConfigPN(CAN_Type * base, const flexcan_pn_config_t *pnConfig)
{
    ((void)0);
    ...
    tmp = base->CTRL1_PN;
    tmp &= ~(0x20000u | 0x10000u | 0xFF00u |
            0x30u | 0xCu | 0x3u);
    tmp |= (((uint32_t)(((uint32_t)(pnConfig->wakeUpTimeout ? 1UL : 0UL))<<17u))&0x20000u);
    tmp |= (((uint32_t)(((uint32_t)(pnConfig->wakeUpMatch ? 1UL : 0UL))<<16u))&0x10000u);
    tmp |= (((uint32_t)(((uint32_t)(pnConfig->numMatches))<<8u))&0xFF00u);
    tmp |= (((uint32_t)(((uint32_t)(pnConfig->filterComb))<<0u))&0x3u);
    tmp |= (((uint32_t)(((uint32_t)(pnConfig->idFilterType))<<2u))&0xCu);
    tmp |= (((uint32_t)(((uint32_t)(pnConfig->payloadFilterType))<<4u))&0x30u);
    base->CTRL1_PN = tmp;

    tmp = base->CTRL2_PN;
    tmp &= ~0xFFFFu;
    tmp |= (((uint32_t)(((uint32_t)(pnConfig->matchTimeout))<<0u))&0xFFFFu);
    base->CTRL2_PN = tmp;


    tmp = base->FLT_ID1;
    tmp &= ~(0x40000000u | 0x20000000u | 0x1FFFFFFFu);
    tmp |= (((uint32_t)(((uint32_t)(pnConfig->idFilter1.extendedId ? 1UL : 0UL))<<30u))&0x40000000u);
    tmp |= (((uint32_t)(((uint32_t)(pnConfig->idFilter1.remoteFrame ? 1UL : 0UL))<<29u))&0x20000000u);
    if (pnConfig->idFilter1.extendedId)
    {
        tmp |= (((uint32_t)(((uint32_t)(pnConfig->idFilter1.id))<<0u))&0x1FFFFFFFu);
    }
    else
    {
        tmp |= (((uint32_t)(((uint32_t)(pnConfig->idFilter1.id << 18))<<0u))&0x1FFFFFFFu);
    }
    base->FLT_ID1 = tmp;
    ...
    if ((pnConfig->filterComb == FLEXCAN_FILTER_ID_PAYLOAD) || (pnConfig->filterComb == FLEXCAN_FILTER_ID_PAYLOAD_NTIMES))
    {
        tmp = base->FLT_DLC;
        tmp &= ~(0xFu | 0xFu);
        tmp |= (((uint32_t)(((uint32_t)(pnConfig->payloadFilter.dlcHigh))<<0u))&0xFu);
        tmp |= (((uint32_t)(((uint32_t)(pnConfig->payloadFilter.dlcLow))<<16u))&0xF0000u);
        base->FLT_DLC = tmp;

        tmp = (((uint32_t)(((uint32_t)(pnConfig->payloadFilter.payload1[4]))<<24u))&0xFF000000u);
        tmp |= (((uint32_t)(((uint32_t)(pnConfig->payloadFilter.payload1[5]))<<16u))&0xFF0000u);
        tmp |= (((uint32_t)(((uint32_t)(pnConfig->payloadFilter.payload1[6]))<<8u))&0xFF00u);
        tmp |= (((uint32_t)(((uint32_t)(pnConfig->payloadFilter.payload1[7]))<<0u))&0xFFu);
        base->PL1_HI = tmp;

        tmp = (((uint32_t)(((uint32_t)(pnConfig->payloadFilter.payload1[0]))<<24u))&0xFF000000u);
        tmp |= (((uint32_t)(((uint32_t)(pnConfig->payloadFilter.payload1[1]))<<16u))&0xFF0000u);
        tmp |= (((uint32_t)(((uint32_t)(pnConfig->payloadFilter.payload1[2]))<<8u))&0xFF00u);
        tmp |= (((uint32_t)(((uint32_t)(pnConfig->payloadFilter.payload1[3]))<<0u))&0xFFu);
        base->PL1_LO = tmp;


        if ((pnConfig->payloadFilterType == FLEXCAN_FILTER_MATCH_EXACT) || (pnConfig->payloadFilterType == FLEXCAN_FILTER_MATCH_RANGE))
        {
            tmp = (((uint32_t)(((uint32_t)(pnConfig->payloadFilter.payload2[4]))<<24u))&0xFF000000u);
            tmp |= (((uint32_t)(((uint32_t)(pnConfig->payloadFilter.payload2[5]))<<16u))&0xFF0000u);
            tmp |= (((uint32_t)(((uint32_t)(pnConfig->payloadFilter.payload2[6]))<<8u))&0xFF00u);
            tmp |= (((uint32_t)(((uint32_t)(pnConfig->payloadFilter.payload2[7]))<<0u))&0xFFu);
            base->PL2_PLMASK_HI = tmp;

            tmp = (((uint32_t)(((uint32_t)(pnConfig->payloadFilter.payload2[0]))<<24u))&0xFF000000u);
            tmp |= (((uint32_t)(((uint32_t)(pnConfig->payloadFilter.payload2[1]))<<16u))&0xFF0000u);
            tmp |= (((uint32_t)(((uint32_t)(pnConfig->payloadFilter.payload2[2]))<<8u))&0xFF00u);
            tmp |= (((uint32_t)(((uint32_t)(pnConfig->payloadFilter.payload2[3]))<<0u))&0xFFu);
            base->PL2_PLMASK_LO = tmp;
        }
    }
}
# 2069 "../SDK/platform/hal/src/flexcan/flexcan_hal.c"
void FLEXCAN_HAL_GetWMB(const CAN_Type * base, uint8_t wmbIndex, flexcan_msgbuff_t *wmb)
{
    ((void)0);
