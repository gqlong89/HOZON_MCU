# 1 "../Sources/app/battery/battery.c"
...
# 2 "../Sources/app/battery/battery.c" 2
...
# 3 "../Sources/app/battery/battery.c" 2
...
# 4 "../Sources/app/battery/battery.c" 2
...
# 5 "../Sources/app/battery/battery.c" 2
...
# 6 "../Sources/app/battery/battery.c" 2
...
# 7 "../Sources/app/battery/battery.c" 2
...
# 8 "../Sources/app/battery/battery.c" 2
...
# 10 "../Sources/app/battery/battery.c" 2
...
void BatteryTempPrint(void)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "BAT temprature = %d, Voltage = %d", batterytemprature, (unsigned int)(BatteryVoltage() * 1000) ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
                                                           ;
    }
}
