# 1 "../SDK/platform/hal/src/pcc/pcc_hal.c"
...
# 1 "../SDK/platform/hal/src/pcc/pcc_hal.c"
# 30 "../SDK/platform/hal/src/pcc/pcc_hal.c"
...
# 22 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/pcc_hal.h" 2
...
# 31 "../SDK/platform/hal/src/pcc/pcc_hal.c" 2
...
# 32 "../SDK/platform/hal/src/pcc/pcc_hal.c" 2
# 43 "../SDK/platform/hal/src/pcc/pcc_hal.c"
...
# 56 "../SDK/platform/hal/src/pcc/pcc_hal.c"
void PCC_HAL_SetPeripheralClockConfig(PCC_Type* const base,
                                                const pcc_config_t* const config)
{
    uint32_t i, clkGate;
    ...
    if ((config != ((void *)0)) && (config->peripheralClocks != ((void *)0)))
    {
        for (i = 0U; i < config->count; i++) {
            ...
            base->PCCn[clockNameMappings[peripheral_clock_config->clockName]] = (((uint32_t)(((uint32_t)(peripheral_clock_config->clkSrc))<<24u))&0x7000000u) |
                                          (((uint32_t)(((uint32_t)(peripheral_clock_config->frac))<<3u))&0x8u) |
                                          (((uint32_t)(((uint32_t)(peripheral_clock_config->divider))<<0u))&0x7u) |
