...
# 10 "../Sources/app/power/power.c" 2
...
# 12 "../Sources/app/power/power.c" 2
...
# 13 "../Sources/app/power/power.c" 2
...
# 14 "../Sources/app/power/power.c" 2
...
# 15 "../Sources/app/power/power.c" 2
...
# 16 "../Sources/app/power/power.c" 2
...
# 17 "../Sources/app/power/power.c" 2
...
# 18 "../Sources/app/power/power.c" 2
...
# 19 "../Sources/app/power/power.c" 2
...
# 20 "../Sources/app/power/power.c" 2
...
# 21 "../Sources/app/power/power.c" 2

# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/include/power_mode_switch.h" 1
...
# 23 "../Sources/app/power/power.c" 2

# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/S32K144/include/S32K144.h" 1
# 168 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/S32K144/include/S32K144.h"
extern unsigned int irq_cnt[20];
# 25 "../Sources/app/power/power.c" 2
...
# 27 "../Sources/app/power/power.c" 2
...
# 28 "../Sources/app/power/power.c" 2
...
unsigned int driverGetHardLineWakeSignals(void)
{
    ...
    i = (pm_get_s_charge_wakeup() ? (1 << 3) : 0);
    i = i | (pm_get_acc_wakeup() ? (1 << 1) : 0);
    i = i | (pm_get_on_wakeup() ? (1 << 0) : 0);
    i = i | (pm_get_usb_wakeup() ? (1 << 2) : 0);
    i = i | (pm_get_f_charge_wakeup() ? (1 << 4) : 0);
...
void driverInitWakeUpSrc(void)
{
    ...
    {
        WakeUpSource = (WakeUpSource | (1 << 1));
    }

    if (pm_get_on_wakeup())
    {
        WakeUpSource = (WakeUpSource | (1 << 0));
    }

    if (pm_get_s_charge_wakeup())
    {
        WakeUpSource = (WakeUpSource | (1 << 3));
    }

    if (pm_get_f_charge_wakeup())
    {
        WakeUpSource = (WakeUpSource | (1 << 4));
    }
...
float get_powervoltage(void)
{
    return (0.00936 * adc_Abat() * 1 + 0.777);
}
...
{
    WakeUpSource = (WakeUpSource | (1 << 11));
}
...
{
    WakeUpSource = (WakeUpSource | (1 << 5));
}

void PORTB15_ISR(void)
{
    WakeUpSource = (WakeUpSource | (1 << 13));
}


void PORTC7_ISR(void)
{
    WakeUpSource = (WakeUpSource | (1 << 6));
}

void PORTC16_ISR(void)
{
    WakeUpSource = (WakeUpSource | (1 << 12));
}

void PORTD17_ISR(void)
{
    WakeUpSource = (WakeUpSource | (1 << 14));
}
...
{
    WakeUpSource = (WakeUpSource | (1 << 10));
}

void PORTE7_ISR(void)
{
    WakeUpSource = (WakeUpSource | (1 << 9));
}
...
void PORTE12_ISR(void)
{
    ...
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( " PORTE12_ISR " ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
}

void PORTE13_ISR(void)
{
    WakeUpSource = (WakeUpSource | (1 << 2));
}

void PORTB17_ISR(void)
{
 WakeUpSource = (WakeUpSource | (1 << 15));
 do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( " PORTB17_ISR " ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
}
...
void gpio_wakeup_init(void)
{
 ...
 GPIO_INT_CFG PORTB17;
    ...
    PORT_HAL_SetMuxModeSel(((PORT_Type *)(0x40049000u)), 12, PORT_MUX_AS_GPIO);
    ...
    PORT_HAL_SetMuxModeSel(((PORT_Type *)(0x4004B000u)), 16, PORT_MUX_AS_GPIO);
    ...
    PORT_HAL_SetMuxModeSel(((PORT_Type *)(0x4004D000u)), 4, PORT_MUX_AS_GPIO);
...
void set_all_pin_disable(void)
{
    ...
    for (i = 0; i < 18; i++)
    {
        ...
        {
            PORT_HAL_SetMuxModeSel(((PORT_Type *)(0x40049000u)), i, PORT_PIN_DISABLED);
        }
    }
    ...
    for (i = 0; i < 18; i++)
    {
        ...
        if ((i != 9) && (i != 15)&& (i != 17))
        {
            PORT_HAL_SetMuxModeSel(((PORT_Type *)(0x4004A000u)), i, PORT_PIN_DISABLED);
        }
    }
    ...
    for (i = 0; i < 18; i++)
    {
        ...
        if ((i != 7) && (i != 16))
        {
            PORT_HAL_SetMuxModeSel(((PORT_Type *)(0x4004B000u)), i, PORT_PIN_DISABLED);
        }
    }
    ...
    for (i = 0; i < 18; i++)
    {
        ...
        if (GPIO_ReadPinInput(((GPIO_Type *)(0x400FF0C0u)), 8U) == 1)
        {
            if ((i != 10) && (i != 17))
            {
                PORT_HAL_SetMuxModeSel(((PORT_Type *)(0x4004C000u)), i, PORT_PIN_DISABLED);
            }
        }
        else
        {
    ...
    for (i = 0; i < 17; i++)
    {
        ...
        {
            PORT_HAL_SetMuxModeSel(((PORT_Type *)(0x4004D000u)), i, PORT_PIN_DISABLED);
        }
    }
    ...
    if (!cfg_get_anti_thief())
    {
        PORT_HAL_SetMuxModeSel(((PORT_Type *)(0x4004D000u)), 7, PORT_PIN_DISABLED);
    }
}
...
{
    WakeUpSource = 0;
    *((volatile unsigned int *) (0x20006F80)) = WakeUpSource;
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( " switch mode to VLPS" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    pm_4g_op_clear();
    pm_sys_off();
    mcu_deinit();
    gpio_isr_clear();
    ...
    *((volatile unsigned int *) (0x20006F80)) = WakeUpSource;
    Power_wakeup_init(0);
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( " switch Listen mode to WAKEUP" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
}
...
void PowerSleep(void)
{
    ...
    *((volatile unsigned int *) (0x20006F80)) = WakeUpSource;
    ...
    Power_wakeup_init(1);
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( " switch Sleep mode to WAKEUP" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
}
