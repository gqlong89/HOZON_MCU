# 1 "../SDK/platform/hal/src/pmc/pmc_hal.c"
...
# 1 "../SDK/platform/hal/src/pmc/pmc_hal.c"
# 30 "../SDK/platform/hal/src/pmc/pmc_hal.c"
...
# 22 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/pmc_hal.h" 2
...
# 31 "../SDK/platform/hal/src/pmc/pmc_hal.c" 2
# 50 "../SDK/platform/hal/src/pmc/pmc_hal.c"
void PMC_HAL_SetLowVoltIntCmd(PMC_Type* const baseAddr, const pmc_int_select_t intSelect, const _Bool enable)
{
    uint8_t regValue;
    ...
    switch (intSelect)
    {
        case PMC_INT_LOW_VOLT_DETECT:
            ...
            regValue |= (uint8_t)(((uint8_t)(((uint8_t)(enableValue))<<5u))&0x20u);
            baseAddr->LVDSC1 = regValue;
            break;
...
# 84 "../SDK/platform/hal/src/pmc/pmc_hal.c"
void PMC_HAL_SetLowVoltIntAckCmd(PMC_Type* const baseAddr, const pmc_int_select_t intSelect)
{
    uint8_t regValue;
...
# 117 "../SDK/platform/hal/src/pmc/pmc_hal.c"
_Bool PMC_HAL_GetLowVoltIntFlag(const PMC_Type* const baseAddr, const pmc_int_select_t intSelect)
{
    _Bool flag;
    uint8_t regValue;
