# 1 "../SDK/platform/hal/src/rcm/rcm_hal.c"
...
# 1 "../SDK/platform/hal/src/rcm/rcm_hal.c"
# 30 "../SDK/platform/hal/src/rcm/rcm_hal.c"
...
# 22 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/rcm_hal.h" 2
...
# 31 "../SDK/platform/hal/src/rcm/rcm_hal.c" 2
# 49 "../SDK/platform/hal/src/rcm/rcm_hal.c"
void RCM_HAL_GetVersion(const RCM_Type* const baseAddr, rcm_version_info_t* const versionInfo)
{
    uint32_t regValue;
...
# 75 "../SDK/platform/hal/src/rcm/rcm_hal.c"
_Bool RCM_HAL_GetSrcIndicationFeatureAvailability(const RCM_Type* const baseAddr, const rcm_source_names_t srcName)
{
...
# 143 "../SDK/platform/hal/src/rcm/rcm_hal.c"
_Bool RCM_HAL_GetSrcStatusCmd(const RCM_Type* const baseAddr, const rcm_source_names_t srcName)
{
    _Bool retValue;
...
# 203 "../SDK/platform/hal/src/rcm/rcm_hal.c"
void RCM_HAL_SetResetIntCmd(RCM_Type* const baseAddr, const rcm_source_names_t resetInterrupt, const _Bool enable)
{
    uint32_t regValue = (uint32_t)baseAddr->SRIE;
    ...
    switch (resetInterrupt)
    {
        case RCM_LOW_VOLT_DETECT:
            ...
            regValue |= (((uint32_t)(((uint32_t)(enableValue))<<1u))&0x2u);
            break;
        case RCM_LOSS_OF_CLK:
            regValue &= (uint32_t)(~(0x4u));
            regValue |= (((uint32_t)(((uint32_t)(enableValue))<<2u))&0x4u);
            break;
        case RCM_LOSS_OF_LOCK:
            regValue &= (uint32_t)(~(0x8u));
            regValue |= (((uint32_t)(((uint32_t)(enableValue))<<3u))&0x8u);
            break;
        case RCM_WATCH_DOG:
            regValue &= (uint32_t)(~(0x20u));
            regValue |= (((uint32_t)(((uint32_t)(enableValue))<<5u))&0x20u);
            break;
        case RCM_EXTERNAL_PIN:
            regValue &= (uint32_t)(~(0x40u));
            regValue |= (((uint32_t)(((uint32_t)(enableValue))<<6u))&0x40u);
            break;
        case RCM_SJTAG:
            regValue &= (uint32_t)(~(0x100u));
            regValue |= (((uint32_t)(((uint32_t)(enableValue))<<8u))&0x100u);
            break;
        case RCM_CORE_LOCKUP:
            regValue &= (uint32_t)(~(0x200u));
            regValue |= (((uint32_t)(((uint32_t)(enableValue))<<9u))&0x200u);
            break;
        case RCM_SOFTWARE:
            regValue &= (uint32_t)(~(0x400u));
            regValue |= (((uint32_t)(((uint32_t)(enableValue))<<10u))&0x400u);
            break;
        case RCM_SMDM_AP:
            regValue &= (uint32_t)(~(0x800u));
            regValue |= (((uint32_t)(((uint32_t)(enableValue))<<11u))&0x800u);
            break;
        case RCM_STOP_MODE_ACK_ERR:
            regValue &= (uint32_t)(~(0x2000u));
            regValue |= (((uint32_t)(((uint32_t)(enableValue))<<13u))&0x2000u);
            break;
        default:
...
# 269 "../SDK/platform/hal/src/rcm/rcm_hal.c"
_Bool RCM_HAL_GetStickySrcStatusCmd(const RCM_Type* const baseAddr, const rcm_source_names_t srcName)
{
    _Bool retValue;
    uint32_t regValue;
...
# 331 "../SDK/platform/hal/src/rcm/rcm_hal.c"
void RCM_HAL_ClearStickySrcStatus(RCM_Type* const baseAddr)
{
    uint32_t status;
