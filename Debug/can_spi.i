# 1 "../Sources/mid/can_spi/can_spi.c"
...
# 9 "../Sources/mid/can_spi/can_spi.c" 2
...
# 11 "../Sources/mid/can_spi/can_spi.c" 2
...
# 12 "../Sources/mid/can_spi/can_spi.c" 2
...
# 13 "../Sources/mid/can_spi/can_spi.c" 2
...
# 14 "../Sources/mid/can_spi/can_spi.c" 2
...
# 15 "../Sources/mid/can_spi/can_spi.c" 2
...
# 16 "../Sources/mid/can_spi/can_spi.c" 2
...
# 17 "../Sources/mid/can_spi/can_spi.c" 2
...
# 18 "../Sources/mid/can_spi/can_spi.c" 2
...
# 19 "../Sources/mid/can_spi/can_spi.c" 2
...
# 21 "../Sources/mid/can_spi/can_spi.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/S32K144/include/S32K144.h" 1
# 168 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/S32K144/include/S32K144.h"
extern unsigned int irq_cnt[20];
# 22 "../Sources/mid/can_spi/can_spi.c" 2
...
static void CAN_INT_ISR_4(unsigned int pin)
{
    if (10U == pin)
    {
        spican_irq_handler((1U));
        PORT_HAL_ClearPinIntFlagCmd(((PORT_Type *)(0x40049000u)), 10);
    }
}
...
static void CAN_INT_ISR_5(unsigned int pin)
{
    if (10U == pin)
    {
        spican_irq_handler((2U));
        PORT_HAL_ClearPinIntFlagCmd(((PORT_Type *)(0x4004D000u)), 10);
    }
}
...
static void GPIOInit(uint32_t instance)
{
    if ((1U) == instance)
    {
        ...
        {PORT_NUM_A, PORT_INT_LOGIC_ZERO, 10U, &CAN_INT_ISR_4 };

        GPIO_HAL_SetPinDirection(((GPIO_Type *)(0x400FF000u)), 11U, 1);
        GPIO_HAL_SetPins(((GPIO_Type *)(0x400FF000u)), 1 << 11U);
    ...
    else if ((2U) == instance)
    {
        ...
        {PORT_NUM_E, PORT_INT_LOGIC_ZERO, 10U, &CAN_INT_ISR_5 };


        GPIO_HAL_SetPinDirection(((GPIO_Type *)(0x400FF100u)), 11U, 1);
        GPIO_HAL_SetPins(((GPIO_Type *)(0x400FF100u)), 1 << 11U);
...
static void Power_On(void)
{
    ...
    GPIO_HAL_SetPinDirection(((GPIO_Type *)(0x400FF040u)), 14, 1);
    GPIO_HAL_SetPins(((GPIO_Type *)(0x400FF040u)), 1 << 14);
}
...
# 98 "../Sources/mid/can_spi/can_spi.c"
_Bool Get_send_sta(uint32_t instance, uint8_t num, uint8_t *perr)
{
    instance = (instance-2);
    uint8_t tmp = 0;
...
static _Bool dataLoad(uint32_t instance, uint8_t no)
{
    uint32_t i;
    uint32_t id, dlc;
    ...
    tmpChar = mcp2515_read_register(instance, 0x62 + no);
    id = 0;

    if (tmpChar & (1 << 3))
    {
        ext = 1;
        id |= (mcp2515_read_register(instance, 0x61 + no) << 21);
        id |= ((tmpChar & 0x03) << 16);
        id |= ((tmpChar & 0xE0) << 13);
        id |= (mcp2515_read_register(instance, 0x63 + no) << 8);
        id |= mcp2515_read_register(instance, 0x64 + no);
    }
    else
    {
        ext = 0;
        ...
        id |= ((tmpChar & 0xE0) >> 5);
        id |= (mcp2515_read_register(instance, 0x61 + no) << 3);
    }

    tmpChar = mcp2515_read_register(instance, 0x65 + no);
    dlc = (tmpChar & 0x0F) % 9;

    if ((tmpChar & (1 << 6)) && (ext == 1))
    {
        extrtr = 1;
    }
    ...
    if ((can_buf = (CAN_MSG *)ipc_can_handle(SPI_GET_FRAME)) != ((void *)0))
    {
        ...
        if (can_receive((instance+2), can_buf))
        {
...
static void spican_irq_handler(uint32_t instance)
{
    ...
    irqFlag = mcp2515_read_register(instance, 0x2C);

    if (irqFlag & 0xA0)
    {
        mcp2515_bit_modify(instance, 0x2C, irqFlag, 0);

        irqFlag = mcp2515_read_register(instance, 0x2D);

        if (irqFlag & (1 << 5))
        {
            can_err_set((instance+2), (1<<1));
        }
        else
        {
            can_err_set((instance+2), (1<<2));
        }
    ...
    {
        dataLoad(instance, 0);
        mcp2515_bit_modify(instance, 0x2C, 0x01, 0);
    }

    if (irqFlag & 0x02)
    {
        dataLoad(instance, 1);
        mcp2515_bit_modify(instance, 0x2C, 0x02, 0);
    }

    can_err_set((instance+2), (1<<6));
    can_rectime_set((instance+2));
}
...
uint8_t spican_baud(uint32_t instance, uint32_t baud)
{
    uint8_t ret = 0;
    instance = (instance-2);
    ret |= mcp2515_write_register(instance, 0x0F, 0x82);

    switch (baud)
    {
        case 50000:
            ret |= mcp2515_write_register(instance, 0x2A, 0x09);
            ret |= mcp2515_write_register(instance, 0x29,
                                          0xB6);
            ret |= mcp2515_write_register(instance, 0x28, 0x04);
            break;

        case 100000:
            ret |= mcp2515_write_register(instance, 0x2A, 0x04);
            ret |= mcp2515_write_register(instance, 0x29, 0xBD);
            ret |= mcp2515_write_register(instance, 0x28, 0x04);
            break;

        case 125000:
            ret |= mcp2515_write_register(instance, 0x2A, 0x03);
            ret |= mcp2515_write_register(instance, 0x29, 0xBD);
            ret |= mcp2515_write_register(instance, 0x28, 0x04);
            break;

        case 250000:
            ret |= mcp2515_write_register(instance, 0x2A, 0x01);
            ret |= mcp2515_write_register(instance, 0x29, 0xBD);
            ret |= mcp2515_write_register(instance, 0x28, 0x04);
            break;

        case 1000000:
            ret |= mcp2515_write_register(instance, 0x2A, 0x00);
            ret |= mcp2515_write_register(instance, 0x29, 0xA0);
            ret |= mcp2515_write_register(instance, 0x28, 0x02);
            break;
    ...
    ret |= mcp2515_write_register(instance, 0x0F, 0x00);
    return ret;
}
...
uint32_t spican_init(uint32_t instance, uint32_t baud)
{
    ...
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_DEBUG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "SPI CAN control: %02X", mcp2515_read_register(instance, 0x0F) ); printf("\r\n"); if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
                                                    ;
    spican_baud((instance+2), baud);
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_DEBUG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "After configuration: %02X", mcp2515_read_register(instance, 0x0F) ); printf("\r\n"); if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
                                                    ;

    mcp2515_write_register(instance, 0x60, 0x64);
    mcp2515_write_register(instance, 0x70, 0x60);
    mcp2515_write_register(instance, 0x2B, 0x03 | 0x80);
...
_Bool spican_deinit(uint32_t instance)
{
    ...
    if ((1U) & instance)
    {
        ...
        GPIO_HAL_ClearPins(((GPIO_Type *)(0x400FF000u)), 1 << 11U);

        LPSPI_HAL_Disable(((LPSPI_Type *)(0x4002D000u)));
    }

    if ((2U) & instance)
    {

        GPIO_HAL_ClearPins(((GPIO_Type *)(0x400FF100u)), 1 << 11U);

        LPSPI_HAL_Disable(((LPSPI_Type *)(0x4002E000u)));
    }
...
uint8_t spican_send(uint32_t instance, unsigned char *bufferPtr, uint8_t num)
{
    ...
    instance = (instance-2);
    canStat = mcp2515_read_register(instance, 0x1E);

    if ((canStat & 0xE0) != 0x00)
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_DEBUG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "reseting mcp2515 to  baud (canstat:%02x)", canStat ); printf("\r\n"); if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 4;
    }

    if (mcp2515_read_register(instance, 0x2D) & (1 << 5))
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_DEBUG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Bus error!" ); printf("\r\n"); if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 3;
    }
    ...
    if (srcPtr[0] & (1u << 31))
    {
        ...
        res |= mcp2515_write_register(instance, 0x31 + num * 0x10, srcPtr[1] >> 21);
        res |= mcp2515_write_register(instance, 0x34 + num * 0x10, srcPtr[1]);
        res |= mcp2515_write_register(instance, 0x33 + num * 0x10, srcPtr[1] >> 8);
        res |= mcp2515_write_register(instance, 0x32 + num * 0x10,
                                      ((srcPtr[1] >> 16) & 0x03) | 0x08 | ((srcPtr[1] >> 13) & 0xE0));
    }
    else
    {
    ...
    res |= mcp2515_write_register(instance, 0x35 + num * 0x10, (srcPtr[0] >> 16) & 0x0F);

    res |= mcp2515_write_register(instance, 0x36 + num * 0x10, srcPtr[2]);
