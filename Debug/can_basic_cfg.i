# 1 "../Sources/app/can_mgr/can_basic_cfg.c"
...
# 5 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
# 6 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
# 7 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
# 8 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
# 9 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
# 10 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
# 11 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
# 12 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
# 13 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
# 14 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
# 15 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
# 16 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
# 18 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
# 19 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
# 20 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
# 21 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
# 22 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
# 23 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
# 26 "../Sources/app/can_mgr/can_basic_cfg.c" 2
...
static void cfg_can_busoff_recover_send(unsigned char canport)
{
 ...
 else if (canport == CAN_PORT1)
 {
  tmpMsg.MsgID = 0x530;
        ...
        can_send_busoff(canport, 0xff, &tmpMsg);
 }
 else
 {}
}
...
# 116 "../Sources/app/can_mgr/can_basic_cfg.c"
 ...
 for(i= 0;i<2;i++)
 {
  if(can_basic_cfg.nm_cfg[i].nm_type == NM_TYPE_AUTOSAR)
  {
   ...
   {
     do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "CAN %d used Autosar NM,please config param\r\n",i ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
   }
  }
  else if(can_basic_cfg.nm_cfg[i].nm_type == NM_TYPE_OSEK)
  {
   ...
   {
     do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "CAN %d used Osek NM,please config param\r\n",i ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
   }
  }
  else
  {}
