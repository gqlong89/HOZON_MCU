...
# 2 "../Sources/app/scom/scom_tl.c" 2
...
# 3 "../Sources/app/scom/scom_tl.c" 2
...
# 4 "../Sources/app/scom/scom_tl.c" 2
...
# 5 "../Sources/app/scom/scom_tl.c" 2
...
# 6 "../Sources/app/scom/scom_tl.c" 2
...
# 7 "../Sources/app/scom/scom_tl.c" 2
...
# 20 "../Sources/app/scom/scom_tl.c"
void scom_tl_init(void)
{
    scom_tl_tx_fun = ((void *)0);
    scom_tl_proc_fun = ((void *)0);
    return;
}
# 34 "../Sources/app/scom/scom_tl.c"
void scom_tl_reg_tx_fun(scom_tx_fun tx_fun)
{
    scom_tl_tx_fun = tx_fun;
}
# 46 "../Sources/app/scom/scom_tl.c"
void scom_tl_reg_proc_fun(scom_msg_proc_fun proc_fun)
{
    scom_tl_proc_fun = proc_fun;
}
# 58 "../Sources/app/scom/scom_tl.c"
int scom_tl_get_state(void)
{
    return scom_tl_status;
}
# 75 "../Sources/app/scom/scom_tl.c"
int scom_tl_send_frame(unsigned char msg_type, unsigned char frame_type,
                       unsigned short frame_no,
                       unsigned char *data, unsigned int len)
{
    ...
    if (ret <= 0)
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "msg_encode hdr failed" ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return -1;
    }
    ...
    if (ret <= 0)
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "msg_encode failed" ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return -1;
    }
    else
    {
    ...
    if (((void *)0) != scom_tl_tx_fun)
    {
        ...
        {
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "send failed [%u,%u,%u]", msg_type, frame_type, len ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            ret = -2;
        }
    }
...
# 141 "../Sources/app/scom/scom_tl.c"
void scom_tl_send_con_req(void)
{
    ...
    if (ret != 0)
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "send connect request failed, ret:0x%08x", ret ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    }
...
# 167 "../Sources/app/scom/scom_tl.c"
void scom_tl_send_con_res(void)
{
    int ret;

    ret = scom_tl_send_frame(SCOM_TL_CMD_CON_RES, SCOM_TL_SINGLE_FRAME, 0, ((void *)0), 0);

    if (ret != 0)
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "send connect response failed, ret:%d", ret ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    }

    return;
}
# 188 "../Sources/app/scom/scom_tl.c"
void scom_tl_proc_con_req(void)
{
    ...
    if (scom_tl_status < SCOM_TL_STATE_IDLE)
    {
        ...
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "spi is connected" ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    }

    can_start_cantag();

    scom_set_mcu_upg_state(0);
}
# 211 "../Sources/app/scom/scom_tl.c"
...
# 236 "../Sources/app/scom/scom_tl.c"
int scom_tl_send_msg(unsigned char msgid, unsigned char *data, unsigned int len)
{
    int ret;
    ...
    if (len > (242))
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "too long msg" ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return -1;
    }
    ...
    if (ret != 0)
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "send frame failed, ret:%d", ret ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    }

    return ret;
}
# 263 "../Sources/app/scom/scom_tl.c"
void scom_tl_msg_proc(unsigned char *msg, unsigned int len)
{
...
# 309 "../Sources/app/scom/scom_tl.c"
void scom_tl_timeout_proc(void)
{
