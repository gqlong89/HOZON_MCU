# 1 "../Sources/app/shell/shell_task.c"
...
# 9 "../Sources/app/shell/shell_task.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/shell/shell_transfer.h" 1
...
# 11 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/app/shell/shell_transfer.h" 2
...
# 10 "../Sources/app/shell/shell_task.c" 2
...
# 11 "../Sources/app/shell/shell_task.c" 2
...
# 12 "../Sources/app/shell/shell_task.c" 2
...
# 13 "../Sources/app/shell/shell_task.c" 2
...
# 14 "../Sources/app/shell/shell_task.c" 2
...
# 15 "../Sources/app/shell/shell_task.c" 2
...
# 16 "../Sources/app/shell/shell_task.c" 2


static uint8_t shell_taskid = 0xFF;
...
unsigned int shell_task(unsigned int mask)
{
    ...
    if (mask & (1<<16))
    {
        ...
        shell_list_init();
        *((volatile unsigned int *)(0x20006F90)) = (0x55555555);
        unsigned int tmp = 0;
        Flash_EEPROM_WriteBuffer((unsigned char *)&tmp, (((0x14000000U) + (3 * 1024))), 4);
        *((volatile unsigned int *)(0x20006FB8)) = 0;
