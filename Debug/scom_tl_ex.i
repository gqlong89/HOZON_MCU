# 1 "../Sources/app/scom/scom_tl_ex.c"
...
void acc_sleep(void);
# 2 "../Sources/app/scom/scom_tl_ex.c" 2
...
# 3 "../Sources/app/scom/scom_tl_ex.c" 2
...
# 4 "../Sources/app/scom/scom_tl_ex.c" 2
...
# 5 "../Sources/app/scom/scom_tl_ex.c" 2
...
# 6 "../Sources/app/scom/scom_tl_ex.c" 2
...
# 7 "../Sources/app/scom/scom_tl_ex.c" 2
...
# 8 "../Sources/app/scom/scom_tl_ex.c" 2
...
# 9 "../Sources/app/scom/scom_tl_ex.c" 2
...
const char *brd_get_btlVerStr(void);
# 10 "../Sources/app/scom/scom_tl_ex.c" 2
...
# 11 "../Sources/app/scom/scom_tl_ex.c" 2
...
# 12 "../Sources/app/scom/scom_tl_ex.c" 2
...
# 13 "../Sources/app/scom/scom_tl_ex.c" 2
...
# 14 "../Sources/app/scom/scom_tl_ex.c" 2
...
# 15 "../Sources/app/scom/scom_tl_ex.c" 2
...
# 16 "../Sources/app/scom/scom_tl_ex.c" 2
...
# 17 "../Sources/app/scom/scom_tl_ex.c" 2
...
# 18 "../Sources/app/scom/scom_tl_ex.c" 2
...
# 19 "../Sources/app/scom/scom_tl_ex.c" 2
...
# 20 "../Sources/app/scom/scom_tl_ex.c" 2
...
# 21 "../Sources/app/scom/scom_tl_ex.c" 2
...
void scom_tl_ex_mcu_fault_syn(void)
{
    ...
    powervVoltage = (unsigned int)(100
                                   * ((3.3 * (49900 + 4700) * adc_Abat() / 4096 / 4700) + 0.777));

    if (powervVoltage < 950)
    {
        data[size++] = 0x01;
    }
    else if (powervVoltage > 1550)
    {
        data[size++] = 0x02;
    }
    else
...
# 144 "../Sources/app/scom/scom_tl_ex.c"
        data[size++] = kernelGetSOSStatus();
# 154 "../Sources/app/scom/scom_tl_ex.c"
...
void scom_tl_ex_syn_time(void)
{
    ...
    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "scom get time: %02d/%02d/%02d %02d:%02d:%02d\r\n", time.RTC_Year, time.RTC_Mon, time.RTC_Mday, time.RTC_Hour, time.RTC_Min, time.RTC_Sec ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
...
void scom_tl_ex_set_time(unsigned char *msg, unsigned int len)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "msg len=%u is not enough, need be %d", len, sizeof(RTCTime) ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }
    ...
    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "scom set time: %02d/%02d/%02d %02d:%02d:%02d\r\n", time->RTC_Year, time->RTC_Mon, time->RTC_Mday, time->RTC_Hour, time->RTC_Min, time->RTC_Sec ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
...
void scom_tl_ex_mcu_shell(unsigned char *msg, unsigned int len)
{
    ...
    do { if( ( ! g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { dumphex(msg, len, __func__, 403); } } while(0);
...
void scom_tl_ex_mpu_shell_res(unsigned char *msg, unsigned int len)
{
    do { if( ( ! g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { dumphex(msg, len, __func__, 422); } } while(0);
}
...
void scom_tl_ex_wake_time(unsigned char *msg, unsigned int len)
{
    ...
    softrtc_frombasetime((120), &com_time);



    if (wake_time <= com_time)
    {
        kernelSetSleepUTCTime(wake_time + (240));
    }
    ...
    if (ret != 0)
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "softrtc_fromuptime failed" ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    }
}
...
int scom_get_wake_time(void)
{
    ...
    if (ret != 0)
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "softrtc_frombasetime failed" ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return -1;
    }
...
void set_sleep_time_in_running(void)
{
    ...
    {
        if ((wake_time - kernelGetCurrentUTCTime()) <= (120))
        {
            kernelSetSleepUTCTime(wake_time - kernelGetCurrentUTCTime() + wake_time + (240));
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "wake_time arriving in running = %d", wake_time - kernelGetCurrentUTCTime() + (240) ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
                                                                               ;
        }
    }
}
