# 1 "../Sources/app/can_mgr/can_basic.c"
...
# 4 "../Sources/app/can_mgr/can_basic.c" 2
...
# 5 "../Sources/app/can_mgr/can_basic.c" 2
...
# 6 "../Sources/app/can_mgr/can_basic.c" 2
...
# 7 "../Sources/app/can_mgr/can_basic.c" 2
...
# 8 "../Sources/app/can_mgr/can_basic.c" 2
...
# 9 "../Sources/app/can_mgr/can_basic.c" 2
...
# 10 "../Sources/app/can_mgr/can_basic.c" 2
...
# 11 "../Sources/app/can_mgr/can_basic.c" 2
...
# 12 "../Sources/app/can_mgr/can_basic.c" 2
...
# 13 "../Sources/app/can_mgr/can_basic.c" 2
...
# 14 "../Sources/app/can_mgr/can_basic.c" 2
...
# 16 "../Sources/app/can_mgr/can_basic.c" 2
...
# 17 "../Sources/app/can_mgr/can_basic.c" 2
...
# 18 "../Sources/app/can_mgr/can_basic.c" 2
...
# 19 "../Sources/app/can_mgr/can_basic.c" 2
...
# 20 "../Sources/app/can_mgr/can_basic.c" 2
...
# 21 "../Sources/app/can_mgr/can_basic.c" 2
...
# 24 "../Sources/app/can_mgr/can_basic.c" 2
...
# 25 "../Sources/app/can_mgr/can_basic.c" 2

unsigned char canBasic_taskid = 0xFF;

LOCAL_WAKEUPCOND_ST NM_Local_WakeupCondition;


static int8_t timer_CAN_basic_task_trigger = (-1);

static int8_t timer_CANFD_test= (-1);
...
# 52 "../Sources/app/can_mgr/can_basic.c"
...
static void timer_CANFD_test_isr(int8_t handle)
{
    ...
    kernelSetTaskEvent(canBasic_taskid, (1<<24));
}
# 90 "../Sources/app/can_mgr/can_basic.c"
void update_NM_Local_WakeupCondition(WAKEUP_TYPE_E wp_type,unsigned char state)
{
 switch(wp_type)
 {
  case WP_TYPE_ON_HD:
  {
   ...
   if(pm_get_on_wakeup() == 1)
   {

    NM_Local_WakeupCondition.current_state |= (1<<0);
   }
   else
   {
    NM_Local_WakeupCondition.current_state &=(~(1<<0));
  ...
  case WP_TYPE_ON_VT:
  {
   ...
   if(state == 1)
   {
    NM_Local_WakeupCondition.current_state |= (1<<5);
   }
   else
   {
    NM_Local_WakeupCondition.current_state &=(~(1<<5));
...
# 161 "../Sources/app/can_mgr/can_basic.c"
  default:
  {
   do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Wrong!!!NO support this wakeup type!!!" ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
   break;
  }
...
{
 unsigned char i;
# 225 "../Sources/app/can_mgr/can_basic.c"
...
static void start_NM(void)
{
 ...
 if(ret != 0)
 {
  if((ret & (0x01<<0)) ==0 )
  {
   if((1) == (1))
   {
    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "Unused AUTOSAR NM Function,Please set * USED_NM_AUTOSAR == FUNC_UNUSED * \r\n" ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
   }
  }
  ...
  if((ret & (0x01<<1)) ==0 )
  {
   if((0) == (1))
   {
    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "Unused OSEK NM Function,Please set * USED_NM_OSEK == FUNC_UNUSED * \r\n" ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
   }
  }
 ...
 if(ret == 0)
 {
  if(((1) == (1))||((0) == (1)))
  {
   do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "No NM is need ,Please set * USED_NM_AUTOSAR == FUNC_UNUSED,USED_NM_OSEK == FUNC_UNUSED * \r\n" ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
  }
 }
...
void run_NM(void)
{
 ...
 nm_AutosarMainFunction();
# 350 "../Sources/app/can_mgr/can_basic.c"
}
...
unsigned int canBasic_task(unsigned int mask)
{
  ...
  update_NM_Local_WakeupCondition(WP_TYPE_ON_HD,(3));
  ...
  run_NM();
        ...
        if ((-1) == timer_CAN_basic_task_trigger)
        {
            timer_CAN_basic_task_trigger = ltimer_create(CAN_basic_task_trigger_isr);
        }

  if ((-1) == timer_CANFD_test)
        {
            timer_CANFD_test = ltimer_create(timer_CANFD_test_isr);
        }
  ...
  ltimer_start(timer_CANFD_test, 100);
        ...
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "CAN basic task init OK!!!" ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        kernelSetTaskEvent(canBasic_taskid, (1<<22));
        return 0;
    }
# 422 "../Sources/app/can_mgr/can_basic.c"
    if (mask & (1<<22))
    {
        mask &= (~(1<<22));
  update_NM_Local_WakeupCondition(WP_TYPE_ON_HD,(3));
...
# 471 "../Sources/app/can_mgr/can_basic.c"
  }
