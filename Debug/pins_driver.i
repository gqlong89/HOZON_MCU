# 1 "../SDK/platform/drivers/src/pins/pins_driver.c"
...
# 1 "../SDK/platform/drivers/src/pins/pins_driver.c"
# 19 "../SDK/platform/drivers/src/pins/pins_driver.c"
...
# 23 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/pins_driver.h" 2
...
# 24 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/pins_driver.h" 2
...
# 25 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/pins_driver.h" 2
...
# 26 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/pins_driver.h" 2
...
# 27 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/pins_driver.h" 2
...
# 20 "../SDK/platform/drivers/src/pins/pins_driver.c" 2
...
status_t CLOCK_SYS_GetFreq(clock_names_t clockName,
                           uint32_t *frequency);
# 21 "../SDK/platform/drivers/src/pins/pins_driver.c" 2


# 1 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\lib\\gcc\\arm-none-eabi\\4.9.3\\include\\stddef.h" 1 3 4
# 24 "../SDK/platform/drivers/src/pins/pins_driver.c" 2
# 58 "../SDK/platform/drivers/src/pins/pins_driver.c"
status_t PINS_DRV_Init(const uint32_t pin_count, const pin_settings_config_t config[])
{
    uint32_t i;
# 69 "../SDK/platform/drivers/src/pins/pins_driver.c"
    for (i = 0U; i < pin_count; i++)
    {
# 123 "../SDK/platform/drivers/src/pins/pins_driver.c"
        ...
        if (PORT_MUX_AS_GPIO == config[i].mux)
        {
            ...
            if ((config[i].base == ((PORT_Type *)(0x4004C000u))) && (config[i].pinPortIdx == 8))
            {
                GPIO_HAL_WritePin(config[i].gpioBase, config[i].pinPortIdx, 1U);
            }

            if ((config[i].base == ((PORT_Type *)(0x40049000u))) && (config[i].pinPortIdx == 14))
            {
                GPIO_HAL_WritePin(config[i].gpioBase, config[i].pinPortIdx, 1U);
            }

            if ((config[i].base == ((PORT_Type *)(0x4004C000u))) && (config[i].pinPortIdx == 10))
            {
                GPIO_HAL_WritePin(config[i].gpioBase, config[i].pinPortIdx, 1U);
            }

            if ((config[i].base == ((PORT_Type *)(0x4004C000u))) && (config[i].pinPortIdx == 4))
            {
                GPIO_HAL_WritePin(config[i].gpioBase, config[i].pinPortIdx, 1U);
            }
        }
