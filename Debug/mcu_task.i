# 1 "../Sources/app/mcu_mgr/mcu_task.c"
...
void acc_sleep(void);
# 9 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
# 10 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
# 11 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
# 12 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
# 13 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
# 14 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
# 15 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
# 5 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/include/config.h" 2
...
# 16 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
# 17 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
# 18 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
# 19 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
# 20 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
# 21 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
# 22 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
# 23 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
# 24 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
# 25 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
# 27 "../Sources/app/mcu_mgr/mcu_task.c" 2


# 1 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\time.h" 1 3
...
#define offsetof(TYPE,MEMBER) __builtin_offsetof (TYPE, MEMBER)
# 16 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\time.h" 2 3


# 1 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\machine\\time.h" 1 3
...
# 28 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\time.h" 2 3
# 1 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\sys\\timespec.h" 1 3
# 35 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\sys\\timespec.h" 3
#define _SYS_TIMESPEC_H_ 


# 1 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\sys\\_timespec.h" 1 3
# 35 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\sys\\_timespec.h" 3
...
# 39 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\sys\\timespec.h" 2 3
...
# 217 "c:\\nxp\\s32ds_arm_v1.3\\cross_tools\\gcc-arm-none-eabi-4_9\\arm-none-eabi\\include\\time.h" 3
...
# 30 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
# 31 "../Sources/app/mcu_mgr/mcu_task.c" 2
...
#define SCOM_TIMEOUT (25*60*100)
#define GPRS_RESET_SAFE_OFF_INTERVAL (2000)
#define MPU_MAX_FAULT_CNT 10
#define ADC_POLLING_VALUE 10
...
volatile unsigned int sosbtnstatus = SOS_UNKNOW;
volatile unsigned int spkstatus = SPK_UNKNOW;

uint8_t mcu_taskid = 0xFF;
...
static void mic_check(void)
{
    ...
    if (get_mic_test_flag())
    {
        if (micCheckCount < 50)
        {
            ...
            if ((adc_MIC_POSITIVE() >= (869)) && (adc_MIC_POSITIVE() <= (1179)))
            {
                micStatus_temp = MIC_OK;
            }
            else if ((adc_MIC_POSITIVE() >= (1986)) && (adc_MIC_POSITIVE() <= (2483)))
            {
                micStatus_temp = MIC_OPEN;
            }
            else if ((adc_MIC_POSITIVE() >= ((3630) - (400)))
                     && (adc_MIC_POSITIVE() <= ((3630) + (400))))
            {
                micStatus_temp = MIC_SHORT_POWER;
            }
            else if ((adc_MIC_POSITIVE() <= ((0) + (200))))
            {
...
{
    if (adc_spk_positive() >= ((3877) - (100)) && adc_spk_negative() <= ((0) + (100)))
    {
        return SPK_OPEN;
    }
    else if (adc_spk_positive() > adc_spk_negative() &&
             adc_spk_positive() - adc_spk_negative() < (248))
    {
        return SPK_SHORT;
    }
    else if (adc_spk_positive() > adc_spk_negative() &&
             adc_spk_positive() - adc_spk_negative() > (373))
    {
        return SPK_OK;
    }
...
# 317 "../Sources/app/mcu_mgr/mcu_task.c"
...
# 359 "../Sources/app/mcu_mgr/mcu_task.c"
}
...
void mpu_reset_check(void)
{
    ...
    reason |= (scom_get_timeout() > (25*60*100)) ? 1 : 0;
    reason |= (scom_get_fault_cnt() > 10) ? 2 : 0;
    reason |= (scom_get_upg_time() > (25*60*100)) ? 4 : 0;

    if (reason && (PM_RUNNING_MODE == pm_get_run_mode() || PM_EMERGENCY_MODE == pm_get_run_mode()))
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "MPU_RESET_EVENT!!!" ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "reset reason: 0x%08x", reason ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        kernelSetTaskEvent(mcu_taskid, (1<<22));
...
static _Bool mpu_reset_enable = 1;
...
void mpu_reset_proc(void)
{
    ...
    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "4G Reset step:%d", step ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);

    if (0 == mpu_reset_enable)
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "4G Reset disable" ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return;
    }
    ...
    switch (step)
    {
        ...
        case 1:
            pm_4g_reset();
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "[%d]:reset 4g module", step ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            kernelDisableTimer(mpu_reset_timer);
            kernelEnableTimer(mpu_reset_timer, (2000), (1<<22));
            step = 2;
            break;
        ...
        case 2:
            pm_4g_safe_on();
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "[%d]:safe on 4g module", step ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            step = 1;
            break;
# 448 "../Sources/app/mcu_mgr/mcu_task.c"
        default:
            break;
    }
}
...
static void mcumgr_init(void)
{
    ...
    kernelEnableTimer(mcu_timer, 1000, (1<<21));
    ...
    {
        RTCInitFlag = RTC_INIT_FAIL;
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( " RTC INIT FAIL" ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        initUTCTime();
    ...
    else
    {
        ...
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( " RTC INIT SUCCESS" ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        initUTCTime();
# 617 "../Sources/app/mcu_mgr/mcu_task.c"
        kernelSetSleepUTCTime(CurrentUTCTime);
    ...
    kernelEnableTimer(AdcPollingTimerNo, 10, (1<<23));
}
...
unsigned int mcumgr_task(unsigned int mask)
{
    ...
    if (mask & (1<<16))
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "TASK_SYS_EVENT_INIT!" ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        mcumgr_init();
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "TASK_SYS_EVENT_READ!" ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        mask &= (~(1<<17));
        custom_evt_proc((1<<17));
    }
    else if (mask & (1<<21))
    {
        ...
        kernelEnableTimer(mcu_timer, 200, (1<<21));
    }
    else if (mask & (1<<22))
    {
        mask &= (~(1<<22));
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "Got unknown event %08x!", mask ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        mask = 0;
    }
