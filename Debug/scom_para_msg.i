# 1 "../Sources/app/scom/scom_para_msg.c"
...
# 2 "../Sources/app/scom/scom_para_msg.c" 2
...
# 3 "../Sources/app/scom/scom_para_msg.c" 2
...
# 4 "../Sources/app/scom/scom_para_msg.c" 2
...
# 5 "../Sources/app/scom/scom_para_msg.c" 2
...
# 6 "../Sources/app/scom/scom_para_msg.c" 2
...
# 7 "../Sources/app/scom/scom_para_msg.c" 2
...
static void scom_tl_ex_para_set_sn(unsigned char *msg)
{
    ...
    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "SN = %u!", *SN ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    cfg_save_sn(*SN);
}
...
static void scom_tl_ex_para_set(unsigned int para_id, unsigned char *msg)
{
    switch (para_id)
    {
        ...
        default:
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_ERROR) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "unknown para_id=%u!", para_id ); printf("\r\n"); if(TASK_LEVEL_ERROR == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            break;
    }
}
