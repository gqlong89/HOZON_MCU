# 1 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
...
# 1 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
# 65 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
...
# 34 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/flexcan_driver.h" 2
...
# 66 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c" 2
...
# 67 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c" 2
...
# 68 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c" 2
...
# 69 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c" 2
...
# 139 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
void FLEXCAN_DRV_SetBitrate(uint8_t instance, const flexcan_time_segment_t *bitrate)
{
    ((void)0);
    ((void)0);
...
# 157 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
void FLEXCAN_DRV_SetBitrateCbt(uint8_t instance, const flexcan_time_segment_t *bitrate)
{
    ((void)0);
    ((void)0);
...
# 174 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
void FLEXCAN_DRV_GetBitrate(uint8_t instance, flexcan_time_segment_t *bitrate)
{
    ((void)0);
    ((void)0);
...
# 192 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
void FLEXCAN_DRV_SetRxMaskType(uint8_t instance, flexcan_rx_mask_type_t type)
{
    ((void)0);
...
# 207 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
void FLEXCAN_DRV_SetRxFifoGlobalMask(
    uint8_t instance,
    flexcan_msgbuff_id_type_t id_type,
    uint32_t mask)
...
# 239 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
void FLEXCAN_DRV_SetRxMbGlobalMask(
    uint8_t instance,
    flexcan_msgbuff_id_type_t id_type,
    uint32_t mask)
...
# 271 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
status_t FLEXCAN_DRV_SetRxIndividualMask(
    uint8_t instance,
    flexcan_msgbuff_id_type_t id_type,
    uint8_t mb_idx,
...
# 310 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
status_t FLEXCAN_DRV_Init(
   uint32_t instance,
   flexcan_state_t *state,
   const flexcan_user_config_t *data)
{
    ...
    {
        FLEXCAN_HAL_SetSelfReception(base, 0);
    }
    ...
    {
        result = FLEXCAN_HAL_SetRxFifoDMA(base, 1);
        if (result != STATUS_SUCCESS)
        {
            return result;
        }
...
# 576 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
status_t FLEXCAN_DRV_ConfigTxMb(
    uint8_t instance,
    uint8_t mb_idx,
    const flexcan_data_info_t *tx_info,
    uint32_t msg_id)
{
    ...
    return FLEXCAN_HAL_SetTxMsgBuff(base, mb_idx, &cs, msg_id, ((void *)0));
}
# 611 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
status_t FLEXCAN_DRV_SendBlocking(
    uint8_t instance,
    uint8_t mb_idx,
    const flexcan_data_info_t *tx_info,
    ...
    uint32_t timeout_ms)
{
    ...
    result = FLEXCAN_DRV_StartSendData(instance, mb_idx, tx_info, msg_id, mb_data, 1);
    ...
    if(result == STATUS_SUCCESS)
    {
        ...
        (void)FLEXCAN_HAL_SetMsgBuffIntCmd(base, mb_idx, 1);

        FLEXCAN_HAL_SetErrIntCmd(base,FLEXCAN_INT_ERR,1);
...
# 664 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
status_t FLEXCAN_DRV_Send(
    uint8_t instance,
    uint8_t mb_idx,
    const flexcan_data_info_t *tx_info,
    ...
    const uint8_t *mb_data)
{
    ...
    result = FLEXCAN_DRV_StartSendData(instance, mb_idx, tx_info, msg_id, mb_data, 0);
    if(result == STATUS_SUCCESS)
    {

        result = FLEXCAN_HAL_SetMsgBuffIntCmd(base, mb_idx, 1);
...
# 703 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
status_t FLEXCAN_DRV_ConfigRxMb(
    uint8_t instance,
    uint8_t mb_idx,
    const flexcan_data_info_t *rx_info,
...
# 749 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
void FLEXCAN_DRV_ConfigRxFifo(
    uint8_t instance,
    flexcan_rx_fifo_id_element_format_t id_format,
    const flexcan_id_table_t *id_filter_table)
...
# 771 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
status_t FLEXCAN_DRV_ReceiveBlocking(
    uint8_t instance,
    uint8_t mb_idx,
    flexcan_msgbuff_t *data,
    uint32_t timeout_ms)
{
    ...
    result = FLEXCAN_DRV_StartRxMessageBufferData(instance, mb_idx, data, 1);
...
# 816 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
status_t FLEXCAN_DRV_Receive(
    uint8_t instance,
    uint8_t mb_idx,
    flexcan_msgbuff_t *data)
{
    ...
    result = FLEXCAN_DRV_StartRxMessageBufferData(instance, mb_idx, data, 0);

    return result;
}
# 839 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
status_t FLEXCAN_DRV_RxFifoBlocking(
    uint8_t instance,
    flexcan_msgbuff_t *data,
    uint32_t timeout_ms)
{
    ...
    result = FLEXCAN_DRV_StartRxMessageFifoData(instance, data, 1);
...
# 870 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
status_t FLEXCAN_DRV_RxFifo(
    uint8_t instance,
    flexcan_msgbuff_t *data)
{
    ...
    result = FLEXCAN_DRV_StartRxMessageFifoData(instance, data, 0);

    return result;
}
# 891 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
status_t FLEXCAN_DRV_Deinit(uint8_t instance)
{
    ((void)0);
...
# 939 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
void FLEXCAN_DRV_IRQHandler(uint8_t instance)
{
    ((void)0);

    uint32_t flag_reg,esr1_reg;
    CAN_Type * base = g_flexcanBase[instance];
    flexcan_state_t * state = g_flexcanStatePtr[instance];
    status_t result = STATUS_SUCCESS;
    ...
    esr1_reg = FLEXCAN_HAL_GetErrStatus(base);


    if (esr1_reg & ( kFLEXCAN_BusOffIntFlag | kFLEXCAN_ErrorIntFlag))
    {
        state->result = esr1_reg;
        ...
        {
            state->callback(instance, FLEXCAN_EVENT_ERROR_STATUS, state);
        }
    }
    else
    {
        ...
        if(flag_reg != 0U)
        {
            ...
            _Bool rxfifoEnabled = FLEXCAN_HAL_IsRxFifoEnabled(base);
            if ((mb_idx == (5U)) && rxfifoEnabled)
            {
                if (state->mbs[0U].state == FLEXCAN_MB_RX_BUSY)
                {

                    FLEXCAN_HAL_ReadRxFifo(base, state->mbs[0U].mb_message);
...
# 1078 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
void FLEXCAN_DRV_WakeUpHandler(uint8_t instance)
{
    ((void)0);
...
# 1116 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
status_t FLEXCAN_DRV_GetTransferStatus(uint32_t instance, uint8_t mb_idx)
{
    ((void)0);
...
# 1145 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
status_t FLEXCAN_DRV_AbortTransfer(uint32_t instance, uint8_t mb_idx)
{
    ((void)0);
...
# 1171 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
static status_t FLEXCAN_DRV_StartSendData(
                    uint8_t instance,
                    uint8_t mb_idx,
                    const flexcan_data_info_t *tx_info,
...
# 1228 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
static status_t FLEXCAN_DRV_StartRxMessageBufferData(
                    uint8_t instance,
                    uint8_t mb_idx,
                    flexcan_msgbuff_t *data,
...
# 1272 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
static status_t FLEXCAN_DRV_StartRxMessageFifoData(
                    uint8_t instance,
                    flexcan_msgbuff_t *data,
                    _Bool isBlocking
                    )
{
    ...
    (void)FLEXCAN_HAL_SetMsgBuffIntCmd(base, (5U), 1);
    (void)FLEXCAN_HAL_SetMsgBuffIntCmd(base, (6U), 1);
    (void)FLEXCAN_HAL_SetMsgBuffIntCmd(base, (7U), 1);
...
# 1362 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
static void FLEXCAN_DRV_CompleteTransfer(uint32_t instance, uint8_t mb_idx)
{
    ((void)0);
    ...
    (void)FLEXCAN_HAL_SetMsgBuffIntCmd(base, mb_idx, 0);

    FLEXCAN_HAL_SetErrIntCmd(base,FLEXCAN_INT_ERR,0);
...
# 1391 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
static void FLEXCAN_DRV_CompleteRxFifoDataDMA(void *parameter, edma_chn_status_t status)
{
...
# 1408 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
static void FLEXCAN_DRV_CompleteRxMessageFifoData(uint32_t instance)
{
    ((void)0);
    ...
    if (state->transferType == FLEXCAN_RXFIFO_USING_INTERRUPTS)
    {
        ...
        (void)FLEXCAN_HAL_SetMsgBuffIntCmd(base, (5U), 0);
        (void)FLEXCAN_HAL_SetMsgBuffIntCmd(base, (6U), 0);
        (void)FLEXCAN_HAL_SetMsgBuffIntCmd(base, (7U), 0);
...
# 1462 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
void FLEXCAN_DRV_InstallEventCallback(uint8_t instance, flexcan_callback_t callback, void *callbackParam)
{
    ((void)0);
...
# 1481 "../SDK/platform/drivers/src/flexcan/flexcan_driver.c"
void FLEXCAN_DRV_ConfigPN(uint8_t instance, _Bool enable, const flexcan_pn_config_t *pnConfig)
{
    ((void)0);
...
void FLEXCAN_DRV_SetMode(unsigned char instance, flexcan_operation_modes_t mode)
{
    flexcan_state_t * state = g_flexcanBase[instance];

    FLEXCAN_HAL_SetOperationMode(state, mode);
}
