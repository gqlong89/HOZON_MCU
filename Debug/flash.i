...
# 64 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/include/flash.h" 2
...
# 42 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/flash_driver.h" 2
...
# 44 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/flash_driver.h" 2
...
# 45 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/flash_driver.h" 2
...
# 10 "../Sources/mid/flash/flash.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/S32K144/include/S32K144.h" 1
# 168 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/S32K144/include/S32K144.h"
extern unsigned int irq_cnt[20];
# 11 "../Sources/mid/flash/flash.c" 2
# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/devices/S32K144/include/S32K144_features.h" 1
# 12 "../Sources/mid/flash/flash.c" 2
...
# 13 "../Sources/mid/flash/flash.c" 2
...
void CCIF_Callback(void)
{
    ...
    if ((((FTFC_Type *)(0x40020000u))->FCNFG & 0x80u) == 0u)
    {
        ((FTFC_Type *)(0x40020000u))->FCNFG |= 0x80u;
    }
}
...
void Flash_SE(unsigned int SectorAddr)
{
# 58 "../Sources/mid/flash/flash.c"
    INT_SYS_DisableIRQGlobal();
    FLASH_DRV_EraseSector(&flashSSDConfig, SectorAddr, (4096U));
...
{
# 82 "../Sources/mid/flash/flash.c"
    INT_SYS_DisableIRQGlobal();
    FLASH_DRV_Program(&flashSSDConfig, addr, (256U), pBuf);
    INT_SYS_EnableIRQGlobal();
...
static status_t Flash_Program(unsigned int addr, unsigned char *pBuf, uint32_t size)
{
    ...
    if ((size & ((8u) - 1U)) != 0U)
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_ERROR) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( " The size must be 8 consecutive bytes" ); printf("\r\n"); if(PRINTK_LEVEL_ERROR == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return STATUS_ERROR;
    }
# 114 "../Sources/mid/flash/flash.c"
    INT_SYS_DisableIRQGlobal();
    ret = FLASH_DRV_Program(&flashSSDConfig, addr, size, pBuf);
    INT_SYS_EnableIRQGlobal();
# 125 "../Sources/mid/flash/flash.c"
    return ret;
}
...
void Flash_CopyData(unsigned int dest_addr, unsigned int Src_addr, uint32_t size)
{
    ...
    while (num < size)
    {
        if ((dest_addr + num) / (4096U) != sectorNumber)
        {
            sectorNumber = (dest_addr + num) / (4096U);
...
unsigned int flash_checksum_read(unsigned int addr, unsigned char *buf, unsigned int num)
{
    ...
    if (buf[num - 1] != cs)
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_DEBUG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Data is corruptted on address (0x%x)! ", addr ); printf("\r\n"); if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 1;
    }
...
unsigned int flash_checksum_write(unsigned int addr, unsigned char *buf, unsigned int num)
{
    ...
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_DEBUG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "flash_checksum_write on address (0x%x)! ", addr ); printf("\r\n"); if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
...
unsigned int flash_eeprom_checksum_read(unsigned int addr, unsigned char *buf, unsigned int num)
{
    ...
    if (buf[num - 1] != cs)
    {
        do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_LOG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "Data is corruptted on address (0x%x)! ", addr ); printf("\r\n"); if(PRINTK_LEVEL_LOG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 1;
    }
...
unsigned int flash_eeprom_checksum_write(unsigned int addr, unsigned char *buf, unsigned int num)
{
    ...
    do { if( ( !g_xModemCommEnable ) && (PRINTK_LEVEL_DEBUG) >= kernelGetDebugLevel() ) { if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" Kernel>"); printf("%s() ", __func__); printf( "flash_eeprom_checksum_write on address (0x%x)! ", addr ); printf("\r\n"); if(PRINTK_LEVEL_DEBUG == PRINTK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);

    return 0;
}
# 537 "../Sources/mid/flash/flash.c"
status_t flash_eeprom_init(void)
{
    flash_user_config_t flash_InitConfig =
    {
        ...
        .CallBack = ((flash_callback_t)0xFFFFFFFFU)
    };
    ...
    if (flashSSDConfig.EEESize == 0u)
    {
        ...
        ret = FLASH_DRV_DEFlashPartition(&flashSSDConfig, 0x02u, 0x08u, 0x0u, 0);
        ...
        else
        {
            ...
            ret = FLASH_DRV_SetFlexRamFunction(&flashSSDConfig, EEE_ENABLE, 0x00u, ((void *)0));
