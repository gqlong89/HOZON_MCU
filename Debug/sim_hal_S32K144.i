# 1 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
...
# 1 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
# 19 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
...
# 20 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c" 2
...
# 21 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c" 2
...
# 42 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
void SIM_HAL_GetClkoutDefaultConfig(sim_clock_out_config_t *config)
{
    ((void)0);
...
# 59 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
void SIM_HAL_GetClkoutConfig(const SIM_Type * base, sim_clock_out_config_t *config)
{
    uint32_t value;
    ((void)0);
...
# 136 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
void SIM_HAL_InitClkout(SIM_Type * base, const sim_clock_out_config_t *config)
{
    uint32_t regValue;
    ((void)0);
    ...
    regValue |= (((uint32_t)(((uint32_t)(config->source))<<4u))&0xF0u);
    regValue |= (((uint32_t)(((uint32_t)(config->divider))<<8u))&0x700u);


    base->CHIPCTL = regValue;
}
# 167 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
void SIM_HAL_SetFtmExternalClkPinMode(SIM_Type * base,
                                      uint32_t instance,
                                      sim_ftm_clk_sel_t select)
{
    ...
    case 3U:
        ...
        break;
# 217 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
    default:
...
# 232 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
sim_ftm_clk_sel_t SIM_HAL_GetFtmExternalClkPinMode(const SIM_Type * base,
                                                   uint32_t instance)
{
    ...
    case 3U:
        ...
        break;
# 273 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
    default:
        regValue = 0U;
        break;
    }
...
# 307 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
void SIM_HAL_SetFtmFaultSelMode(SIM_Type * base,
                                uint32_t instance,
                                uint8_t select)
{
...
# 357 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
uint8_t SIM_HAL_GetFtmFaultSelMode(const SIM_Type * base,
                                   uint32_t instance)
{
    uint8_t retValue;
...
# 394 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
uint32_t SIM_HAL_GetLpoFreq(const SIM_Type * base)
{
    uint32_t freq = 0U;
...
# 428 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
uint32_t SIM_HAL_GetLpo128KFreq(const SIM_Type * base)
{
    (void)base;
    return 128000;
}
# 441 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
uint32_t SIM_HAL_GetLpo32KFreq(const SIM_Type * base)
{
    uint32_t retValue = 0U;
...
# 457 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
uint32_t SIM_HAL_GetLpo1KFreq(const SIM_Type * base)
{
    uint32_t retValue = 0U;
...
# 474 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
void SIM_HAL_SetAdcPreTriggerMode(SIM_Type * base,
                                  uint32_t instance,
                                  sim_adc_pretrg_sel_t select)
{
...
# 502 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
sim_adc_pretrg_sel_t SIM_HAL_GetAdcPreTriggerMode(const SIM_Type * base,
                                                  uint32_t instance)
{
...
# 553 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
void SIM_HAL_SetAdcSwPreTriggerMode(SIM_Type * base,
                                  uint32_t instance,
                                  sim_adc_sw_pretrg_sel_t select)
{
...
# 586 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
sim_adc_sw_pretrg_sel_t SIM_HAL_GetAdcSwPreTriggerMode(const SIM_Type * base,
                                                       uint32_t instance)
{
...
# 647 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
void SIM_HAL_SetAdcTriggerMode(SIM_Type * base,
                               uint32_t instance,
                               sim_adc_trg_sel_t select)
{
...
# 695 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
...
# 749 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
void SIM_HAL_SetFtmChOutSrcMode(SIM_Type * base,
                                uint32_t instance,
                                uint8_t channel,
                                sim_ftm_ch_out_src_t select)
...
# 781 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
sim_ftm_ch_out_src_t SIM_HAL_GetFtmChOutSrcMode(const SIM_Type * base,
                                                uint32_t instance,
                                                uint8_t channel)
{
...
# 809 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
void SIM_HAL_SetFtmChSrcMode(SIM_Type * base,
                             uint32_t instance,
                             uint8_t channel,
                             sim_ftm_ch_src_t select)
...
# 866 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
sim_ftm_ch_src_t SIM_HAL_GetFtmChSrcMode(const SIM_Type * base,
                                         uint32_t instance,
                                         uint8_t channel)
{
...
# 938 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
void SIM_HAL_SetFtmSyncCmd(SIM_Type * base, uint32_t instance, _Bool sync)
{
    ...
    case 3U:
        ...
        break;
# 986 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
    default:
...
# 1000 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
void SIM_HAL_GetTraceClockDefaultConfig(sim_trace_clock_config_t *config)
{
    ((void)0);
...
# 1020 "../SDK/platform/hal/src/sim/S32K144/sim_hal_S32K144.c"
void SIM_HAL_InitTraceClock(SIM_Type * base,
                            const sim_trace_clock_config_t *config)
{
    uint32_t regValue;
