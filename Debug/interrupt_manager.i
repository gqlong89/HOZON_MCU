# 1 "../SDK/platform/drivers/src/interrupt/interrupt_manager.c"
...
# 1 "../SDK/platform/drivers/src/interrupt/interrupt_manager.c"
# 53 "../SDK/platform/drivers/src/interrupt/interrupt_manager.c"
...
# 54 "../SDK/platform/drivers/src/interrupt/interrupt_manager.c" 2
# 62 "../SDK/platform/drivers/src/interrupt/interrupt_manager.c"
...
# 93 "../SDK/platform/drivers/src/interrupt/interrupt_manager.c"
void INT_SYS_InstallHandler(IRQn_Type irqNumber,
                            const isr_t newHandler,
                            isr_t* const oldHandler)
{
...
# 123 "../SDK/platform/drivers/src/interrupt/interrupt_manager.c"
    __VECTOR_RAM[((int32_t)irqNumber) + 16] = (uint32_t)newHandler;
}
# 136 "../SDK/platform/drivers/src/interrupt/interrupt_manager.c"
void INT_SYS_EnableIRQ(IRQn_Type irqNumber)
{
...
# 152 "../SDK/platform/drivers/src/interrupt/interrupt_manager.c"
}
# 163 "../SDK/platform/drivers/src/interrupt/interrupt_manager.c"
void INT_SYS_DisableIRQ(IRQn_Type irqNumber)
{
...
# 180 "../SDK/platform/drivers/src/interrupt/interrupt_manager.c"
}
# 190 "../SDK/platform/drivers/src/interrupt/interrupt_manager.c"
void INT_SYS_EnableIRQGlobal(void)
{
...
# 213 "../SDK/platform/drivers/src/interrupt/interrupt_manager.c"
void INT_SYS_DisableIRQGlobal(void)
{
