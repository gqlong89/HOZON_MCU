# 1 "../Sources/app/tp/uds/UDS_LData.c"
...
# 6 "../Sources/app/tp/uds/UDS_LData.c" 2
...
# 7 "../Sources/app/tp/uds/UDS_LData.c" 2
...
# 8 "../Sources/app/tp/uds/UDS_LData.c" 2
...
# 9 "../Sources/app/tp/uds/UDS_LData.c" 2
# 18 "../Sources/app/tp/uds/UDS_LData.c"
#define UDS_FF_PUD_DLC_MAX (6)
#define UDS_SF_PDU_DLC_MAX (7)
#define CAN_DLC (8)
# 31 "../Sources/app/tp/uds/UDS_LData.c"
#define SF_PCI (0x00)
#define FF_PCI (0x10)
#define CF_PCI (0x20)
#define FC_PCI (0x30)
...
# 72 "../Sources/app/tp/uds/UDS_LData.c"
void L_Data_Init(uds_t *tUDS)
{
    uint8_t u8i;

    tUDS->LData_FS_Ind = (0x01);
...
# 141 "../Sources/app/tp/uds/UDS_LData.c"
void L_Data_Indication(uds_t *tUDS)
{
    ...
    UDS_CANMsg_T *pt_UDSCANMsg = (void*) 0;

    pt_UDSCANMsg = UDS_CANRead(tUDS);

    if (pt_UDSCANMsg != (void*) 0)
    {
        u8TOTAL_CANDL = pt_UDSCANMsg->u8DLC;
        u8PCI = pt_UDSCANMsg->Ar_u8CANData[0] & 0xF0;
        u32PDU_DLC = pt_UDSCANMsg->Ar_u8CANData[0] & 0x0F;
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "reciver data:" ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);

        for (ii = 0; ii < u8TOTAL_CANDL; ii++)
        {
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "0x%x ", pt_UDSCANMsg->Ar_u8CANData[ii] ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        }

        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "\r\n" ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        ...
        switch (u8PCI)
        {
            ...
            case (0x10) :
                if ((((tUDS->LData_eFrameStatus == NL_FRAME_IDLE) || (tUDS->LData_eFrameStatus == SF_REQ_STATE)
                      || (tUDS->LData_eFrameStatus == MF_OVER_REQ_STATE) || (tUDS->LData_eFrameStatus == FC_REQ_STATE)
                      || (tUDS->LData_eFrameStatus == SF_IND_STATE) || (tUDS->LData_eFrameStatus == MF_OVER_IND_STATE))
                     && (pt_UDSCANMsg->u32CANID == tUDS->u32Phy_CANID) && (tUDS->mode == (1)))
                    || (tUDS->mode == (2)))
                {
            ...
            case (0x20) :
                if ((tUDS->mode == (1)) && (pt_UDSCANMsg->u32CANID != tUDS->u32Phy_CANID))
                {
                    break ;
                }
...
# 239 "../Sources/app/tp/uds/UDS_LData.c"
...
# 375 "../Sources/app/tp/uds/UDS_LData.c"
void CF_Request(uds_t *tUDS)
{
    ...
    uint8_t Can_Dl;
        ...
        if ((tUDS->LData_FS_Ind == (0x00)) && (tUDS->LData_MF_DataIndex < tUDS->LData_PDU_DLC))
        {
            if ((tUDS->LData_BlockCnt < tUDS->LData_BS_Ind) || (tUDS->LData_BS_Ind == 0))
            {
                Ar_u8CanData[0] = (0x20) + (tUDS->LData_u8SN & 0x0F);
    ...
    else
    {
        ...
        if ((tUDS->LData_FS_Ind == (0x00)) && (tUDS->LData_MF_DataIndex < tUDS->LData_PDU_DLC))
        {
            if ((tUDS->LData_BlockCnt < tUDS->LData_BS_Ind) || (tUDS->LData_BS_Ind == 0))
            {
                ...
                if (0 == UDS_CANSend(tUDS, tUDS->u32ReqCANID, (8), Ar_u8CanData))
                {
                    tUDS->LData_u8SN++;
...
# 568 "../Sources/app/tp/uds/UDS_LData.c"
uint32_t SF_Request__(uds_t *tUDS, uint32_t u32AI, uint32_t u32PDU_DLC, uint8_t *pu8_Data)
{
    ...
    if(tUDS->canport == CAN_PORT0)
    {
        ...
        if (0 == UDS_CANSend(tUDS, u32AI, u8Can_Dl, Ar_u8CanData))
        {
            ...
            Ret = 0;
            N_USData_confirm(tUDS, tUDS->u32ReqCANID, N_OK);
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "LData.SF_Req" ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        }
    ...
    else
    {
        ...
        if (0 == UDS_CANSend(tUDS, u32AI, (8), Ar_u8CanData))
        {
            tUDS->LData_eFrameStatus = SF_REQ_STATE;
            Ret = 0;
            N_USData_confirm(tUDS, tUDS->u32ReqCANID, N_OK);
...
# 702 "../Sources/app/tp/uds/UDS_LData.c"
uint32_t FF_Request__(uds_t *tUDS, uint32_t u32AI, uint32_t u32PDU_DLC, uint8_t *pu8_Data)
{
    if(tUDS->canport == CAN_PORT0)
    {
        ...
        if (u32PDU_DLC < 4096)
        {
            Ar_u8CanData[0] = (0x10) + (uint8_t)(u32PDU_DLC >> 8);
            ...
            if (0 == UDS_CANSend(tUDS, u32AI, 64, Ar_u8CanData))
            {
                ...
                SetNLTimer__(tUDS, NL_TimeBs, 1);
                Ret = 0;
                do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "LData.FF_Req" ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            }
...
# 854 "../Sources/app/tp/uds/UDS_LData.c"
static uint32_t FC_Request__(uds_t *tUDS, uint8_t u8Fs, uint8_t u8Bs, uint8_t u8ST)
{
    ...
    if(tUDS->canport == CAN_PORT0)
    {
        ...
        u8Ar_SendData[0] = (0x30) + (u8Fs & 0x0F);
        ...
        if (0 == UDS_CANSend(tUDS, u32FC_CANID, 64, u8Ar_SendData))
        {
            ...
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "LData.FC_Req" ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            Ret = 0;
        }
        else
        {
    ...
    else
    {
        ...
        if (0 == UDS_CANSend(tUDS, u32FC_CANID, (8), u8Ar_SendData))
        {
            tUDS->LData_eWorkStatus = NL_SEGMENT_READ_STATUS;
            tUDS->LData_eFrameStatus = FC_REQ_STATE;
            SetNLTimer__(tUDS, NL_TimeCr, 1);
...
# 950 "../Sources/app/tp/uds/UDS_LData.c"
static void SF_Indication__(uds_t *tUDS, uint32_t u32AI, uint32_t u32PDU_DLC, uint8_t u8TOTAL_CANDL,
                            uint8_t *pu8_Data)
{
    uint8_t u8i;
    if(tUDS->canport == CAN_PORT0)
    {
        ...
        if (u8TOTAL_CANDL == 8)
        {
            if ((u32PDU_DLC > 0) && (u32PDU_DLC <= 7))
            {
                ...
                do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "LData.SF_Ind" ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
...
# 1031 "../Sources/app/tp/uds/UDS_LData.c"
static void FC_Indication__(uds_t *tUDS, uint32_t u32AI, uint32_t u32PDU_DLC, uint8_t *pu8_Data)
{
    ((void)u32AI );
    ((void)u32PDU_DLC );
    ...
    {
        tUDS->LData_STMin_Ind = pu8_Data[2] * 1000;
    }
    else if ((pu8_Data[2] >= 0xF1) && (pu8_Data[2] <= 0xF9))
    {
        tUDS->LData_STMin_Ind = (pu8_Data[2] - 0xF0) * 100;
    }
    else
    {
        tUDS->LData_STMin_Ind = 127 * 1000;
    }

    tUDS->LData_BlockCnt = 0;
    tUDS->LData_eFrameStatus = FC_IND_STATE;
    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "LData.FC_Ind" ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);

    if (tUDS->LData_FS_Ind == (0x00))
    {
        tUDS->LData_eWorkStatus = NL_SEGMENT_SEND_STATUS;
        UDS_Timer_SetPeriod(tUDS, tUDS->LData_STMin_Ind);
    }
    else if (tUDS->LData_FS_Ind == (0x01))
    {
        tUDS->LData_eFrameStatus = FC_WAIT_STATE;
        SetNLTimer__(tUDS, NL_TimeBs, 1);
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "LData.FC_FS_WAIT" ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
    }
    else if (tUDS->LData_FS_Ind == (0x02))
    {
        tUDS->LData_PDU_DLC = 0;
        tUDS->LData_eWorkStatus = NL_IDLE_STATUS;
        tUDS->LData_eFrameStatus = MF_OVER_REQ_STATE;
        UDS_TimerClose(tUDS);
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "LData.FC_FS_OVER" ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                            ...
                            uint8_t *pu8_Data)
{
    ...
    if(tUDS->canport == CAN_PORT0)
    {
...

        {
            ...
            if ((u32PDU_DLC > 62) && (u32PDU_DLC <= 0xFFF))
            {
                ...
                do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "LData.FF_Ind" ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);

                FC_Request__(tUDS, (0x00), tUDS->u8FC_BS, tUDS->u8FC_STmin);
    ...
    else
    {
        ...
        {
            FC_Request__(tUDS, (0x02), tUDS->u8FC_BS, tUDS->u8FC_STmin);
        }
...
# 1190 "../Sources/app/tp/uds/UDS_LData.c"
static void CF_Indication__(uds_t *tUDS, uint32_t u32AI, uint32_t u32PDU_DLC, uint8_t u8TOTAL_CANDL,
                            uint8_t *pu8_Data)
{
    uint8_t u8i;
            ...
            if (CF_CANID == u32AI)
            {
                ...
                if (u8SN == (tUDS->LData_u8SN & 0x0F))
                {
                    ...
                    if (tUDS->LData_MF_DataIndex >= tUDS->LData_PDU_DLC)
                    {
                        ...
                        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "LData.MF_Ind_OVER" ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
...
# 1355 "../Sources/app/tp/uds/UDS_LData.c"
static void SetNLTimer__(uds_t *tUDS, uint8_t u8TimerType, uint8_t u8Switch)
{
