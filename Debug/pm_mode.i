...
# 7 "../Sources/app/power/pm_mode.c" 2
...
# 8 "../Sources/app/power/pm_mode.c" 2
...
# 9 "../Sources/app/power/pm_mode.c" 2
...
# 10 "../Sources/app/power/pm_mode.c" 2
...
# 11 "../Sources/app/power/pm_mode.c" 2
...
# 12 "../Sources/app/power/pm_mode.c" 2
...
# 13 "../Sources/app/power/pm_mode.c" 2
...
# 14 "../Sources/app/power/pm_mode.c" 2
...
# 15 "../Sources/app/power/pm_mode.c" 2
...
# 16 "../Sources/app/power/pm_mode.c" 2
...
# 17 "../Sources/app/power/pm_mode.c" 2
...
# 18 "../Sources/app/power/pm_mode.c" 2


# 1 "C:/Users/INTEST/Desktop/MCU(2)/MCU/Sources/include/mcu_fun_def.h" 1


#define _MCU_FUN_DEF_H_ 


#define MCU_RTC_WAKEUP_IN_LP_INTERVAL (12*60)
# 21 "../Sources/app/power/pm_mode.c" 2

static unsigned int pm_run_mode = PM_RUNNING_MODE;
static unsigned int pm_sys_mode = PM_RUNNING_ONLY;
static unsigned int pm_rtc_wakeup_val = (12*60);
...
{
    unsigned int ret = 0;
# 80 "../Sources/app/power/pm_mode.c"
    return ret;
}
...
unsigned int pm_sleep_available(void)
{
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "upgrade status:%u", scom_get_upg_status() ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 0;
    }
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "anti thief status:%u", get_anti_thief_trigger() ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 0;
    }
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "usb status:%u", pm_get_usb_status() ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 0;
    }
    ...
    if (get_can_status())
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "can status:%u", get_can_status() ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 0;
    }
    ...
    if (call_get_status())
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "call status:%u", call_get_status() ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 0;
    }
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "hard line status:%u", driverGetHardLineWakeSignals() ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 0;
    }
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "ring status:%u", pm_get_ring_wakeup() ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 0;
    }
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "bat status:%u, vol:%u", BatteryInsertDetect(), get_powervoltage() ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 0;
    }
# 170 "../Sources/app/power/pm_mode.c"
...
unsigned int pm_off_available(void)
{
    ...
    if (get_powervoltage() > (5))
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "power:%u", get_powervoltage() ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 0;
    }
    ...
    {
        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "call:%u", call_get_trigger_timeout() ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        return 0;
    }
# 206 "../Sources/app/power/pm_mode.c"
    return 1;
}
...
void RunningModeCheck(void)
{
    ...
    switch (pm_run_mode)
    {
        case PM_RUNNING_MODE:
            ...
            if (pm_get_4g_status())
            {
                do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "wakeup 4G" ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            ...
            else
            {
                if (driverGetUptime() > (pm_4g_on_time + 30 * 100))
                {
                    ...
                    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_DEBUG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "power on 4G" ); printf("\r\n"); if(TASK_LEVEL_DEBUG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                    pm_4g_safe_on();
            ...
            if ((!BatteryInsertDetect()) && (get_powervoltage() < (5)))
            {
                ...
                do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "switch to emergency mode! powervoltage: %d", (int)get_powervoltage() ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                break;
            }
            ...
            if ((pm_sys_mode != PM_RUNNING_ONLY) && (kernelGetSleepUTCTime() > kernelGetCurrentUTCTime()))
            {
                ...
                if (pm_sleep_available())
                {
                    if (kernelGetSleepUTCTime() - kernelGetCurrentUTCTime() <= (240))
                    {
                        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "after %d sec into other mode", kernelGetSleepUTCTime() - kernelGetCurrentUTCTime() ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
                                                                                       ;
                    }
                }
                else
            ...
            else if (pm_sys_mode == PM_LISTEN_ONLY)
            {
                ...
                {
                    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "wait mcu to check version" ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                    run_last_ticks = 0;
                }
                else if (pm_sleep_available())
                {
                    ...
                    if (run_last_ticks > (5))
                    {
                        ...
                        ticks = 0;
                        run_last_ticks = 0;
                        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "Switch to listen mode!" ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                    }
                }
                else
                {
                    set_sleep_time_in_running();
                    run_last_ticks = 0;
                }
            }
            else if (pm_sys_mode == PM_SLEEP_ONLY)
            {
                ...
                else if (pm_sleep_available())
                {
                    ...
                    if (run_last_ticks > (5))
                    {
                        ...
                        ticks = 0;
                        run_last_ticks = 0;
                        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "Switch to sleep mode!" ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                    }
                }
                else
                {
                ...
                else if (pm_sleep_available())
                {
                    ...
                    if (run_last_ticks > (5))
                    {
                        ...
                        else if (get_standby_timeout() && (cfg_get_standbyflag() == STANDBY_DEEP_SLEEP))
                        {
                            ...
                            ticks = 0;
                            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "Switch to deep sleep mode!" ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                        }
                        else
                        {
                            pm_wakeup_ec20_ctrl(0);
        ...
        case PM_EMERGENCY_MODE:
            ...
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "emergency mode ticks = %d", ticks ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            ...
            if (get_powervoltage() > (5))
            {
                ...
                do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "Switch to running mode!" ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            }
            else
            {
                                                  ...
                                                  && (ticks > (300))))
                {
                    if (pm_off_available() && (ticks > 64) && !scom_is_need_upgrade())
                    {
                        ...
                        ticks = 0;
                        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "Switch to off mode!" ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                    }
                }
            }
        ...
        case PM_LISTEN_MODE:
            ...
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "listen mode ticks = %d", ticks ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
            ...
            if ((!pm_sleep_available()) || (pm_sys_mode_bak != pm_sys_mode))
            {
                ...
                {
                    kernelSetSleepUTCTime(kernelGetCurrentUTCTime() + (240));
                }
                ...
                pm_run_mode = PM_RUNNING_MODE;
                do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "Switch to running mode! power: %d, canstatus: %d, app_status: %d, callstatus: %d, usbstatus: %d, anti_thief: %d, sysmode: %d ", driverGetHardLineWakeSignals(), get_can_status(), scom_is_app_can_sleep(), call_get_status(), pm_get_usb_status(), get_anti_thief_trigger(), pm_sys_mode_bak ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
            ...
            else if (ticks > 64)
            {
                ...
                if (wake_time > 0)
                {
                    ...
                    cfg_save_standbyflag(STANDBY_NO_SLEEP);
                    cfg_save_wake_cnt(0);
                    do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "set rtc wake time = (%d)", wake_time ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                }
                else
                {
...
# 496 "../Sources/app/power/pm_mode.c"
                        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "set rtc sleep wake time = (%d), wake cnt = (%u)", interval, cfg_get_wake_cnt() ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
                                                      ;
                    }
                    else
                    {
                        ...
                        cfg_save_standbyflag(STANDBY_NO_SLEEP);
                        cfg_save_wake_cnt(0);
                        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "disable rtc wake" ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
                    }
                }
        ...
        case PM_SLEEP_MODE:
            ...
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "sleep mode ticks = %d", ticks ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
...
# 584 "../Sources/app/power/pm_mode.c"
                        do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "set rtc deep wake time = (%u), wake cnt = (%u)", interval, cfg_get_wake_cnt() ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0)
                                                                ;
                    }
                    else
                    {
        ...
        case PM_DEEP_SLEEP_MODE:
            ...
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "deep sleep mode ticks = %d", ticks ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
        ...
        case PM_OFF_MODE:
            ...
            do { if( ( !g_xModemCommEnable ) && (TASK_LEVEL_LOG) >= kernelGetTaskLevel() ) { if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[47;31m" );} printf(" %s>", kernelGetTaskName()); printf("%s() ", __func__); printf( "off mode ticks = %d", ticks ); printf("\r\n"); if(TASK_LEVEL_LOG == TASK_LEVEL_ERROR) {printf( "\033[0m" );} } } while (0);
