# 1 "../Sources/mid/brdinfo/brdInfo.c"
...
# 1 "../Sources/mid/brdinfo/brdInfo.c"
# 9 "../Sources/mid/brdinfo/brdInfo.c"
...
# 10 "../Sources/mid/brdinfo/brdInfo.c" 2
...
# 11 "../Sources/mid/brdinfo/brdInfo.c" 2
...
# 12 "../Sources/mid/brdinfo/brdInfo.c" 2
...
# 13 "../Sources/mid/brdinfo/brdInfo.c" 2
...
# 14 "../Sources/mid/brdinfo/brdInfo.c" 2
...
# 15 "../Sources/mid/brdinfo/brdInfo.c" 2
...
{
    if (memcmp((void *) (((0x20006F00))), (void *) "btlver", 6) != 0)
    {
        return 1;
    }

    if (strlen((char *) (((0x20006F00)))) >= 64)
    {
        return 1;
    }
...
{
    if (memcmp((void *) ((((0x20006F00)) + 64)), (void *) "hwver", 5) != 0)
    {
        return 1;
    }

    if (strlen((char *) ((((0x20006F00)) + 64))) >= 32)
    {
        return 1;
    }
...
{
    if (memcmp((void *) (((((0x20006F00)) + 64) + 32)), (void *) "bomver", 6) != 0)
    {
        return 1;
    }

    if (strlen((char *) (((((0x20006F00)) + 64) + 32))) >= 32)
    {
        return 1;
    }
...
const char *brd_get_bomVerStr(void)
{
    if (s_BomVerValid == 1)
    {
        return (char *)((((((0x20006F00)) + 64) + 32)) + 7);
    }
    else
    {
        return (char *) 0;
...
unsigned int brd_get_projectCode(void)
{
    ...
    if (s_HwVerValid == 1)
    {
        ...
        pStart = (unsigned int) strstr((char *) ((((0x20006F00)) + 64)), "IN.");
...
unsigned int brd_get_bomRevision(void)
{
    ...
    if (s_BomVerValid == 1)
    {
        ...
        pStart = (unsigned int) strstr((char *) (((((0x20006F00)) + 64) + 32)), "bom");
        pStart += 1;
