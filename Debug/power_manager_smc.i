# 1 "../SDK/platform/drivers/src/power/power_manager_smc.c"
...
# 1 "../SDK/platform/drivers/src/power/power_manager_smc.c"
# 103 "../SDK/platform/drivers/src/power/power_manager_smc.c"
...
# 23 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/power_manager.h" 2
...
# 24 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/hal/inc/smc_hal.h" 2
...
# 30 "C:/Users/INTEST/Desktop/MCU(2)/MCU/SDK/platform/drivers/inc/power_manager.h" 2
...
# 104 "../SDK/platform/drivers/src/power/power_manager_smc.c" 2
...
# 198 "../SDK/platform/drivers/src/power/power_manager_smc.c"
status_t POWER_SYS_DoInit(void)
{
    ...
    SMC_HAL_SetProtectionMode(((SMC_Type *)(0x4007E000u)), &powerModeProtConfig);
...
# 224 "../SDK/platform/drivers/src/power/power_manager_smc.c"
status_t POWER_SYS_DoSetMode(const power_manager_user_config_t * const configPtr)
{
    status_t returnCode;
...
# 250 "../SDK/platform/drivers/src/power/power_manager_smc.c"
power_manager_modes_t POWER_SYS_GetCurrentMode(void)
{
    power_manager_modes_t retVal;
    switch (SMC_HAL_GetPowerModeStatus(((SMC_Type *)(0x4007E000u))))
    {
...
# 284 "../SDK/platform/drivers/src/power/power_manager_smc.c"
static status_t POWER_SYS_WaitForModeStatus(smc_run_mode_t mode)
{
    status_t retCode;
    ...
    if (STATUS_SUCCESS == retCode)
    {
        for (; i < 1000U ; i++)
        {
            if(SMC_HAL_GetPowerModeStatus(((SMC_Type *)(0x4007E000u))) == modeStat)
            {
                break;
            }
        }
...
# 336 "../SDK/platform/drivers/src/power/power_manager_smc.c"
static status_t POWER_SYS_SwitchToRunningPowerMode(const power_manager_user_config_t * const configPtr)
{
    ...
    case POWER_MANAGER_HSRUN:
        ...
        if (SMC_HAL_GetPowerModeStatus(((SMC_Type *)(0x4007E000u))) != STAT_RUN)
        {
            SMC_HAL_SetRunModeControl(((SMC_Type *)(0x4007E000u)), SMC_RUN);
        ...
        if (STATUS_SUCCESS == returnCode)
        {
            ...
            if (SMC_HAL_SetPowerMode(((SMC_Type *)(0x4007E000u)), &halModeConfig) == STATUS_SUCCESS)
            {
...
# 432 "../SDK/platform/drivers/src/power/power_manager_smc.c"
static status_t POWER_SYS_SwitchToSleepingPowerMode(const power_manager_user_config_t * const configPtr)
{
    smc_power_mode_config_t halModeConfig;
    status_t returnCode;
    power_mode_stat_t pwrModeStat;


    switch (configPtr->powerMode) {
# 479 "../SDK/platform/drivers/src/power/power_manager_smc.c"
...
# 515 "../SDK/platform/drivers/src/power/power_manager_smc.c"
        if (POWER_MANAGER_STOP1 == configPtr->powerMode)
        {
          halModeConfig.stopOption = 1;
        ...
        {
          halModeConfig.stopOption = 0;
        }

        break;

    case POWER_MANAGER_VLPS:
        pwrModeStat = SMC_HAL_GetPowerModeStatus(((SMC_Type *)(0x4007E000u)));
